...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(453, projection["reviewedNonDebtRowCount"])
        self.assertEqual(122, projection["genuineDebtRowCount"])
        self.assertEqual(48, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`453` non-debt and `122` genuine-debt", tracker)
        self.assertIn("`48` unique file/rule items", tracker)
        self.assertIn("`122` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(445, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(122, review["genuineDebtRowCount"])
        self.assertEqual(48, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(122, len(debt_rows))
