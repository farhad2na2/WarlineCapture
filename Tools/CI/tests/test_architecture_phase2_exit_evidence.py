...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(436, projection["reviewedNonDebtRowCount"])
        self.assertEqual(139, projection["genuineDebtRowCount"])
        self.assertEqual(63, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`436` non-debt and `139` genuine-debt", tracker)
        self.assertIn("`63` unique file/rule items", tracker)
        self.assertIn("`139` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(428, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(139, review["genuineDebtRowCount"])
        self.assertEqual(63, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(139, len(debt_rows))
