...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(483, projection["reviewedNonDebtRowCount"])
        self.assertEqual(92, projection["genuineDebtRowCount"])
        self.assertEqual(37, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`483` non-debt and `92` genuine-debt", tracker)
        self.assertIn("`37` unique file/rule items", tracker)
        self.assertIn("`92` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(475, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(92, review["genuineDebtRowCount"])
        self.assertEqual(37, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(92, len(debt_rows))
