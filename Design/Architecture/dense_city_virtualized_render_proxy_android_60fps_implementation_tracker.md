...
**Independent correctness queue (does not advance the 80-item VRP checklist):** candidate canal water has a regeneration-stable, clearly blue transparent presentation override with its Windows/Editor asset contract accepted; Android visual confirmation remains pending. The building-road clearance correction is accepted on the rebuilt Android candidate after the reconciled generator, inventory, database, capacity, and direct-bake gates: reviewed base and urban device views show generated buildings beside, rather than intersecting, rendered roads. Road-over-water-without-bridge remains a separate open defect. The urban Android view also exposes harsh black shadow patches; that evidence belongs to VRP-072's shadow/small-detail policy gate and is not conflated with the closed clearance defect.
