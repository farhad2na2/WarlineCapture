...
namespace Game.UI.Shell.Ecs
{
    public sealed partial class UiShellEcsGateway
    {
        ...
        public static bool TryReadMissionResult(out UiMissionResultPopupModel result)
        {
            ...
            bool debriefRequired = (establishBase || runtime.MissionId.Equals(RadarResultMissionId) || runtime.MissionId.Equals(AirliftId) || runtime.MissionId.Equals(BreachId) || runtime.MissionId.Equals(new FixedString64Bytes(Game.Missions.Contracts.CampaignMissionSequence.Gridlock))) && victory &&
