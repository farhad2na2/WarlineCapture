...
namespace Game.UI.Runtime
{
    ...
    public sealed class AssistantButtonView : MonoBehaviour
    {
        ...
        public void SetState(AssistantButtonVisualState state)
        {
            ...
            if (labelText != null)
                labelText.text = UiShellRuntimeGateway.Localization.Get("ui.aria.name", "ARIA");

            if (stateText != null)
                stateText.text = UiShellRuntimeGateway.Localization.GetBySource(presentation.StateLabel);
