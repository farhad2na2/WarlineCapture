...
| Current task | Reduce the clean APH-804 APK from `512,082,081` to `<=463,359,198` bytes and APH-803 peak allocated memory from `1,085.77` to `<=967.5 MB` without visual downgrade, then collect release and visual evidence |
