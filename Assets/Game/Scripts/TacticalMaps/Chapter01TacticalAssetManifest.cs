...
public sealed class Chapter01TacticalAssetManifest : ScriptableObject
{
    ...
    public void ConfigureDefaults()
    {
        ...
        entries = new[]
        {
            Entry("iso.ch01.district_edge_01.ground", TacticalAssetCategory.GroundPlate, TacticalAssetStatus.ExistsNeedsReview, "Assets/Game/Art/Generated/2DISO/Chapter01/M01_AIProduction/TacticalMaps/m01_tactical_plate_a_source.png", "saga.ch01.m01.first_contact", "M01 approved tactical plate candidate from the step-by-step visual lock layer pack; replaces stale TacticalGroundQualityTest_A proxy while preserving the contracted map id."),
