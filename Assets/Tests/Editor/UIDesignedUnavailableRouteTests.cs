...
public sealed class UIDesignedUnavailableRouteTests
{
    private static readonly RouteCase[] Cases =
    {
        new RouteCase("Screen_Inbox", UIRoute.Inbox, "COMMAND INBOX", "INBOX READY", "Assets/Game/Art/UI/Generated/Inbox/LayeredOneGo"),
        new RouteCase("Screen_Events", UIRoute.Events, "EVENTS", "NO ACTIVE EVENT", "Assets/Game/Art/UI/Generated/Events/LayeredOneGo"),
        new RouteCase("Screen_Ranking", UIRoute.Ranking, "RANKING", "LOCAL STATS ONLY", "Assets/Game/Art/UI/Generated/Ranking/LayeredOneGo"),
        new RouteCase("Screen_CommandFeed", UIRoute.CommandFeed, "COMMAND FEED", "LOCAL FEED ACTIVE", "Assets/Game/Art/UI/Generated/CommandFeed/LayeredOneGo")
    };
    ...
    private readonly struct RouteCase
    {
        ...
        public RouteCase(string screenName, UIRoute route, string title, string heroTitle, string layerRoot)
        {
