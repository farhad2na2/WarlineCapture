...
- Canvas parity controls currently include `PassengerChip`, `TransportPassengerDrawer`, `ExitAllButton`, `CloseButton`, `FeedbackPanel`, `BoardAllButton`, `CancelButton`, and five squad tray buttons `SquadCard1` through `SquadCard5`.
