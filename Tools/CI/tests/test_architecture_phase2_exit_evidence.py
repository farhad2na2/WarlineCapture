...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(510, projection["reviewedNonDebtRowCount"])
        self.assertEqual(65, projection["genuineDebtRowCount"])
        self.assertEqual(30, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`510` non-debt and `65` genuine-debt", tracker)
        self.assertIn("`30` unique file/rule items", tracker)
        self.assertIn("`65` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(502, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(65, review["genuineDebtRowCount"])
        self.assertEqual(30, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(65, len(debt_rows))
