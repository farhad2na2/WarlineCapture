public sealed class OperationEventsScreenController : OperationLedgerScreenController
{
    protected override void Refresh()
    {
        ...
        SetText("StatusCard_2/BodyText", hotDistrict != null
            ? $"{OperationDashboardScreenController.FormatDistrictName(hotDistrict.districtId)} is the current highest-pressure district."
