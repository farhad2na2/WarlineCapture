...
Date: 2026-05-05
Status: Historical request package. Superseded by the 2026-05-21 3D single-map direction. Do not use this as an active production request unless PM explicitly reopens 2D isometric macro-tile terrain.
