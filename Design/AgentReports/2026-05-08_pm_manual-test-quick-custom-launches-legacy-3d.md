...
- Decide whether Quick Custom should continue to launch legacy gameplay for sandbox testing or should launch the current M01 production route when `new ActiveMissionSession().ActiveMissionId == saga.ch01.m01.first_contact`.
