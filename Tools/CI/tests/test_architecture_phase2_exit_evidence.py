...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(507, projection["reviewedNonDebtRowCount"])
        self.assertEqual(68, projection["genuineDebtRowCount"])
        self.assertEqual(32, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`507` non-debt and `68` genuine-debt", tracker)
        self.assertIn("`32` unique file/rule items", tracker)
        self.assertIn("`68` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(499, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(68, review["genuineDebtRowCount"])
        self.assertEqual(32, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(68, len(debt_rows))
