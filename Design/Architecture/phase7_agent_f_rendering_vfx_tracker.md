...
- In progress: `0`.
- Remaining open: `61`.
- Current target: `Agent F helper fold completed for P7-0280 SelectionOrderMarkerSystem; continue remaining Agent F visual split/direct candidates`.
...
- Validation status: `P7-0280 SelectionOrderMarkerSystem folded out of ECS into a plain direct-owned helper. The selection order marker helper was already direct-owned by SelectionGameplayStartupSystem and had empty SystemBase OnUpdate; it now keeps managed marker presentation as a plain helper while preserving move, attack, scan, attack-target selection, board preview marker pools, command result marker consumption, visibility expiry, and disposal behavior. Compile, inventory regeneration, SelectionOrderMarker focused validation, git diff --check, and Phase 7 architecture guard passed. Latest logs: /private/tmp/warline-phase7-agent-f-selection-order-marker-helper-fold.log and /private/tmp/warline-phase7-agent-a-architecture.log. Inventory now reports 43 production SystemBase/legacy declarations, 134 production ISystem declarations, and 75.7% production ISystem share; open rows dropped to 18 and managed exceptions remain 24. Prior Agent F logs include /private/tmp/warline-phase7-agent-f-road-build-visual-context-helper-fold-road-build-command.log, /private/tmp/warline-phase7-agent-f-building-selection-marker-helper-fold.log, /private/tmp/warline-phase7-agent-f-building-runtime-visual-helper-fold-selection-marker.log, /private/tmp/warline-phase7-agent-f-building-placement-visual-helper-fold-placement-runtime.log, /private/tmp/warline-phase7-agent-f-building-foundation-visual-helper-fold-runtime-building.log, /private/tmp/warline-phase7-agent-f-building-destroyed-visual-helper-fold.log, /private/tmp/warline-phase7-agent-f-unit-impostor-helper-fold-render-budget.log, /private/tmp/warline-phase7-agent-f-unit-attack-trace-helper-fold-unit-combat.log, /private/tmp/warline-phase7-agent-f-unit-selection-marker-outline-split-vehicle-visual.log, /private/tmp/warline-phase7-agent-f-runtime-city-yard-wall-visual-helper-fold-runtime-city-generation.log, /private/tmp/warline-phase7-agent-f-runtime-city-visual-helper-fold-runtime-city-generation.log, /private/tmp/warline-phase7-agent-f-building-placement-visual-update-helper-fold-placement-runtime.log, /private/tmp/warline-phase7-agent-f-building-placement-visual-composition-helper-fold-placement-runtime.log, /private/tmp/warline-phase7-agent-f-road-visual-refresh-helper-fold-road-build-command.log, /private/tmp/warline-phase7-agent-f-camera-helper-fold-rts-camera.log, and /private/tmp/warline-phase7-agent-f-camera-helper-fold-runtime-camera-reference.log. Residual unrelated validation note: /private/tmp/warline-phase7-agent-f-building-marker-composition-placement-runtime.log failed an existing runtime-tick cadence assertion (Expected 2, But was 1).`
...
- `2026-06-22` - `P7-0270` `RoadBuildVisualContextSystem`: folded disabled road build visual context `SystemBase` wrapper into a plain direct-owned helper. `RoadBuildCompositionSourceSystem` now instantiates the helper directly; chunk, preview, special-road, road visual resolution context construction, and prefab resolution stayed unchanged.
