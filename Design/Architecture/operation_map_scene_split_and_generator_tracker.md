...
- [ ] Bind runway and helipad anchors for taxi, takeoff, return, and landing behavior. Loader-neutral exact typed resolution, fail-closed validation, geometry semantics, and deterministic current-map records are implemented. Gameplay consumer integration remains pending, so existing building-derived behavior stays authoritative. See `../AgentReports/2026-07-17_operation_map_infrastructure_anchor_foundation.md`, `../AgentReports/2026-07-17_operation_map_infrastructure_anchor_geometry_contract.md`, and `../AgentReports/2026-07-17_operation_map_current_infrastructure_anchor_records.md`.
