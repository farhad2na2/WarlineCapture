...
Current checkpoint: disk-backed profile transactions and shared ECS recon rules are implemented; the normal Operations menu deploys the authored 16-versus-20 finite-force candidate into the shared city world. Normal mouse/keyboard English and Farsi victories, saved results and menu returns passed (9:48 and 7:19). Explicit interrupted-attempt restart/withdrawal passed. Save & Exit and same-session checkpoint Resume now pass both in one Editor session and across a fresh Editor process; deeper scan/carrier/terminal recovery, a second reviewed tactical approach, ARIA acceptance and unfamiliar-player review remain open. Android/device acceptance remains deferred. See [implementation evidence](../../AgentReports/Operations/O001_IMPLEMENTATION_PROGRESS_20260922.md) and [checkpoint evidence](../../AgentReports/Operations/O001_CHECKPOINT_RESUME_20260923.md).
