...
- Checklist progress: `268 / 268 complete (100.0%)`.
- In progress: `0`.
- Remaining open: `0`.
- Current target: `Phase 7 single-thread domain execution: Integration P7-0315 ManagedGameplayStartupSystem disabled managed-startup helper wrapper folded out of ECS; continue remaining Integration split-first rows; P7-0003/P7-0019 remain held pending an explicit managed-reference boundary guardrail/model change`.
...
- Phase 7 checklist progress: `172 / 176 complete (97.7%)`.
...
- Production `SystemBase`/legacy declarations under `Assets/Game/Scripts`: `37`.
- Production `ISystem` declarations under `Assets/Game/Scripts`: `136`.
- Current production `ISystem` share: `78.6%`.
- Inventory rows: `173 total`, `165 ProductionNonUI`, `8 ProductionUI`.
- Dispositions: `Converted 129`, `DirectConvert 1`, `ManagedPresentationSystemBaseException 24`, `RetireFold 2`, `ReviewRequired 0`, `SplitThenConvert 9`, `UIOutOfScope 8`.
...
- Direct `ISystem` conversion candidates selected: `1`.
- Split-before-conversion candidates selected: `9`.
- Remaining retired/folded non-UI `SystemBase` boundaries selected: `2`.
- Converted production `ISystem` rows in inventory: `129`.
- Current target: `Phase 7 single-thread domain execution: Integration P7-0328 SceneLifecycleSystem disabled managed scene helper wrapper folded out of ECS; continue remaining Integration rows; P7-0003/P7-0019 remain held pending an explicit managed-reference boundary guardrail/model change`.
...
- [x] Fold Agent F `P7-0260 BuildingPlacementVisualCompositionSystem` from a disabled `SystemBase` wrapper into a plain building placement visual composition helper and validate building placement runtime behavior, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent F `P7-0262 BuildingPlacementVisualUpdateSystem` from a disabled `SystemBase` wrapper into a plain building placement visual update helper and validate building placement runtime behavior, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent F `P7-0241 RuntimeCityVisualSystem` from a disabled `SystemBase` wrapper into a plain runtime city visual helper and validate runtime-city focused behavior, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent F `P7-0242 RuntimeCityYardWallVisualSystem` from a disabled `SystemBase` wrapper into a plain runtime city yard-wall visual helper and validate runtime-city focused behavior, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
...
- [x] Fold Agent F `P7-0263 BuildingRuntimeVisualSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime building visual helper and validate building selection marker behavior, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
...
- [x] Fold Integration `P7-0320 MatchStartRequestSystem` from a disabled `SystemBase` wrapper into a plain direct-owned match start request helper and validate queue behavior, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
