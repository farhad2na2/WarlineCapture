...
namespace Game.Configs
{
    ...
    public sealed class SkirmishArmyProfileConfig : ScriptableObject
    {
        ...
        public bool AllowsAdvancedGround =>
            Allows(SkirmishRoleIds.Tank) ||
            Allows(SkirmishRoleIds.ApcHeavy) ||
            Allows(SkirmishRoleIds.Siege);
        ...
        public void ConfigureCombinedArms()
        {
            ...
            excludedRoleIds = System.Array.Empty<string>();
            contentVersion = 1;
        }
