...
public sealed class BattleHudGameplayBridgeConnectionTests
{
    ...
    public void SetUp()
    {
        ...
        _world = new World("BattleHudGameplayBridgeConnectionTests");
        ...
        InvokeAwake(_overlay.GetComponent<BattleHudTacticalFeedbackController>());
        InvokeAwake(_overlay.GetComponent<BattleHudGameplayBridge>());
    }
    ...
    {
        BuildDrawerPanelController drawer = _overlay.GetComponent<BuildDrawerPanelController>();
        CommandWheelPanelController wheel = _overlay.GetComponent<CommandWheelPanelController>();
        InvokeAwake(drawer);
        InvokeAwake(wheel);
    ...
    private static Entity CreatePlayerUnit(EntityManager em, string displayName, int2 cell, int health)
    {
        ...
        em.AddComponentData(entity, new UnitDisplayInfo
        {
            ...
            Description = new FixedString128Bytes("Gameplay bridge test unit")
        });
