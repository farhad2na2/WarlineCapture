...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(424, projection["reviewedNonDebtRowCount"])
        self.assertEqual(151, projection["genuineDebtRowCount"])
        self.assertEqual(75, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`424` non-debt and `151` genuine-debt", tracker)
        self.assertIn("`75` unique file/rule items", tracker)
        self.assertIn("`151` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(416, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(151, review["genuineDebtRowCount"])
        self.assertEqual(75, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(151, len(debt_rows))
