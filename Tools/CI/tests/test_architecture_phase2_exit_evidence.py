...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(449, projection["reviewedNonDebtRowCount"])
        self.assertEqual(126, projection["genuineDebtRowCount"])
        self.assertEqual(50, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`449` non-debt and `126` genuine-debt", tracker)
        self.assertIn("`50` unique file/rule items", tracker)
        self.assertIn("`126` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(441, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(126, review["genuineDebtRowCount"])
        self.assertEqual(50, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(126, len(debt_rows))
