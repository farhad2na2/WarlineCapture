...
Implementation handoff: use `../WarlineCapture_M01_FirstContact_Production_Contract.md` for concrete tactical metadata anchors, UI command feedback, FTUE targets, asset manifest, audio/VFX requirements, and validation gates.
