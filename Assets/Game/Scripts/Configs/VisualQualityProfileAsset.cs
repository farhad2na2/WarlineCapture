...
namespace Game.Configs
{
    ...
    public sealed class VisualQualityProfileAsset : ScriptableObject
    {
        ...
        [SerializeField] private UniversalRenderPipelineAsset highRenderPipelineAsset;
        [SerializeField] private UniversalRenderPipelineAsset renderPipelineAsset;
        [SerializeField] private VolumeProfile highVolumeProfile;
        ...
        [SerializeField, Range(0.25f, 1f)] private float highRenderScaleOverride = 0.75f;
        [SerializeField] private bool enableHighCameraPostProcessing = true;
        ...
        public UniversalRenderPipelineAsset HighRenderPipelineAsset => highRenderPipelineAsset;
        public UniversalRenderPipelineAsset RenderPipelineAsset => renderPipelineAsset;
        public VolumeProfile HighVolumeProfile => highVolumeProfile;
        ...
        public float HighRenderScaleOverride => highRenderScaleOverride;
        public bool EnableHighCameraPostProcessing => enableHighCameraPostProcessing;
        ...
        public float HighSunShadowStrength => highSunShadowStrength;
