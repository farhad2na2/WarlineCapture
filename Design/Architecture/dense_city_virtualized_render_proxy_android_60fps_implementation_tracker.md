...
| Phase 2: Deterministic database builder | In progress; generated bake-config schema, exact output ownership, deterministic source-row inventory, shared compound prototype recipes, and exact render-only logical placements accepted; building state linkage remains deferred and no config asset was created |
...
Checklist progress: `15 / 80` complete.
