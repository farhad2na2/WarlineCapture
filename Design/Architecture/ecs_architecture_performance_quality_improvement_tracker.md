...
- [x] Fold Agent E `P7-0146 RuntimeCityBuildingPlotUtilitySystemHelper`, `P7-0166 RuntimeCityLayoutSystem`, and `P7-0180 RuntimeCityWalkabilityUtilitySystemHelper` from disabled `SystemBase` wrappers into plain direct-owned runtime-city core helpers and validate runtime city focused generation, compile, and Phase 7 architecture guard.
