...
This document turns the AAA mobile promise into concrete validation targets for 3D operation-map gameplay, UI readability, and performance. Use it with `Architecture/performance_regression_contract.md`, `WarlineCapture_3D_SingleMap_Gameplay_Direction.md`, and `WarlineCapture_LargeScale_Grid_Movement_Design.md`.
