...
## Batch 227 - Selection UI Read-Model UI Helper

`SelectionUiReadModelSystem` owns the UI-facing `ISelectionUiReadModel` adapter, focused-unit status/health/capability reads, transport passenger reads, selected-unit presence checks, and camera-backed visible-player-unit screen queries. This batch renamed it to the approved UI-helper suffix while preserving the Unity `.meta` GUID.

| Status | Old type/file | New type/file | Reason |
| --- | --- | --- | --- |
| Complete | `SelectionUiReadModelSystem` | `SelectionUiReadModelUiSystemHelper` | UI read-model adapter with managed camera/UI read boundaries; not scheduled by ECS. |

## Batch 227 Validation Log

- `python3 Tools/Architecture/generate_non_ecs_system_inventory.py`: completed; inventory denominator is now `2`.
- `git diff --check`: passed.
- `dotnet build Assembly-CSharp.csproj --no-restore -v:minimal`: passed.
- `dotnet build Assembly-CSharp-Editor.csproj --no-restore -v:minimal`: passed.
- `/Applications/Unity/Hub/Editor/6000.4.0f1/Unity.app/Contents/MacOS/Unity -batchmode -nographics -quit -projectPath /Users/farhad/Projects/WarlineCapture-Clone -executeMethod SelectionUiReadModelLookupTests.RunFocusedValidation -logFile /private/tmp/warline-non-ecs-helper-naming-batch227-readmodel-lookup.log`: passed with `[SelectionUiReadModelLookupValidation] result=Passed tests=5`.
- `/Applications/Unity/Hub/Editor/6000.4.0f1/Unity.app/Contents/MacOS/Unity -batchmode -nographics -quit -projectPath /Users/farhad/Projects/WarlineCapture-Clone -executeMethod MatchHudSquadTraySelectionUiSystemHelperTests.RunFocusedValidation -logFile /private/tmp/warline-non-ecs-helper-naming-batch227-squad-tray.log`: passed with `[MatchHudSquadTraySelectionFocusedValidation] result=Passed tests=3`.
- `/Applications/Unity/Hub/Editor/6000.4.0f1/Unity.app/Contents/MacOS/Unity -batchmode -nographics -quit -projectPath /Users/farhad/Projects/WarlineCapture-Clone -executeMethod RtsSelectionInputSystemTests.RunFocusedValidation -logFile /private/tmp/warline-non-ecs-helper-naming-batch227-rts-selection-input.log`: passed with `[RtsSelectionInputSystemValidation] result=Passed tests=56`.
- `/Applications/Unity/Hub/Editor/6000.4.0f1/Unity.app/Contents/MacOS/Unity -batchmode -nographics -quit -projectPath /Users/farhad/Projects/WarlineCapture-Clone -executeMethod NonEcsSystemConversionArchitectureTests.RunFocusedValidation -logFile /private/tmp/warline-non-ecs-helper-naming-batch227-architecture.log`: passed with `[NonEcsSystemConversionArchitectureValidation] result=Passed tests=9` and `runtimeNonEcsDenominator=2`.

## Batch 228 - Visible Unit Selection Camera Helper

`VisibleUnitSelectionSystem` owns the managed camera screen-rectangle filtering and selected-tag application around ECS visible-unit candidate data. This batch renamed it to the approved camera-helper suffix while preserving the Unity `.meta` GUID.

| Status | Old type/file | New type/file | Reason |
| --- | --- | --- | --- |
| Complete | `VisibleUnitSelectionSystem` | `VisibleUnitSelectionCameraSystemHelper` | Camera-backed visible-unit screen filtering and selection tag application; candidate collection remains in ECS. |

## Batch 228 Validation Log

- `python3 Tools/Architecture/generate_non_ecs_system_inventory.py`: completed; inventory denominator is now `1`.
- `git diff --check`: passed.
- `dotnet build Assembly-CSharp.csproj --no-restore -v:minimal`: passed.
- `dotnet build Assembly-CSharp-Editor.csproj --no-restore -v:minimal`: passed with the existing Unity XML copy warning and `0` errors.
- `/Applications/Unity/Hub/Editor/6000.4.0f1/Unity.app/Contents/MacOS/Unity -batchmode -nographics -quit -projectPath /Users/farhad/Projects/WarlineCapture-Clone -executeMethod SelectionStateCompositionSystemHelperTests.RunFocusedValidation -logFile /private/tmp/warline-non-ecs-helper-naming-batch228-selection-state.log`: passed with `[SelectionStateFocusedValidation] result=Passed tests=8`.
- `/Applications/Unity/Hub/Editor/6000.4.0f1/Unity.app/Contents/MacOS/Unity -batchmode -nographics -quit -projectPath /Users/farhad/Projects/WarlineCapture-Clone -executeMethod RtsSelectionInputSystemTests.RunFocusedValidation -logFile /private/tmp/warline-non-ecs-helper-naming-batch228-rts-selection-input.log`: passed with `[RtsSelectionInputSystemValidation] result=Passed tests=56`.
- `/Applications/Unity/Hub/Editor/6000.4.0f1/Unity.app/Contents/MacOS/Unity -batchmode -nographics -quit -projectPath /Users/farhad/Projects/WarlineCapture-Clone -executeMethod NonEcsSystemConversionArchitectureTests.RunFocusedValidation -logFile /private/tmp/warline-non-ecs-helper-naming-batch228-architecture.log`: passed with `[NonEcsSystemConversionArchitectureValidation] result=Passed tests=9` and `runtimeNonEcsDenominator=1`.

## Batch 229 - UI Screen Route Flow UI Helper

`UIScreenRouteFlowSystem` owns route stack state, registered screen lookup, screen prefab instantiation, and show/hide transitions behind `UIRouterView`. This batch renamed it to the approved UI-helper suffix while preserving the Unity `.meta` GUID.

| Status | Old type/file | New type/file | Reason |
| --- | --- | --- | --- |
| Complete | `UIScreenRouteFlowSystem` | `UIScreenRouteFlowUiSystemHelper` | UI route-flow state and screen transition helper; not scheduled by ECS. |

## Batch 229 Validation Log

- `python3 Tools/Architecture/generate_non_ecs_system_inventory.py`: completed; inventory denominator is now `0`.
- `git diff --check`: passed.
- `dotnet build Assembly-CSharp.csproj --no-restore -v:minimal`: passed.
- `dotnet build Assembly-CSharp-Editor.csproj --no-restore -v:minimal`: passed.
- `/Applications/Unity/Hub/Editor/6000.4.0f1/Unity.app/Contents/MacOS/Unity -batchmode -nographics -quit -projectPath /Users/farhad/Projects/WarlineCapture-Clone -executeMethod NonEcsSystemConversionArchitectureTests.RunFocusedValidation -logFile /private/tmp/warline-non-ecs-helper-naming-batch229-architecture.log`: failed on the obsolete positive-denominator assertion after the inventory reached `runtimeNonEcsDenominator=0`.
- Guardrail ratchet completed in `Assets/Tests/Editor/NonEcsSystemConversionArchitectureTests.cs`: the inventory enumeration test now accepts the completed zero-denominator state while the generated-inventory sync test still fails missing or stale rows.
- `/Applications/Unity/Hub/Editor/6000.4.0f1/Unity.app/Contents/MacOS/Unity -batchmode -nographics -quit -projectPath /Users/farhad/Projects/WarlineCapture-Clone -executeMethod NonEcsSystemConversionArchitectureTests.RunFocusedValidation -logFile /private/tmp/warline-non-ecs-helper-naming-batch229-architecture-rerun.log`: passed with `[NonEcsSystemConversionArchitectureValidation] result=Passed tests=9` and `runtimeNonEcsDenominator=0`.
- `/Applications/Unity/Hub/Editor/6000.4.0f1/Unity.app/Contents/MacOS/Unity -batchmode -nographics -quit -projectPath /Users/farhad/Projects/WarlineCapture-Clone -executeMethod UIShellCurrentContentLoadTests.RunFocusedValidation -logFile /private/tmp/warline-non-ecs-helper-naming-batch229-ui-shell-content.log`: failed before route-flow behavior on documented pre-existing prefab reference debt, `statusChipSprite must be assigned on the placement bar prefab`.

## Open Follow-Up Batches

- None for runtime non-ECS bare `*System` naming; the generated inventory denominator is `0`.
