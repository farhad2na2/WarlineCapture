...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(448, projection["reviewedNonDebtRowCount"])
        self.assertEqual(127, projection["genuineDebtRowCount"])
        self.assertEqual(51, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`448` non-debt and `127` genuine-debt", tracker)
        self.assertIn("`51` unique file/rule items", tracker)
        self.assertIn("`127` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(440, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(127, review["genuineDebtRowCount"])
        self.assertEqual(51, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(127, len(debt_rows))
