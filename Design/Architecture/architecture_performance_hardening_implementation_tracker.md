...
| Last update | 2026-07-14 - Exact building-definition cloning with one footprint override moved into a 70-line stateless helper, reducing the runtime spawn facade from 531 to 473 lines. Clone/config projection `3/3`, non-ECS architecture/naming `9/9`, exact source-policy `2/2`, both project builds, and Menu-to-Match smoke pass. The global inventory is now 26 unrelated oversized owners. |
...
- Validation: building cost/config/clone projection passed `3/3`; non-ECS architecture/naming passed `9/9`; exact source authorization passed `2/2`; Runtime and Editor-test builds passed with zero errors; Menu-to-Match smoke reached `MatchHudReady`, completed Match Intro, and unlocked input
- Artifacts: `/private/tmp/warline-building-definition-footprint-clone-focused.xml`, `/private/tmp/warline-building-definition-clone-naming.log`, `/private/tmp/warline-building-definition-clone-source-policy.xml`, `/private/tmp/warline-building-definition-clone-source-growth-full.log`, and `/private/tmp/warline-building-definition-clone-match-smoke.log`
