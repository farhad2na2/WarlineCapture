...
- In progress: `0`.
- Remaining open: `69`.
- Current target: `Phase 7 single-thread domain execution: Agent D helper fold complete for P7-0070/P7-0137/P7-0061/P7-0069/P7-0068/P7-0067; continue next low-risk Agent D row`.
...
- Production `SystemBase`/legacy declarations under `Assets/Game/Scripts`: `220`.
...
- Direct `ISystem` conversion candidates selected: `54`.
- Split-before-conversion candidates selected: `115`.
- Retired/folded non-UI `SystemBase` boundaries selected: `29`.
