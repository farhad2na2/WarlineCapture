...
- Gameplay-facing content must follow `Design/WarlineCapture_3D_SingleMap_Gameplay_Direction.md`.
...
0. Apply the 3D operation-map HUD work order.
   - Use `Design/WarlineCapture_UIUX_Gameplay_Element_Alignment.md` as the current handoff for operation-map gameplay UI.
   ...
   - Use `Design/WarlineCapture_3D_SingleMap_Gameplay_Direction.md` as the current target audit for stale/missing tactical state targets.
...
- Selected entity, command mode, world command markers, invalid command feedback, and minimap camera-jump hooks exist as named UI elements in `WarlineCapture_UIUX_Gameplay_Element_Alignment.md`.
