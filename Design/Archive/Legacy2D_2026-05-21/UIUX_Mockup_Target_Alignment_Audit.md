...
Status: Historical UI target audit snapshot. This file captured alignment before the 2026-05-21 return to full 3D single-map gameplay and the command-base Main Menu target. Use it for process history only. Active UI target work should follow `3D_SingleMap_Gameplay_Direction.md`, `UIUX_MainMenu_Visual_Contract.md`, `UIUX_Mockup_To_Canvas_Conversion_Plan.md`, and `UIUX_Target_To_Canvas_Workflow_Guide.md`.
...
- `UIUX_Screen_Popup_Implementation_Spec.md`
- `UIUX_Mockup_To_Canvas_Conversion_Plan.md`
...
- Resource and reward icons must use canonical names from `Economy_Reward_Design.md`.
...
| Reward preview and deterministic grants | SCN-06 reward tiles, POP-04 unlock, POP-05 reward grid. | Covered; reward types must come from `Economy_Reward_Design.md`. |
...
- SCN-15 Inbox, SCN-16 Events, SCN-17 Ranking, and SCN-18 Command Feed remain designed-unavailable route contracts in `UIUX_Gameplay_Element_Alignment.md`; they do not yet require full visual-lock targets for the Chapter 1 surface set.
...
- It must use the canonical visual target listed in `UIUX_Mockup_To_Canvas_Conversion_Plan.md` or the SCN-14 monetization target for store work.
- It must bind all visible text, counters, icons, rows, cards, meters, and buttons to the gameplay data listed in `UIUX_Gameplay_Element_Alignment.md`.
...
- It must use canonical economy resources and rewards from `Economy_Reward_Design.md`.
- It must pass the target-to-canvas workflow in `UIUX_Target_To_Canvas_Workflow_Guide.md`.
