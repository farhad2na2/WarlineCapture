...
Overall implementation progress: 31% (54/177 checklist items complete).
...
| 6. Metadata, camera, minimap, and movement binding | In progress / shared | 9 | 12 | 75% | Scenario-required anchors validate against map metadata; camera bounds/poses, ARIA Show Me, minimap projection, startup grid domain, authoritative surface payload, and current runway/helipad records are authored from accepted sources. Active-map aircraft consumers and lifecycle regressions are accepted. |
