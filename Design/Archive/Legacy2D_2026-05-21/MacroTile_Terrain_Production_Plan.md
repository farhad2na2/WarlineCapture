...
This plan covers the tactical/zoomed-in playable map lane in `Strategic_Tactical_Map_Gameplay_Alignment.md`. Strategic previews and minimaps are separate outputs that reference the same mission/map ids but are approved in UI/navigation context.
