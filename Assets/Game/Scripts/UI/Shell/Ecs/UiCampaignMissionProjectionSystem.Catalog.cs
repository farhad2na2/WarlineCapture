...
namespace Game.UI.Shell.Ecs
{
    public partial struct UiCampaignMissionProjectionSystem
    {
        ...
        {
            bool changed=false;
            for(int i=0;i<CampaignMissionSequence.RegisteredMissionCount-1;i++)
