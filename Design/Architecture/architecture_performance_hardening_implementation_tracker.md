...
| Current task | Reduce the clean APH-803 peak allocated-memory result from `1,085.77 MB` to the unchanged `967.5 MB` budget without visual downgrade, while collecting APH-804 release and APH-809 visual evidence |
...
| Last verified commit | `8568654b249bde2dc12fadb88468d2abcc38adf5` on `origin/main`; architecture implementation commit `98cb2bb6d4321132574ebc5247aa3f2c93359eac` |
| Last update | 2026-07-15 - clean exact-revision APH-803 development evidence now passes frame, approved p99/startup, process, crash, and thermal checks; peak allocated memory remains red at `1,085.77 MB` against `967.5 MB`, and APH-804/APH-809 evidence remains open |
...
- [~] `APH-804` Add Android release-build acceptance for the documented 30 FPS tier; keep 60 FPS as a separate high-end target.
  ...
  - Current blocker: the static presentation manifest prerequisite is resolved at `f850f3a5bdc6b3f4ffa8ad7ab453c07611fb5e8a`. A clean exact-revision release APK/AAB and BuildReport have not yet been generated from that revision, and same-device release collection waits for the pinned phone to reconnect and satisfy the unplugged/idle-thermal preflight.
