...
| R4 durable recovery | Same-attempt restart/withdrawal and fresh-process checkpoint resume pass; deeper interruption states remain open | Scan/carrier/terminal process recovery, exact-once settlement, cross-mode checks |
| R5 UI/EN/FA/ARIA | Normal-input EN/FA victories and real-input ARIA Regular 1102/2102/3102/4102 victories passed; popup/dashboard localization smoke passed; seed 5102, FA 9102 and review pending | Real-input ARIA matrix, interruption/resume and layout/audio review |
