...
- `Assets/Game/Scripts/Systems/BuildingPlacementStartupSystem.cs`, `BuildingPlacementGridSystem.cs`, `BuildingPlacementVisualUpdateSystem.cs`, `BuildingRuntimeContextCompositionSystemHelper.cs`, and `BuildingRuntimeQueryCompositionSystemHelper.cs`: placement and runtime building centers use `BuildPlaneY` or flatten world y.
