...
namespace Game.Editor
{
    ...
    public static class SkirmishS002GameViewCapture
    {
        ...
        static SkirmishS002GameViewCapture()
        {
        ...
        public static void LaunchRegularStandard()
        {
            if (EditorApplication.isPlaying)
                throw new InvalidOperationException("Exit play mode before launching S002 Regular Standard.");
        ...
        public static string DescribeLaunchPayload()
        {
            ...
            return "[SkirmishS002GameView] selected " + payload.FormatSelectedConfiguration();
        }
