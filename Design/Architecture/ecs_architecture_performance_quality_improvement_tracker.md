...
- [ ] Treat `Design/Architecture/five_systembase_to_isystem_conversion_tracker.md` as the required sub-track for `BuildingSpawnCompositionSystemHelper`, `BuildingProductionTransportBridgeCompositionSystemHelper`, `CitizenVisibleUnitSystem`, `MapVehiclePlacementSpawnSystem`, and `CustomGameStartupSystem`.
