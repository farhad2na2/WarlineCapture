...
public static class BattleScenarioAd002Runner
{
    public const string ScenarioId = "AD-002_AirMissileLauncher_InterceptEnemyJet_RadarComparison";

    private const int Seed = 22345;
    ...
    private static readonly float3 JetEndPosition = new(-30f, 14f, 0f);
    ...
    public static BattleScenarioVariant[] CreateDefaultVariants()
    {
        return new[]
        {
            ...
            {
                VariantId = "AD-002-A-NoSupport-Jet",
                Label = "No Support / Enemy Jet",
            ...
            new BattleScenarioVariant
            {
                VariantId = "AD-002-B-RadarNear-Jet",
                Label = "Radar Near / Enemy Jet",
    ...
    public static BattleScenarioResult RunDefinition(BattleScenarioDefinition definition)
    {
        ...
        if (definition.ScenarioId != ScenarioId)
            throw new ArgumentException($"Unsupported AD-002 scenario id '{definition.ScenarioId}'.", nameof(definition));
        ...
        BattleScenarioFixedStepState state)
    {
        ...
        transform.Position = math.lerp(start, JetEndPosition, t);
