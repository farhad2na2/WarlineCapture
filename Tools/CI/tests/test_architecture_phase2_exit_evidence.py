...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(409, projection["reviewedNonDebtRowCount"])
        self.assertEqual(166, projection["genuineDebtRowCount"])
        self.assertEqual(78, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`409` non-debt and `166` genuine-debt", tracker)
        self.assertIn("`78` unique file/rule items", tracker)
        self.assertIn("`166` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(401, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(166, review["genuineDebtRowCount"])
        self.assertEqual(78, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(166, len(debt_rows))
