...
Status: Legacy source/reference spec. Superseded for active visual/gameplay direction on 2026-05-21 by `3D_SingleMap_Gameplay_Direction.md`, `UIUX_MainMenu_Visual_Contract.md`, and `UIUX_Gameplay_Element_Alignment.md`.
...
- **Responsive feedback:** Shared button pulses, locked-state wiggles, validation toasts, resource flyouts, meter deltas, popup/drawer motion, tactical command markers, critical warning feedback, and paired audio event ids are defined in `Design/Visual_Feedback_VFX_Recommendations.md` and `Design/Audio_Design_Guidelines.md`.
...
- **Canonical visual-lock targets:** The high-quality generated target PNG paths for all `SCN-*`, `POP-*`, and `PREFAB-*` surfaces are listed in `Design/UIUX_Mockup_To_Canvas_Conversion_Plan.md` under `Canonical Visual-Lock Target Inventory`. Use the active 3D/command-base targets for production Canvas matching; the JPGs embedded below remain source/content references.
...
![SCN-01 Splash / Loading](UIUX_Codex_Package/uiux_spec_assets/SCN-01_splash_loading.jpg)
...
![SCN-02 Main Menu / Mode Select](UIUX_Codex_Package/uiux_spec_assets/SCN-02_main_menu_mode_select.jpg)
...
![SCN-03 Commander Profile](UIUX_Codex_Package/uiux_spec_assets/SCN-03_commander_profile.jpg)
...
![SCN-04 Settings & Accessibility](UIUX_Codex_Package/uiux_spec_assets/SCN-04_settings_accessibility.jpg)
...
### SCN-05 - Saga Map
![SCN-05 Saga Map](UIUX_Codex_Package/uiux_spec_assets/SCN-05_saga_map.jpg)
...
![SCN-06 Mission Briefing](UIUX_Codex_Package/uiux_spec_assets/SCN-06_mission_briefing.jpg)
...
![SCN-07 Loadout / Squad Prep](UIUX_Codex_Package/uiux_spec_assets/SCN-07_loadout_squad_prep.jpg)
...
![SCN-08 RTS Battle HUD](UIUX_Codex_Package/uiux_spec_assets/SCN-08_rts_battle_hud.jpg)
...
![SCN-09 Build Drawer / Production](UIUX_Codex_Package/uiux_spec_assets/SCN-09_build_drawer_production.jpg)
...
![SCN-10 Unit Command / Command Wheel](UIUX_Codex_Package/uiux_spec_assets/SCN-10_unit_command_wheel.jpg)
...
![SCN-11 Persistent Operation Dashboard](UIUX_Codex_Package/uiux_spec_assets/SCN-11_operation_dashboard.jpg)
...
![SCN-12 District Detail / Actions](UIUX_Codex_Package/uiux_spec_assets/SCN-12_district_detail_actions.jpg)
...
![SCN-13 Quick Custom Game Setup](UIUX_Codex_Package/uiux_spec_assets/SCN-13_quick_custom_game_setup.jpg)
...
### POP-01 - Threat Alert
![POP-01 Threat Alert](UIUX_Codex_Package/uiux_spec_assets/POP-01_threat_alert.jpg)
...
### POP-02 - Confirm Raid
![POP-02 Confirm Raid](UIUX_Codex_Package/uiux_spec_assets/POP-02_confirm_raid.jpg)
...
![POP-03 Build Placement](UIUX_Codex_Package/uiux_spec_assets/POP-03_build_placement.jpg)
...
![POP-04 Reward / Unlock](UIUX_Codex_Package/uiux_spec_assets/POP-04_reward_unlock.jpg)
...
![POP-05 Mission Result](UIUX_Codex_Package/uiux_spec_assets/POP-05_mission_result.jpg)
...
![POP-06 End of Day Report](UIUX_Codex_Package/uiux_spec_assets/POP-06_end_of_day_report.jpg)
...
![POP-07 Pause / Options](UIUX_Codex_Package/uiux_spec_assets/POP-07_pause_options.jpg)
...
### POP-08 - Intel Reveal
![POP-08 Intel Reveal](UIUX_Codex_Package/uiux_spec_assets/POP-08_intel_reveal.jpg)
...
![PREFAB-01 Objective Tracker](UIUX_Codex_Package/uiux_spec_assets/PREFAB-01_objective_tracker.jpg)
...
![PREFAB-02 Squad Tray](UIUX_Codex_Package/uiux_spec_assets/PREFAB-02_squad_tray.jpg)
...
![PREFAB-03 Build Drawer](UIUX_Codex_Package/uiux_spec_assets/PREFAB-03_build_drawer.jpg)
