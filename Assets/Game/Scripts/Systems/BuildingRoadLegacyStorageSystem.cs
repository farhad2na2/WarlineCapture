...
internal sealed class BuildingRoadLegacyStorageSystem
{
    private readonly RuntimeBuildingSystem<RuntimeBuildingData> _runtimeBuildingSystem = new();

    public IReadOnlyDictionary<int, RuntimeBuildingData> RuntimeBuildings => _runtimeBuildingSystem.Buildings;
    ...
    public void AddBuilding(RuntimeBuildingData building)
    {
        if (building == null)
            return;
    ...
    public bool TryGetBuilding(int buildingId, out RuntimeBuildingData building)
    {
        return _runtimeBuildingSystem.TryGetBuilding(buildingId, out building);
    }

    public bool TryGetSelectedBuilding(out RuntimeBuildingData building)
    {
        building = null;
