...
| 6. Metadata, camera, minimap, and movement binding | In progress / shared | 8 | 12 | 67% | Scenario-required anchors validate against map metadata; camera bounds/poses, ARIA Show Me, minimap projection, startup grid domain, authoritative surface payload, and current runway/helipad records are authored from accepted sources. Active-map runway and helipad read-model publication is integrated; runtime aircraft acceptance remains open. |
...
- [ ] Bind runway and helipad anchors for taxi, takeoff, return, and landing behavior. Loader-neutral exact typed resolution, fail-closed validation, geometry semantics, and deterministic current-map records are implemented. Active-map runways publish through the faction runway read model; active-map helipads bind exact centers into the existing mutable production-slot read model. Per-faction compatibility and activation/teardown invalidation are preserved. Current-map runtime aircraft acceptance remains pending. See `../AgentReports/2026-07-17_operation_map_infrastructure_anchor_foundation.md`, `../AgentReports/2026-07-17_operation_map_infrastructure_anchor_geometry_contract.md`, `../AgentReports/2026-07-17_operation_map_current_infrastructure_anchor_records.md`, `../AgentReports/2026-07-17_operation_map_runway_read_model_binding.md`, and `../AgentReports/2026-07-17_operation_map_helipad_read_model_binding.md`.
