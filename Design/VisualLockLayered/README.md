...
| `SCN-19_Armory` | Unit/building/support roster inspection. | Shows name, description, role, unlock state, level/tier, stats, abilities, upgrades, parts, source. Target and V01 layer pack generated with Skirmish-style secondary header. |
