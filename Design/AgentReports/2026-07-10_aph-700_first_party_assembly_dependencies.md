...
| `Game.UI.Shell.Ecs` | `Assets/Game/Scripts/UI/Shell/Ecs/Game.UI.Shell.Ecs.asmdef` | 41 | 33 | 8 | 5 |
...
| `Game.Composition` | `Game.Configs` | 153 | 46 | 14 |
| `Game.Composition` | `Game.Narrative.Contracts` | 38 | 6 | 6 |
...
| `Game.Composition` | `Game.UI.Runtime` | 71 | 22 | 13 |
| `Game.Composition` | `Game.UI.Shell.Contracts.Ecs` | 53 | 12 | 4 |
...
| `Game.Editor` | `Game.Configs` | 193 | 35 | 30 |
...
| `Game.Tests.Editor` | `Game.Components` | 10292 | 383 | 162 |
...
| `Game.Tests.Editor` | `Game.Narrative.Contracts` | 13 | 5 | 4 |
...
| `Game.Tests.Editor` | `Game.Runtime` | 2784 | 371 | 149 |
...
| `Game.Tests.Editor` | `Game.UI.Shell.Contracts.Ecs` | 449 | 31 | 29 |
...
| 16 | `Game.Tests.Editor` | `Game.Components` | `Game.Components.RtsSelectionCommandResultElement` | 185 | 15 |
| 17 | `Game.Tests.Editor` | `Game.Components` | `Game.Components.ResourceExchangeQueueComponent` | 183 | 17 |
...
| 24 | `Game.Tests.Editor` | `Game.Components` | `Game.Components.FactionEconomy` | 157 | 32 |
...
| 27 | `Game.Runtime` | `Game.Components` | `Game.Components.UnitPathRequest` | 142 | 49 |
| 28 | `Game.Tests.Editor` | `Game.Components` | `Game.Components.FactionTacticalMaterialsComponent` | 140 | 29 |
...
| 32 | `Game.Runtime` | `Game.Components` | `Game.Components.EngageTarget` | 132 | 42 |
| 33 | `Game.Runtime` | `Game.Components` | `Game.Components.UnitTarget` | 131 | 43 |
| 34 | `Game.Runtime` | `Game.Components` | `Game.Components.FactionEconomy` | 129 | 19 |
...
| 41 | `Game.Runtime` | `Game.Components` | `Game.Components.UnitSourcePrefabKey` | 108 | 38 |
| 42 | `Game.Runtime` | `Game.Components` | `Game.Components.GridRoad` | 107 | 38 |
| 43 | `Game.Tests.Editor` | `Game.Runtime` | `Game.Runtime.RtsSelectionInputCompositionSystemHelper` | 107 | 7 |
| 44 | `Game.Runtime` | `Game.Components` | `Game.Components.FactionTacticalMaterialsComponent` | 106 | 15 |
