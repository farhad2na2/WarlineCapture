...
`VisibleUnitSelectionCameraSystemHelper.HasVisiblePlayerUnits` now reuses the same filtered screen-rect scan as `CollectVisiblePlayerUnits` with early exit, deleting a duplicate visible-selection snapshot.
