...
internal sealed class BuildingRoadLegacyGridSystem
{
    ...
    {
        private readonly BuildingRoadLegacyGridSystem _system;
        private Context _context;

        public State(BuildingRoadLegacyGridSystem system)
        {
            _system = system;
        }
