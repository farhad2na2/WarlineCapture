...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(435, projection["reviewedNonDebtRowCount"])
        self.assertEqual(140, projection["genuineDebtRowCount"])
        self.assertEqual(64, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`435` non-debt and `140` genuine-debt", tracker)
        self.assertIn("`64` unique file/rule items", tracker)
        self.assertIn("`140` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(427, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(140, review["genuineDebtRowCount"])
        self.assertEqual(64, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(140, len(debt_rows))
