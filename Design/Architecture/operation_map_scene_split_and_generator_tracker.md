...
- [ ] Bind runway and helipad anchors for taxi, takeoff, return, and landing behavior. Loader-neutral exact typed resolution, fail-closed validation, geometry semantics, and deterministic current-map records are implemented. Active-map runways now publish through the existing faction runway read model with per-faction building fallback and activation/teardown invalidation; helipad gameplay consumer integration and runtime aircraft acceptance remain pending. See `../AgentReports/2026-07-17_operation_map_infrastructure_anchor_foundation.md`, `../AgentReports/2026-07-17_operation_map_infrastructure_anchor_geometry_contract.md`, `../AgentReports/2026-07-17_operation_map_current_infrastructure_anchor_records.md`, and `../AgentReports/2026-07-17_operation_map_runway_read_model_binding.md`.
