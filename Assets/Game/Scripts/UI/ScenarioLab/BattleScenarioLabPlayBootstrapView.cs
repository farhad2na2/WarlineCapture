...
namespace Game.UI.ScenarioLab.Runtime
{
    public sealed class BattleScenarioLabPlayBootstrapView : MonoBehaviour
    {
        ...
        public void RunScenario()
        {
            ...
            catch (Exception ex)
            {
                ...
                Game.UI.Contracts.UiDiagnostics.Error($"[BattleScenarioLab] Scenario run failed: {ex}");
            }
        }
