...
- Task: `APH-700`
- Exact commit: `ae88ed74af37f57197f0a1719f95be5e0be26bd6`
- Environment identity SHA-256: `1750156ad389d4f28a392531d19339a96140da898d5c2dfd1920c38d6486239e`
- Dirty at capture start: `true`
- Source fingerprint (SHA-256): `3d92b0a2988d551e74c05bdcb703cb24a2b94cfcd5b75401ba79e88ad30b5d93`
...
| Owned C# source files | 2282 |
| Indexed visible types | 3892 |
| Resolved cross-domain type occurrences | 50772 |
| Distinct cross-domain type references | 4391 |
...
| `Game.Editor` | `Assets/Game/Scripts/Editor/Game.Editor.asmdef` | 342 | 464 | 19 | 20 |
...
| `Game.Runtime` | `Assets/Game/Scripts/Game.Runtime.asmdef` | 672 | 1200 | 10 | 10 |
...
| `Game.Tests.Editor` | `Assets/Tests/Editor/Game.Tests.Editor.asmdef` | 517 | 529 | 20 | 14 |
...
| `Game.Editor` | `Game.Configs` | 981 | 87 | 115 |
...
| `Game.Editor` | `Game.UI.Runtime` | 1865 | 136 | 93 |
...
| `Game.Runtime` | `Game.Components` | 12342 | 525 | 469 |
...
| `Game.Tests.Editor` | `Game.Components` | 14301 | 511 | 250 |
| `Game.Tests.Editor` | `Game.Composition` | 312 | 42 | 38 |
| `Game.Tests.Editor` | `Game.Configs` | 1639 | 124 | 127 |
| `Game.Tests.Editor` | `Game.Editor` | 772 | 130 | 71 |
...
| `Game.Tests.Editor` | `Game.Runtime` | 3661 | 458 | 203 |
...
| `Game.Tests.Editor` | `Game.UI.Contracts` | 486 | 88 | 57 |
| `Game.Tests.Editor` | `Game.UI.Runtime` | 1411 | 140 | 73 |
...
| 3 | `Game.Tests.Editor` | `Game.Components` | `Game.Components.Faction` | 462 | 70 |
| 4 | `Game.Runtime` | `Game.Components` | `Game.Components.UnitGrid` | 407 | 100 |
| 5 | `Game.Runtime` | `Game.Components` | `Game.Components.Faction` | 384 | 101 |
| 6 | `Game.Tests.Editor` | `Game.Components` | `Game.Components.UnitHealth` | 372 | 63 |
...
| 18 | `Game.Tests.Editor` | `Game.Components` | `Game.Components.CampaignMissionRuntimeComponent` | 207 | 36 |
...
| 30 | `Game.Editor` | `Game.UI.Runtime` | `Game.UI.Runtime.MainMenuV3SectionLayoutView` | 164 | 36 |
...
| 38 | `Game.Tests.Editor` | `Game.Components` | `Game.Components.UnitPathRequest` | 147 | 24 |
...
| 46 | `Game.Tests.Editor` | `Game.Components` | `Game.Components.UnitCombat` | 131 | 29 |
| 47 | `Game.Tests.Editor` | `Game.Components` | `Game.Components.UnitMovementBehavior` | 130 | 30 |
| 48 | `Game.Runtime` | `Game.Components` | `Game.Components.FactionTacticalMaterialsComponent` | 130 | 23 |
| 49 | `Game.Tests.Editor` | `Game.Configs` | `Game.Configs.ScenarioSetupConfig` | 130 | 22 |
| 50 | `Game.Tests.Editor` | `Game.Components` | `Game.Components.AudioPlaybackRequestElement` | 130 | 17 |
