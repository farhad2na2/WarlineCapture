...
Use `../3D_SingleMap_Gameplay_Direction.md` before turning these mission slots into detailed specs. Intel/raid previews, minimap, deployment, and battle view are camera/UI states on the same 3D operation map.
