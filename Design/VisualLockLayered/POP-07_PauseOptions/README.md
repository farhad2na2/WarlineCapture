# POP-07_PauseOptions Layer Pack

This pack is the mandatory VisualLockLayered source for `Pause Options Popup`. It was created while reworking the popup track after the earlier popup implementation skipped the layer-pack gate.

## Gate Rules

- Reference target: `reference/POP-07_PauseOptions_Landscape_Target.png`
