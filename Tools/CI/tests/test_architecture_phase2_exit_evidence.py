...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(456, projection["reviewedNonDebtRowCount"])
        self.assertEqual(119, projection["genuineDebtRowCount"])
        self.assertEqual(46, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`456` non-debt and `119` genuine-debt", tracker)
        self.assertIn("`46` unique file/rule items", tracker)
        self.assertIn("`119` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(448, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(119, review["genuineDebtRowCount"])
        self.assertEqual(46, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(119, len(debt_rows))
