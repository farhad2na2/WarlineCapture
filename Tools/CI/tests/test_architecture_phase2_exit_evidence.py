...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(461, projection["reviewedNonDebtRowCount"])
        self.assertEqual(114, projection["genuineDebtRowCount"])
        self.assertEqual(45, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`461` non-debt and `114` genuine-debt", tracker)
        self.assertIn("`45` unique file/rule items", tracker)
        self.assertIn("`114` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(453, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(114, review["genuineDebtRowCount"])
        self.assertEqual(45, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(114, len(debt_rows))
