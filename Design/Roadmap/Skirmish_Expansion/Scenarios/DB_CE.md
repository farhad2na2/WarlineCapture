# Desert Base — Convoy Escort: implementation packet
...
- Map: `opmap.skirmish.desert_base_01`; layout `layout.skirmish.db.ce`. Three truck bays at west depot; destination east evacuation pad; routes a/b: highway / southern service road; two defender tower slots, holding pockets, repair service pads.
...
**Desert Base · Convoy Escort · Ground Maneuver · Field Base** — handoff work ordinal **21**. One of the 117 remaining new catalog combinations.

**Bind:** catalog `S019`; definition `skirmish.s019`; scenario `scenario.skirmish.s019`; map `opmap.skirmish.desert_base_01`; objective `CE`; army `G`; start `F`. Prerequisite tickets: `SK-00;SK-01;SK-02;SK-03;SK-04;SK-05;SK-09;SK-10;SK-11;SK-12;SK-13`. Required capability tags: `ground;intel;transport;advanced_ground;objective_ce;vehicle_repair`. Recommended later size `War` is gated; first visit remains Standard.

**Opening and decisions:** Leave trucks at origin until a scout and cheap ground escort check the first exposed segment. Two intended approaches: Use gunner/rocketeer infantry on highway, or send APCs ahead along southern service road and move trucks between holding pockets. These describe tactical options, not a mandatory click sequence or AI script.
...
**Implementation sequence:** (1) Compile exactly the identity/profile/layout above and match all three size rows to [INITIAL_SETUP_MATRIX](../INITIAL_SETUP_MATRIX.csv), including caps/storage/BT substitution/CE support. (2) Bind the packet’s objective roles and all starting/group/producer/route anchors; simulate both viable approaches with real movement. (3) Install `SkirmishConvoyObjectiveSystem` and its typed state; preserve the exact terminal/clock semantics. (4) Wire producer costs/queues, contextual controls and objective/army HUD from the resolved snapshot; add keys `skirmish.s019.{title,brief,objective,warning.*,result.*}` in EN/FA. (5) Expose the same public role/route/goal affordances to enemy and ARIA policies through their separate legal observations/actuators. (6) Verify checkpoint and result/replay, then publish only this entry’s certified size/difficulty matrix.
...
**ARIA must play and win:** Regular seeds `104748`, `130382`, `155940` in both EN and FA at Standard: three full normal-speed runs per locale, at least two real wins in each, all traces/losses retained. Additional exposed difficulty wins at Standard/EN use Recruit `196632`, Veteran `262166`, Commander `327692`. Additional exposed sizes need a full Regular EN and FA win at War seed `393260` and Large War seed `458898`, plus their device/recovery gates. These samples supplement per-configuration legality checks; all four difficulties are required for final catalog completion. ARIA uses visible controls, no hidden knowledge/state mutation/extra resources, no human tactical intervention or restart in a counted win. A Draw is not a win.

**Completion artifact:** Config and code hashes; compiled setup/actual entity census; normal human win; ARIA matrix; loss/deadline/surrender and unique edge fixtures; saved-result/replay/checkpoint evidence; camera/map/EN/FA/device review. Store evidence under `Design/AgentReports/SkirmishExpansion/S019/` and update only this publication row after every required gate. Authoring a valid asset does not mark it Accepted.

## S020

**Desert Base · Convoy Escort · Ground Maneuver · Established Base** — handoff work ordinal **22**. One of the 117 remaining new catalog combinations.

**Bind:** catalog `S020`; definition `skirmish.s020`; scenario `scenario.skirmish.s020`; map `opmap.skirmish.desert_base_01`; objective `CE`; army `G`; start `E`. Prerequisite tickets: `SK-00;SK-01;SK-02;SK-03;SK-04;SK-05;SK-09;SK-10;SK-11;SK-12;SK-13`. Required capability tags: `ground;intel;transport;advanced_ground;objective_ce;vehicle_repair`. Recommended later size `War` is gated; first visit remains Standard.
...
**Implementation sequence:** (1) Compile exactly the identity/profile/layout above and match all three size rows to [INITIAL_SETUP_MATRIX](../INITIAL_SETUP_MATRIX.csv), including caps/storage/BT substitution/CE support. (2) Bind the packet’s objective roles and all starting/group/producer/route anchors; simulate both viable approaches with real movement. (3) Install `SkirmishConvoyObjectiveSystem` and its typed state; preserve the exact terminal/clock semantics. (4) Wire producer costs/queues, contextual controls and objective/army HUD from the resolved snapshot; add keys `skirmish.s020.{title,brief,objective,warning.*,result.*}` in EN/FA. (5) Expose the same public role/route/goal affordances to enemy and ARIA policies through their separate legal observations/actuators. (6) Verify checkpoint and result/replay, then publish only this entry’s certified size/difficulty matrix.
...
**ARIA must play and win:** Regular seeds `104749`, `130383`, `155941` in both EN and FA at Standard: three full normal-speed runs per locale, at least two real wins in each, all traces/losses retained. Additional exposed difficulty wins at Standard/EN use Recruit `196633`, Veteran `262167`, Commander `327693`. Additional exposed sizes need a full Regular EN and FA win at War seed `393261` and Large War seed `458899`, plus their device/recovery gates. These samples supplement per-configuration legality checks; all four difficulties are required for final catalog completion. ARIA uses visible controls, no hidden knowledge/state mutation/extra resources, no human tactical intervention or restart in a counted win. A Draw is not a win.

**Completion artifact:** Config and code hashes; compiled setup/actual entity census; normal human win; ARIA matrix; loss/deadline/surrender and unique edge fixtures; saved-result/replay/checkpoint evidence; camera/map/EN/FA/device review. Store evidence under `Design/AgentReports/SkirmishExpansion/S020/` and update only this publication row after every required gate. Authoring a valid asset does not mark it Accepted.

## S021

**Desert Base · Convoy Escort · Air Mobile · Field Base** — handoff work ordinal **23**. One of the 117 remaining new catalog combinations.

**Bind:** catalog `S021`; definition `skirmish.s021`; scenario `scenario.skirmish.s021`; map `opmap.skirmish.desert_base_01`; objective `CE`; army `A`; start `F`. Prerequisite tickets: `SK-00;SK-01;SK-02;SK-03;SK-04;SK-05;SK-09;SK-10;SK-11;SK-12;SK-13`. Required capability tags: `ground;intel;transport;offensive_air;advanced_air;objective_ce;vehicle_repair`. Recommended later size `War` is gated; first visit remains Standard.

**Opening and decisions:** Start with a ground escort and scout both truck routes; air research competes with convoy protection funds. Two intended approaches: Use an APC infantry escort on southern service road, or delay departure for a limited air-support transition without exhausting the deadline. These describe tactical options, not a mandatory click sequence or AI script.
...
**ARIA must play and win:** Regular seeds `104750`, `130384`, `155942` in both EN and FA at Standard: three full normal-speed runs per locale, at least two real wins in each, all traces/losses retained. Additional exposed difficulty wins at Standard/EN use Recruit `196634`, Veteran `262168`, Commander `327694`. Additional exposed sizes need a full Regular EN and FA win at War seed `393262` and Large War seed `458900`, plus their device/recovery gates. These samples supplement per-configuration legality checks; all four difficulties are required for final catalog completion. ARIA uses visible controls, no hidden knowledge/state mutation/extra resources, no human tactical intervention or restart in a counted win. A Draw is not a win.

**Completion artifact:** Config and code hashes; compiled setup/actual entity census; normal human win; ARIA matrix; loss/deadline/surrender and unique edge fixtures; saved-result/replay/checkpoint evidence; camera/map/EN/FA/device review. Store evidence under `Design/AgentReports/SkirmishExpansion/S021/` and update only this publication row after every required gate. Authoring a valid asset does not mark it Accepted.

## S022

**Desert Base · Convoy Escort · Air Mobile · Established Base** — handoff work ordinal **24**. One of the 117 remaining new catalog combinations.

**Bind:** catalog `S022`; definition `skirmish.s022`; scenario `scenario.skirmish.s022`; map `opmap.skirmish.desert_base_01`; objective `CE`; army `A`; start `E`. Prerequisite tickets: `SK-00;SK-01;SK-02;SK-03;SK-04;SK-05;SK-09;SK-10;SK-11;SK-12;SK-13`. Required capability tags: `ground;intel;transport;offensive_air;advanced_air;objective_ce;vehicle_repair`. Recommended later size `War` is gated; first visit remains Standard.
...
**Implementation sequence:** (1) Compile exactly the identity/profile/layout above and match all three size rows to [INITIAL_SETUP_MATRIX](../INITIAL_SETUP_MATRIX.csv), including caps/storage/BT substitution/CE support. (2) Bind the packet’s objective roles and all starting/group/producer/route anchors; simulate both viable approaches with real movement. (3) Install `SkirmishConvoyObjectiveSystem` and its typed state; preserve the exact terminal/clock semantics. (4) Wire producer costs/queues, contextual controls and objective/army HUD from the resolved snapshot; add keys `skirmish.s022.{title,brief,objective,warning.*,result.*}` in EN/FA. (5) Expose the same public role/route/goal affordances to enemy and ARIA policies through their separate legal observations/actuators. (6) Verify checkpoint and result/replay, then publish only this entry’s certified size/difficulty matrix.
...
**ARIA must play and win:** Regular seeds `104751`, `130385`, `155943` in both EN and FA at Standard: three full normal-speed runs per locale, at least two real wins in each, all traces/losses retained. Additional exposed difficulty wins at Standard/EN use Recruit `196635`, Veteran `262169`, Commander `327695`. Additional exposed sizes need a full Regular EN and FA win at War seed `393263` and Large War seed `458901`, plus their device/recovery gates. These samples supplement per-configuration legality checks; all four difficulties are required for final catalog completion. ARIA uses visible controls, no hidden knowledge/state mutation/extra resources, no human tactical intervention or restart in a counted win. A Draw is not a win.

**Completion artifact:** Config and code hashes; compiled setup/actual entity census; normal human win; ARIA matrix; loss/deadline/surrender and unique edge fixtures; saved-result/replay/checkpoint evidence; camera/map/EN/FA/device review. Store evidence under `Design/AgentReports/SkirmishExpansion/S022/` and update only this publication row after every required gate. Authoring a valid asset does not mark it Accepted.

## S023

**Desert Base · Convoy Escort · Combined Arms · Field Base** — handoff work ordinal **25**. One of the 117 remaining new catalog combinations.

**Bind:** catalog `S023`; definition `skirmish.s023`; scenario `scenario.skirmish.s023`; map `opmap.skirmish.desert_base_01`; objective `CE`; army `C`; start `F`. Prerequisite tickets: `SK-00;SK-01;SK-02;SK-03;SK-04;SK-05;SK-09;SK-10;SK-11;SK-12;SK-13`. Required capability tags: `ground;intel;transport;offensive_air;advanced_ground;advanced_air;objective_ce;vehicle_repair`. Recommended later size `War` is gated; first visit remains Standard.

**Opening and decisions:** Choose tank escort investment or air scouting; the three objective trucks do not replace Oil/Fuel logistics. Two intended approaches: Clear highway with mixed infantry/armor, or draw enemy reserve away and take southern service road. These describe tactical options, not a mandatory click sequence or AI script.
...
**Implementation sequence:** (1) Compile exactly the identity/profile/layout above and match all three size rows to [INITIAL_SETUP_MATRIX](../INITIAL_SETUP_MATRIX.csv), including caps/storage/BT substitution/CE support. (2) Bind the packet’s objective roles and all starting/group/producer/route anchors; simulate both viable approaches with real movement. (3) Install `SkirmishConvoyObjectiveSystem` and its typed state; preserve the exact terminal/clock semantics. (4) Wire producer costs/queues, contextual controls and objective/army HUD from the resolved snapshot; add keys `skirmish.s023.{title,brief,objective,warning.*,result.*}` in EN/FA. (5) Expose the same public role/route/goal affordances to enemy and ARIA policies through their separate legal observations/actuators. (6) Verify checkpoint and result/replay, then publish only this entry’s certified size/difficulty matrix.
...
**ARIA must play and win:** Regular seeds `104752`, `130386`, `155944` in both EN and FA at Standard: three full normal-speed runs per locale, at least two real wins in each, all traces/losses retained. Additional exposed difficulty wins at Standard/EN use Recruit `196636`, Veteran `262170`, Commander `327696`. Additional exposed sizes need a full Regular EN and FA win at War seed `393264` and Large War seed `458902`, plus their device/recovery gates. These samples supplement per-configuration legality checks; all four difficulties are required for final catalog completion. ARIA uses visible controls, no hidden knowledge/state mutation/extra resources, no human tactical intervention or restart in a counted win. A Draw is not a win.

**Completion artifact:** Config and code hashes; compiled setup/actual entity census; normal human win; ARIA matrix; loss/deadline/surrender and unique edge fixtures; saved-result/replay/checkpoint evidence; camera/map/EN/FA/device review. Store evidence under `Design/AgentReports/SkirmishExpansion/S023/` and update only this publication row after every required gate. Authoring a valid asset does not mark it Accepted.

## S024

**Desert Base · Convoy Escort · Combined Arms · Established Base** — handoff work ordinal **26**. One of the 117 remaining new catalog combinations.

**Bind:** catalog `S024`; definition `skirmish.s024`; scenario `scenario.skirmish.s024`; map `opmap.skirmish.desert_base_01`; objective `CE`; army `C`; start `E`. Prerequisite tickets: `SK-00;SK-01;SK-02;SK-03;SK-04;SK-05;SK-09;SK-10;SK-11;SK-12;SK-13`. Required capability tags: `ground;intel;transport;offensive_air;advanced_ground;advanced_air;objective_ce;vehicle_repair`. Recommended later size `War` is gated; first visit remains Standard.
...
**Implementation sequence:** (1) Compile exactly the identity/profile/layout above and match all three size rows to [INITIAL_SETUP_MATRIX](../INITIAL_SETUP_MATRIX.csv), including caps/storage/BT substitution/CE support. (2) Bind the packet’s objective roles and all starting/group/producer/route anchors; simulate both viable approaches with real movement. (3) Install `SkirmishConvoyObjectiveSystem` and its typed state; preserve the exact terminal/clock semantics. (4) Wire producer costs/queues, contextual controls and objective/army HUD from the resolved snapshot; add keys `skirmish.s024.{title,brief,objective,warning.*,result.*}` in EN/FA. (5) Expose the same public role/route/goal affordances to enemy and ARIA policies through their separate legal observations/actuators. (6) Verify checkpoint and result/replay, then publish only this entry’s certified size/difficulty matrix.
...
**ARIA must play and win:** Regular seeds `104753`, `130387`, `155945` in both EN and FA at Standard: three full normal-speed runs per locale, at least two real wins in each, all traces/losses retained. Additional exposed difficulty wins at Standard/EN use Recruit `196637`, Veteran `262171`, Commander `327697`. Additional exposed sizes need a full Regular EN and FA win at War seed `393265` and Large War seed `458903`, plus their device/recovery gates. These samples supplement per-configuration legality checks; all four difficulties are required for final catalog completion. ARIA uses visible controls, no hidden knowledge/state mutation/extra resources, no human tactical intervention or restart in a counted win. A Draw is not a win.

**Completion artifact:** Config and code hashes; compiled setup/actual entity census; normal human win; ARIA matrix; loss/deadline/surrender and unique edge fixtures; saved-result/replay/checkpoint evidence; camera/map/EN/FA/device review. Store evidence under `Design/AgentReports/SkirmishExpansion/S024/` and update only this publication row after every required gate. Authoring a valid asset does not mark it Accepted.
