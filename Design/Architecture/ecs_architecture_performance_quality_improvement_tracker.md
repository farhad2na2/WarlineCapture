...
- Checklist progress: `244 / 244 complete (100.0%)`.
- In progress: `0`.
- Remaining open: `0`.
- Current target: `Phase 7 single-thread domain execution: Agent E helper fold complete for P7-0189 CitizenPopulationCompositionSystem; continue remaining Agent E split/managed-exception candidates`.
...
- Latest Phase 7 Agent A/B/C/D/E/F validation: inventory generator, MonoBehaviour loop baseline generator, 42-row manual review classification, validation matrix, integration branch/handoff contract, editor compile, `git diff --check`, and focused architecture guard passed; inventory `Design/Architecture/systembase_to_isystem_inventory.md`, MonoBehaviour loop baseline `Design/Architecture/phase7_monobehaviour_loop_baseline.md` (`41` existing loop keys after unchanged UI Toolkit baseline drift was captured), handoff template `Design/AgentReports/phase7_domain_handoff_template.md`, guard log `/private/tmp/warline-phase7-agent-a-architecture.log` (`[NonUiSystemBaseMigrationArchitectureValidation] result=Passed tests=18`). Agent B converted `P7-0010` `AIPlanEntryStartupSystem`, `P7-0015` `FactionEconomyStartupSystem`, `P7-0008` `AIFactionControlStartupSystem`, `P7-0016` `InitialFactionSpawnCellSystem`, `P7-0021` `RuntimeDiagnosticsSystem`, `P7-0022` `RuntimeGameplayStateSystem`, `P7-0013` `AIStartupSystem`, and `P7-0005` `AICombatOrderSystem` to clean `ISystem` rows; `P7-0020` `PerformanceDiagnosticsSystem`, `P7-0002` `MapSurfaceRuntimeBootstrapSystem`, all open Agent C SystemBase rows, Agent F `P7-0281` `SelectionScreenMarkerSystem`, and `P7-0259` `BuildingMarkerVisualCompositionSystem` were folded out of ECS into plain manually owned helpers/facades. Agent F `P7-0249` `UnitModelSpawnSystem` and `P7-0251` `UnitRenderBudgetSystem` now consume `RuntimeCameraSnapshotComponent` instead of managed `Camera`; inventory marks both rows `Converted`. Agent F `P7-0283` `CombatGameObjectVfxPlaybackSystem` and `P7-0284` `UnitAttackVfxRequestSystem` moved to `UnitAttackVfxSystems.cs` as reviewed managed presentation exceptions consuming ECS VFX request data; `P7-0338` `UnitAttackSystem` is now inventoried as converted with no GameObject blocker. Agent D has no remaining open Agent D inventory rows. Agent E folded `P7-0144` `RuntimeCityArchwaySpawnSystem`, `P7-0145` `RuntimeCityBuildingPlacementSystem`, `P7-0146` `RuntimeCityBuildingPlotSystem`, `P7-0147` `RuntimeCityBuildingSpawnContextSystem`, `P7-0149` `RuntimeCityBulkPlotPlanSystem`, `P7-0150` `RuntimeCityChainSystem`, `P7-0154` `RuntimeCityCorridorBuildingSpawnSystem`, `P7-0158` `RuntimeCityEntryBuildingSpawnSystem`, `P7-0175` `RuntimeCityRoadsideBuildingSpawnSystem`, `P7-0179` `RuntimeCitySurfaceIntegrationSystem`, `P7-0182` `RuntimeCityYardWallPlanSystem`, `P7-0190` `CitizenPopulationDebugSystem`, `P7-0193` `CitizenPopulationEventSystem`, `P7-0194` `CitizenPopulationLifecycleSystem`, `P7-0196` `CitizenPopulationRuntimeUpdateSystem`, `P7-0198` `CitizenPopulationTotalsSystem`, `P7-0202` `CitizenResourceSystem`, `P7-0203` `CitizenScheduleSystem`, `P7-0216` `RoadBuildDependencySystem`, `P7-0217` `RoadBuildDisposalSystem`, `P7-0222` `RoadBuildMutationSystem`, `P7-0228` `RoadDeletePromptSystem`, `P7-0230` `RoadMinimapEventSystem`, `P7-0232` `RoadPathPlanningSystem`, `P7-0237` `RoadSurfacePlacementSystem`, `P7-0238` `RuntimeGridBootstrapSystem`, `P7-0157` `RuntimeCityDiagnosticSystem`, `P7-0163` `RuntimeCityIngressSystem`, `P7-0164` `RuntimeCityLandmarkOffsetSystem`, `P7-0166` `RuntimeCityLayoutSystem`, `P7-0167` `RuntimeCityLifecycleSystem`, `P7-0168` `RuntimeCityMinimapEventSystem`, `P7-0170` `RuntimeCityReadModelSystem`, `P7-0171` `RuntimeCityReadinessQuerySystem`, `P7-0172` `RuntimeCityRoadBuildBridgeSystem`, `P7-0173` `RuntimeCityRoadCommitSystem`, `P7-0174` `RuntimeCityRoadLayoutSystem`, `P7-0180` `RuntimeCityWalkabilitySystem`, `P7-0181` `RuntimeCityYardGateSystem`, `P7-0185` `CitizenBuildingReadSystem`, `P7-0187` `CitizenHouseholdRegistrationSystem`, `P7-0191` `CitizenPopulationDiagnosticSystem`, `P7-0192` `CitizenPopulationEcsProjectionSystem`, `P7-0195` `CitizenPopulationReadModelSystem`, `P7-0197` `CitizenPopulationStateSystem`, `P7-0201` `CitizenRefugeeSystem`, `P7-0204` `CitizenStatusTransitionSystem`, `P7-0208` `RoadBuildCommandSystem`, `P7-0211` `RoadBuildCompositionSourceSystem`, `P7-0214` `RoadBuildContextSystem`, `P7-0220` `RoadBuildInteractionContextSystem`, `P7-0224` `RoadBuildReadModelSystem`, `P7-0226` `RoadBuildSessionSystem`, `P7-0231` `RoadNetworkSystem`, `P7-0234` `RoadRuntimeGenerationContextSystem`, and `P7-0235` `RoadRuntimeGenerationSystem`, plus `P7-0159` `RuntimeCityFreeScatterDecorationSystem`, `P7-0161` `RuntimeCityHallSpawnSystem`, `P7-0162` `RuntimeCityHouseYardWallSystem`, `P7-0165` `RuntimeCityLandmarkSpawnSystem`, `P7-0176` `RuntimeCityRuralBuildingSpawnSystem`, and `P7-0177` `RuntimeCitySpawnBridgeSystem`, and `P7-0169` `RuntimeCityPrefabSelectionSystem`, and `P7-0178` `RuntimeCityStartupSystem`, `P7-0186` `CitizenDangerSystem`, `P7-0236` `RoadRuntimeRootSystem`, `P7-0210` `RoadBuildCompositionLifecycleSystem`, `P7-0209` `RoadBuildCompositionContextSystem`, `P7-0212` `RoadBuildCompositionSystem`, `P7-0225` `RoadBuildRuntimeActionSystem`, `P7-0207` `RoadBuildBuildingPlacementSystem`, `P7-0218` `RoadBuildEcsBoundarySystem`, `P7-0219` `RoadBuildInputSystem`, `P7-0221` `RoadBuildInteractionSystem`, `P7-0223` `RoadBuildPlacementStorageSystem`, `P7-0233` `RoadPreviewSystem`, `P7-0183` `RuntimeDecorationSpawnerSystem`, `P7-0184` `RuntimeGridBlockerSystem`, and `P7-0189` `CitizenPopulationCompositionSystem`, out of ECS into plain Agent E helpers. Latest inventory reports `59` production SystemBase/legacy declarations, `134` production ISystem declarations, and `69.4%` production ISystem share. Latest Agent E validations passed `/private/tmp/warline-phase7-agent-e-citizen-population-composition-helper-fold-citizen-visible-unit.log` (`[CitizenVisibleUnitFocusedValidation] result=Passed tests=3`), and `/private/tmp/warline-phase7-agent-a-architecture.log` (`[NonUiSystemBaseMigrationArchitectureValidation] result=Passed tests=18`). Prior Agent D/F/B/C log paths remain recorded in the active lane trackers and handoff reports. Continue on remaining Agent E split/managed-exception rows.
- Latest Phase 7 slice: Agent E folded `P7-0189` `CitizenPopulationCompositionSystem` from a disabled `SystemBase` wrapper into a plain citizen population composition helper. Validation passed `/private/tmp/warline-phase7-agent-e-citizen-population-composition-helper-fold-citizen-visible-unit.log` (`[CitizenVisibleUnitFocusedValidation] result=Passed tests=3`) and `/private/tmp/warline-phase7-agent-a-architecture.log` (`[NonUiSystemBaseMigrationArchitectureValidation] result=Passed tests=18`). Inventory now reports `59` production SystemBase/legacy declarations, `134` production ISystem declarations, and `69.4%` production ISystem share.
...
- Phase 7 checklist progress: `155 / 159 complete (97.5%)`.
- Phase 7 in progress: `0`.
- Phase 7 remaining open: `0`.
- Authoritative inventory generation date: `2026-06-22`.
- Authoritative classified inventory: `Design/Architecture/systembase_to_isystem_inventory.md`.
- Production `SystemBase`/legacy declarations under `Assets/Game/Scripts`: `59`.
- Production `ISystem` declarations under `Assets/Game/Scripts`: `134`.
- Current production `ISystem` share: `69.4%`.
- Inventory rows: `193 total`, `185 ProductionNonUI`, `8 ProductionUI`.
- Dispositions: `Converted 126`, `DirectConvert 8`, `ManagedPresentationSystemBaseException 22`, `RetireFold 3`, `ReviewRequired 0`, `SplitThenConvert 26`, `UIOutOfScope 8`.
- Non-UI gameplay `SystemBase` retirement target: `0 non-UI runtime gameplay owners`.
- Managed presentation `SystemBase` exception target: `22 non-UI managed presentation/config/camera exceptions currently planned; cap <= 30`.
- Updating `MonoBehaviour` target: `0 newly introduced MonoBehaviour Update/LateUpdate/FixedUpdate/coroutine loops`.
- Direct `ISystem` conversion candidates selected: `18`.
- Split-before-conversion candidates selected: `45`.
- Remaining retired/folded non-UI `SystemBase` boundaries selected: `3`.
- Converted focused `ISystem` processors from this phase: `9`.
- Current target: `Phase 7 single-thread domain execution: Agent E helper fold complete for P7-0189 CitizenPopulationCompositionSystem; continue remaining Agent E split/managed-exception candidates`.
...
- [x] Fold Agent D `P7-0095 BuildingPlacementStartupSystem` from a disabled `SystemBase` wrapper into a plain direct-owned placement startup helper and validate placement command, building composition smoke, compile, and Phase 7 architecture guard.
...
- [x] Fold Agent E `P7-0224 RoadBuildReadModelSystem` from a disabled `SystemBase` wrapper into a plain direct-owned road build read-model helper and validate road-build command behavior, compile, and Phase 7 architecture guard.
...
- [x] Fold Agent E `P7-0147 RuntimeCityBuildingSpawnContextSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city spawn context helper and validate runtime city focused generation, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0157 RuntimeCityDiagnosticSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city diagnostic helper and validate runtime city focused generation, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0170 RuntimeCityReadModelSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city read-model helper and validate runtime city focused generation, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0171 RuntimeCityReadinessQuerySystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city readiness query helper and validate runtime city focused generation, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0181 RuntimeCityYardGateSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city yard-gate helper and validate runtime city focused generation, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0146 RuntimeCityBuildingPlotSystem`, `P7-0166 RuntimeCityLayoutSystem`, and `P7-0180 RuntimeCityWalkabilitySystem` from disabled `SystemBase` wrappers into plain direct-owned runtime-city core helpers and validate runtime city focused generation, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0167 RuntimeCityLifecycleSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city lifecycle helper and validate runtime city focused generation, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0172 RuntimeCityRoadBuildBridgeSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city road-build bridge helper and validate runtime city focused generation, road-build command behavior, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0173 RuntimeCityRoadCommitSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city road commit helper and validate runtime city focused generation, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0174 RuntimeCityRoadLayoutSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city road layout helper and validate runtime city focused generation, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0149 RuntimeCityBulkPlotPlanSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city bulk plot plan helper and validate runtime city focused generation, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0150 RuntimeCityChainSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city chain helper and validate runtime city focused generation, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0154 RuntimeCityCorridorBuildingSpawnSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city corridor building spawn helper and validate runtime city focused generation, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0158 RuntimeCityEntryBuildingSpawnSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city entry building spawn helper and validate runtime city focused generation, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0182 RuntimeCityYardWallPlanSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city yard-wall plan helper and validate runtime city focused generation, compile, and Phase 7 architecture guard.
...
- [x] Fold Agent E `P7-0216 RoadBuildDependencySystem` from a disabled `SystemBase` wrapper into a plain direct-owned road-build dependency helper and validate road-build command behavior, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0217 RoadBuildDisposalSystem` from a disabled `SystemBase` wrapper into a plain direct-owned road-build disposal helper and validate road-build command behavior, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0222 RoadBuildMutationSystem` from a disabled `SystemBase` wrapper into a plain direct-owned road-build mutation helper and validate road-build command behavior, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0228 RoadDeletePromptSystem` from a disabled `SystemBase` wrapper into a plain direct-owned road-delete prompt helper and validate road-build command behavior, compile, and Phase 7 architecture guard.
...
- [x] Fold Agent E `P7-0144 RuntimeCityArchwaySpawnSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city archway spawn helper and validate runtime-city generation, compile, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0145 RuntimeCityBuildingPlacementSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city building placement helper and validate runtime-city generation, compile, MonoBehaviour loop baseline drift, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0148 RuntimeCityBulkBuildingSpawnRoutineSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city bulk building spawn routine helper and validate runtime-city generation, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0151 RuntimeCityClothCoverSpawnSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city cloth-cover spawn helper and validate runtime-city generation, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0153 RuntimeCityConfigSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city config helper and validate runtime-city generation, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0155 RuntimeCityDecorationBuildingSpawnSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city decoration building spawn helper and validate runtime-city generation, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0156 RuntimeCityDecorationPrefabGroupSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city decoration prefab grouping helper and validate runtime-city generation, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0159 RuntimeCityFreeScatterDecorationSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city free-scatter decoration helper and validate runtime-city generation, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0161 RuntimeCityHallSpawnSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city hall spawn helper and validate runtime-city generation, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0162 RuntimeCityHouseYardWallSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city house-yard-wall helper and validate runtime-city generation, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0165 RuntimeCityLandmarkSpawnSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city landmark spawn helper and validate runtime-city generation, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0176 RuntimeCityRuralBuildingSpawnSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city rural building spawn helper and validate runtime-city generation, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0177 RuntimeCitySpawnBridgeSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city spawn bridge helper and validate runtime-city generation, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0169 RuntimeCityPrefabSelectionSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city prefab selection helper and validate runtime-city generation, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0178 RuntimeCityStartupSystem` from a disabled `SystemBase` wrapper into a plain direct-owned runtime-city startup helper and validate runtime-city generation, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
...
- [x] Fold Agent E `P7-0207 RoadBuildBuildingPlacementSystem` from a disabled `SystemBase` wrapper into a plain road build building placement helper and validate road build command behavior, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
...
- [x] Fold Agent E `P7-0210 RoadBuildCompositionLifecycleSystem` from a disabled `SystemBase` wrapper into a plain road build lifecycle helper and validate road build command behavior, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0209 RoadBuildCompositionContextSystem` from a disabled `SystemBase` wrapper into a plain road build context factory helper and validate road build command behavior, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0212 RoadBuildCompositionSystem` from a disabled `SystemBase` wrapper into a plain road build composition helper and validate road build command behavior, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0225 RoadBuildRuntimeActionSystem` from a disabled `SystemBase` wrapper into a plain road build runtime action helper and validate road build command behavior, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0218 RoadBuildEcsBoundarySystem` from a disabled `SystemBase` wrapper into a plain road build ECS boundary helper and validate road build command behavior, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
...
- [x] Fold Agent E `P7-0219 RoadBuildInputSystem` from a disabled `SystemBase` wrapper into a plain road build input helper and validate road build command behavior, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0221 RoadBuildInteractionSystem` from a disabled `SystemBase` wrapper into a plain road build interaction helper and validate road build command behavior, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0223 RoadBuildPlacementStorageSystem` from a disabled `SystemBase` wrapper into a plain road build placement storage helper and validate road build command behavior, compile, inventory regeneration, `git diff --check`, and Phase 7 architecture guard.
- [x] Fold Agent E `P7-0226 RoadBuildSessionSystem` from a disabled `SystemBase` wrapper into a plain direct-owned road-build session helper and validate road-build command behavior, compile, and Phase 7 architecture guard.
