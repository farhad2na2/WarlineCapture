...
| Phase 4: Surface and blocker proxies | In progress; deterministic map-scoped proxy generation, compatible merging, and finite map-bounds enforcement complete |
