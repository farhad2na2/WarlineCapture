...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(408, projection["reviewedNonDebtRowCount"])
        self.assertEqual(167, projection["genuineDebtRowCount"])
        self.assertEqual(79, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`408` non-debt and `167` genuine-debt", tracker)
        self.assertIn("`79` unique file/rule items", tracker)
        self.assertIn("`167` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(400, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(167, review["genuineDebtRowCount"])
        self.assertEqual(79, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(167, len(debt_rows))
