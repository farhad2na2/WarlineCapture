...
public sealed class RtsSelectionRuntimeInputContextSystem
{
    public RtsSelectionRuntimeInputSystem.Context Create(
        ...
        Func<Unity.Entities.Entity, Vector2, bool> tryIssueBoardSelectedTransportOrderToClickedUnit,
        Func<Unity.Entities.Entity, Rect, bool> tryIssueBoardSelectedTransportOrderToPassengerRect,
        Func<Unity.Entities.Entity, Vector2, bool> isBoardSelectedTransportPassengerTarget,
        ...
        Func<bool> isGameplayInputLocked)
    {
        return new RtsSelectionRuntimeInputSystem.Context(
            ...
            tryIssueBoardSelectedTransportOrderToPassengerRect,
