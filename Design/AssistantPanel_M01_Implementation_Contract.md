...
|---|---|
| `Design/FTUE_And_Command_Assistant_Design.md` | ARIA role, takeover rules, assistant architecture, FTUE step plan. |
...
These ids are locked by `M01_FirstContact_Production_Contract.md` and must be used for M01 recommendations.
