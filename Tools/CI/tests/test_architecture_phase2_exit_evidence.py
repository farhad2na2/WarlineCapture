...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(440, projection["reviewedNonDebtRowCount"])
        self.assertEqual(135, projection["genuineDebtRowCount"])
        self.assertEqual(59, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`440` non-debt and `135` genuine-debt", tracker)
        self.assertIn("`59` unique file/rule items", tracker)
        self.assertIn("`135` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(432, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(135, review["genuineDebtRowCount"])
        self.assertEqual(59, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(135, len(debt_rows))
