...
| P4R — O001 player-ready integration | **Planned:** R0–R6 in [O001_PLAYER_READY_IMPLEMENTATION.md](O001_PLAYER_READY_IMPLEMENTATION.md): shared launch/ECS/input, real D01 map and tactical decision, durable save/settlement, EN/FA/ARIA and player acceptance. Reuse proven pieces for O002/O003 afterward. | First close the full manual O001 player journey; then durable recovery, actual visible-input ARIA and device/unfamiliar-player release gates. Every gate has candidate-specific evidence. Integration lead owns shared changes; prototype capture success is insufficient. |
