...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(476, projection["reviewedNonDebtRowCount"])
        self.assertEqual(99, projection["genuineDebtRowCount"])
        self.assertEqual(42, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`476` non-debt and `99` genuine-debt", tracker)
        self.assertIn("`42` unique file/rule items", tracker)
        self.assertIn("`99` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(468, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(99, review["genuineDebtRowCount"])
        self.assertEqual(42, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(99, len(debt_rows))
