...
public class BuildingGameplaySystem
{
    ...
    public void BeginSoldierBasePlacement()
    {
        ...
        {
            Debug.LogWarning("BuildingGameplaySystem is missing the Soldier Base spawnable prefab reference.");
            return;
        }
    ...
    public void BeginSoldierTentPlacement()
    {
        ...
        {
            Debug.LogWarning("BuildingGameplaySystem is missing the Soldier Tent spawnable prefab reference.");
            return;
        }
    ...
    public void BeginFactoryPlacement()
    {
        ...
        {
            Debug.LogWarning("BuildingGameplaySystem is missing the Factory spawnable prefab reference.");
            return;
        }
