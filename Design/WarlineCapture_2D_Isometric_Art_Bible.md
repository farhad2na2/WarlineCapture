...
This document defines the production art rules for WarlineCapture's premium 2D isometric mobile RTS direction.

The active terrain approach is large authored macro tiles with separate gameplay metadata. The terrain image should look premium; gameplay truth must remain data-driven.
...
WarlineCapture should read as a premium 2D isometric military RTS: tactical, clean, readable, and visually richer than the current 3D/Synty prototype.
