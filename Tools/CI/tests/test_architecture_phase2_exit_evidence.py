...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(561, projection["reviewedNonDebtRowCount"])
        self.assertEqual(14, projection["genuineDebtRowCount"])
        self.assertEqual(13, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`561` non-debt and `14` genuine-debt", tracker)
        self.assertIn("`13` unique file/rule items", tracker)
        self.assertIn("`14` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(555, review["resolvedNonDebtRowCount"])
        self.assertEqual(6, review["protectedDeferredRowCount"])
        self.assertEqual(14, review["genuineDebtRowCount"])
        self.assertEqual(13, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(14, len(debt_rows))
