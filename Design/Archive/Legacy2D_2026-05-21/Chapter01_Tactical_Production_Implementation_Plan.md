...
- `Art_Asset_Requirements_Register.md`
- `Art_Asset_Requirements_Register.csv`
- `2D_Isometric_Production_Direction.md`
- `2D_Isometric_Art_Bible.md`
- `Tactical_Map_AI_Workflow.md`
...
- use `M01_FirstContact_Production_Contract.md` as the first production target
...
- assign UI owners for the missing tactical controls in `Tactical_UI_Missing_Parts_Work_Order.md`
...
- use `Tactical_UI_Missing_Parts_Work_Order.md` as the active UI handoff
- use `M01_FirstContact_Production_Contract.md` as the concrete M01 implementation handoff
...
1. use `M01_FirstContact_Production_Contract.md` as the first production contract
2. use `Tactical_UI_Missing_Parts_Work_Order.md` as the UI/gameplay handoff before coding M01 select, move, attack, build placement, threat jump, minimap jump, or objective jump behavior
...
7. update `Art_Asset_Requirements_Register.csv` rows for the accepted validation assets as `exists_needs_review`, not `complete`
