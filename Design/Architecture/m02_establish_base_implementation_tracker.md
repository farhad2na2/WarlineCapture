...
|---|---|---|
| M02EB-029 playable implementation | Owner findings in correction | Barracks placement is corrected; M2-only audio/camera/activity/story/voice/highlight findings remain open before the next review |
