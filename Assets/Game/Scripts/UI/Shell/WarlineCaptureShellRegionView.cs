...
public sealed class WarlineCaptureShellRegionView : MonoBehaviour
{
    [SerializeField] private WarlineCaptureShellRegionId regionId;
    ...
    public WarlineCaptureShellRegionId RegionId => regionId;
    ...
    public void Configure(
        WarlineCaptureShellRegionId id,
        RectTransform root,
