...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(444, projection["reviewedNonDebtRowCount"])
        self.assertEqual(131, projection["genuineDebtRowCount"])
        self.assertEqual(55, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`444` non-debt and `131` genuine-debt", tracker)
        self.assertIn("`55` unique file/rule items", tracker)
        self.assertIn("`131` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(436, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(131, review["genuineDebtRowCount"])
        self.assertEqual(55, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(131, len(debt_rows))
