...
| Capture | `Game.Operations.Capture` | Ops-owned Play Mode tactical world shell + phone-mock HUD/victory presentation for O001–O003. Runtime assembly (UnityEngine). Does not open Match/Watch shared UI. |
