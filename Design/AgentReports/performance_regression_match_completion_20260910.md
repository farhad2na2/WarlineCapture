...
| Frame count | 256 |
| Average frame ms | 15.73 |
| P95 frame ms | 23.09 |
| Editor P95 frame budget ms | 20.00 |
| Editor P95 frame budget passed | no |
| P99 frame ms | 35.97 |
| Max frame ms | 103.11 |
| Current-thread allocated bytes | -1 |
| Current-thread counter available (8192-byte control) | no; -1 denotes unavailable |
...
- Stable: `playRequested=1 spawnConfigs=2/2 progressing=0 sourceKeys=5082 performanceFixture=ready addedBuildings=0 addedUnits=83 sourceEntities=5082 buildings=4977 renderStates=105 culledUnits=59`
