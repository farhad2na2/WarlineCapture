...
public sealed class UISettingsTests
{
    ...
    public void SettingsService_PersistsPlayerPrefsValues()
    {
        ...
        model.Graphics.Quality = UIGraphicsQuality.High;
        model.Graphics.FrameRateMode = UIFrameRateMode.Thirty;
        ...
        model.Accessibility.ColorblindMode = UIColorblindMode.Deuteranopia;
        model.Localization.Language = UILanguage.German;
        ...
        Assert.AreEqual(UIGraphicsQuality.High, loaded.Graphics.Quality);
        Assert.AreEqual(UIFrameRateMode.Thirty, loaded.Graphics.FrameRateMode);
        ...
        Assert.AreEqual(UIColorblindMode.Deuteranopia, loaded.Accessibility.ColorblindMode);
        Assert.AreEqual(UILanguage.German, loaded.Localization.Language);
    ...
    public void SettingsAccessibilityApplier_UpdatesStandaloneScaleAndBackgroundContrast()
    {
        ...
        try
        {
            UIAccessibilityApplier accessibilityApplier = instance.GetComponent<UIAccessibilityApplier>();
