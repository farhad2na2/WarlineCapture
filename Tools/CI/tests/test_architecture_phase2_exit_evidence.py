...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(551, projection["reviewedNonDebtRowCount"])
        self.assertEqual(24, projection["genuineDebtRowCount"])
        self.assertEqual(20, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`551` non-debt and `24` genuine-debt", tracker)
        self.assertIn("`20` unique file/rule items", tracker)
        self.assertIn("`24` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(543, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(24, review["genuineDebtRowCount"])
        self.assertEqual(20, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(24, len(debt_rows))
