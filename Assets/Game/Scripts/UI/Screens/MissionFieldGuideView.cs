...
namespace Game.UI.Runtime
{
    ...
    {
        [SerializeField] private ScriptableObject guide, extractionGuide, breachGuide, gridlockGuide;
        private ScriptableObject defenseGuide;
        private IUiMissionGuideSession guideSession;
        private UiMissionGuideCatalog content;
        private bool extractionContext, breachContext, skirmishContext, gridlockContext;
        ...
        private void OnEnable()
        {
            ...
            guide=UiShellRuntimeGateway.IsGridlockGuideContext() && gridlockGuide!=null ? gridlockGuide : UiShellRuntimeGateway.IsBreachGuideContext() && breachGuide!=null ? breachGuide : UiShellRuntimeGateway.IsExtractionGuideContext() && extractionGuide!=null ? extractionGuide : defenseGuide;
            gridlockContext=guide==gridlockGuide; extractionContext=guide==extractionGuide; breachContext=guide==breachGuide;
        ...
        {
            scopedTitle?.SetLocalizedValue(UiShellRuntimeGateway.Localization.Get(skirmishContext?"ui.skirmish.guide.title":gridlockContext?"mission.gridlock.guide.title":breachContext?"mission.m05.guide.title":extractionContext?"mission.m04.guide.title":"mission.m03.guide.title"));
        ...
        public void Refresh()
        {
            ...
            if(radioButton!=null) {radioButton.gameObject.SetActive(!skirmishContext && !extractionContext && !breachContext && !gridlockContext); radioButton.interactable=UiShellRuntimeGateway.TryReadMissionRadioArchive();}
