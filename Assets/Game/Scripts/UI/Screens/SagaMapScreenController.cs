...
public sealed class SagaMapScreenController : MonoBehaviour
{
    ...
    private static bool HasExplicitRoute(WarlineCaptureSagaMissionNodeMetadata metadata)
    {
        return metadata != null
            && metadata.GetComponent<ScreenRouteButton>() != null
            && metadata.GetComponent<WarlineCaptureMissionSessionButton>() != null;
    }
