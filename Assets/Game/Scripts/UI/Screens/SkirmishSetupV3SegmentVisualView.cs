...
namespace Game.UI.Runtime
{
    ...
    public sealed class SkirmishSetupV3SegmentVisualView : MonoBehaviour
    {
        ...
        private UISegmentedControlView segmented;
        ...
        {
            segmented = GetComponent<UISegmentedControlView>();
            if(segmented != null) segmented.SelectionChanged += RefreshSelection;
            Refresh(true);
        }
        ...
        private void RefreshSelection() => Refresh(false);
