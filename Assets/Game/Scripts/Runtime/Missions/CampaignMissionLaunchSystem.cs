...
namespace Game.Runtime
{
    ...
    {
        private static readonly FixedString64Bytes BreachTutorialMission = "saga.ch01.m05.breach_assault";
...
#pragma warning restore 0618
            ...
            in OperationMapReadinessComponent readiness) => new()
        {
            ...
            LaunchOrigin = request.LaunchOrigin, RunKind = request.RunKind, Guidance = (request.MissionId.Equals(RadarTutorialMission) || request.MissionId.Equals(BreachTutorialMission)) ? Game.Narrative.Contracts.NarrativeGuidanceMode.Full : request.Guidance,
            ...
            ReadyReadiness = readiness.ReadyFlags, ReplayTutorialEnabled = (request.MissionId.Equals(RadarTutorialMission) || request.MissionId.Equals(BreachTutorialMission)) ? (byte)1 : request.ReplayTutorialEnabled
        };
