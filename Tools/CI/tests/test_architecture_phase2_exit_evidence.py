...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(511, projection["reviewedNonDebtRowCount"])
        self.assertEqual(64, projection["genuineDebtRowCount"])
        self.assertEqual(29, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`511` non-debt and `64` genuine-debt", tracker)
        self.assertIn("`29` unique file/rule items", tracker)
        self.assertIn("`64` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(503, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(64, review["genuineDebtRowCount"])
        self.assertEqual(29, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(64, len(debt_rows))
