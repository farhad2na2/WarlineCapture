...
namespace Game.Configs
{
    ...
    public static class M04AirliftCopyCatalog
    {
        ...
        public static readonly (string Key,string English,string Persian)[] Ui={
            ("mission.m04.tutorial.selection_progress","Specialists selected: {0}/4. Press Select, then drag a selection box around all four unarmed specialists. Include the highlighted person and leave armed escorts outside the box.","متخصصان انتخاب‌شده: {0} از ۴. «انتخاب» را بزنید، سپس کادر انتخاب را دور هر چهار متخصص غیرمسلح بکشید. فرد مشخص‌شده را هم داخل کادر بگیرید و محافظان مسلح را بیرون بگذارید."),
            ...
            ("mission.m04.specialist.group","{0} SPECIALISTS","{0} متخصص"),
