...
namespace Game.UI.Contracts
{
    ...
    {
        public bool Active, Finished, DrawerOpen, SelectionVisible, AttackMode, MapOpen, MapContactInView, SelectionMode, FocusThreatDrag, FocusGroupDrag, PlacementOpen, AdvancePreferred, ThreatNearForce, AssaultAtBase;
        public Vector2 FocusThreatDragEnd, FocusGroupDragEnd;
        ...
        public AriaTouchTarget AdvanceGround, DefenseBuild, PlacementConfirm, PlacementCancel, FocusPlayer, Select, GroupStart, GroupEnd, FocusEnemy, Attack, Hold, EnemyBase, Recruit, CloseDrawer, Threat, FocusThreat, FocusGroup, CloseMap;
