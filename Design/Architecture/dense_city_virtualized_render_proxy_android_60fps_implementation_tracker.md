...
| Phase 2: Deterministic database builder | Complete through the VRP-067 candidate normalization and capacity acceptance; generated schema/ownership, exact normalized source inventory, shared compound recipes, logical placements, spatial index, exact 12x9/9x12 all-grid camera/projection capacities, transactional config/report, unchanged-input determinism, and persisted source-to-logical field parity are accepted for render-only Vegetation/Prop plus complete House and Shop families. CityHall remains atomically resident under an exact unsupported-policy exclusion. Broader infrastructure/resident-exception expansion remains explicitly owned by later phases. |
...
| Phase 7: Coverage, LOD, and GPU headroom | Dependency-ready at VRP-070; not started |
...
Checklist progress: `54 / 80` complete.
