...
3. Convert static runtime state into ECS singleton components.
4. Replace static logging with ECS log events plus a log flush service.
5. Convert mission-specific hardcoding into mission configs and systems.
6. Retire legacy class names only when touching that domain for real behavior work.
