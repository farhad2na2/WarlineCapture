...
- [x] `BuildingProductionTransportPresentationSystemHelper`: remove runtime `transport.Instance.transform.Find("Model")` fallback.
...
- [x] Replace `BuildingProductionTransportPresentationSystemHelper` model-child fallback with cached transport visual references.
...
- [x] Update `RoadBuildCompositionSourceSystem`, `RoadBuildCompositionContextCompositionSystemHelper`, `RoadBuildCompositionLifecycleCompositionSystemHelper`, `RoadBuildDisposalCompositionSystemHelper`, and `RoadBuildReadModelCompositionSystemHelper`.
