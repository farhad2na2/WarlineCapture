...
Generated from `Design/Project_State_Source.json` on `2026-05-21`.
...
| 3D Operation Map Validation | Art/Runtime | In Progress | 29% | `Design/3D_SingleMap_Gameplay_Direction.md` |
...
| UI Visual Lock And Canvas Conversion | UI | In Progress | 45% | `Design/UIUX_Mockup_To_Canvas_Conversion_Plan.md` |
| Command UI Render Assets | UI/Art | On Hold | 5% | `Design/UIUX_MainMenu_Visual_Contract.md` |
| Audio | Audio | Planned | 18% | `Design/Audio_Design_Guidelines.md` |
| Game Modes, Missions, Progression | Product/Gameplay | Planned | 40% | `Design/Gameplay_Features_Detailed_Spec.md` |
| Monetization And Store | Product/UI | Planned | 18% | `Design/Monetization/Monetization_Strategy.md` |
| Balance And Automated Probes | QA/Gameplay | Planned | 20% | `Design/Balancing_Automated_Test_Plan.md` |
...
- Completion: **29%**
- Area: `Art/Runtime`
- Source: `Design/3D_SingleMap_Gameplay_Direction.md`
- Depends on: -
...
- Completion: **5%**
- Area: `UI/Art`
- Source: `Design/UIUX_MainMenu_Visual_Contract.md`
- Depends on: 3D Operation Map Validation
...
- Completion: **45%**
- Area: `UI`
- Source: `Design/UIUX_Mockup_To_Canvas_Conversion_Plan.md`
...
- Source: `Design/Gameplay_Features_Detailed_Spec.md`
...
- Completion: **20%**
- Area: `QA/Gameplay`
- Source: `Design/Balancing_Automated_Test_Plan.md`
...
- Completion: **18%**
- Area: `Product/UI`
- Source: `Design/Monetization/Monetization_Strategy.md`
...
- Completion: **18%**
- Area: `Audio`
- Source: `Design/Audio_Design_Guidelines.md`
- Depends on: Playable Vertical Slice, UI Visual Lock And Canvas Conversion
