...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(446, projection["reviewedNonDebtRowCount"])
        self.assertEqual(129, projection["genuineDebtRowCount"])
        self.assertEqual(53, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`446` non-debt and `129` genuine-debt", tracker)
        self.assertIn("`53` unique file/rule items", tracker)
        self.assertIn("`129` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(438, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(129, review["genuineDebtRowCount"])
        self.assertEqual(53, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(129, len(debt_rows))
