...
Portrait production must use ids from `VisualConfigs/Combat_Visual_Config_v0_1.json`. Gameplay stats, costs, upgrades, and unlock gates stay in `BalanceConfigs/Combat_Balance_Config_v0_1.json`; do not bake those values into portrait art.
