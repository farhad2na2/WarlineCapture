...
- `check_mobile_ready.py` — Linux/host O001–O003 mobile-ready coach/escort/result checks. No Unity. Marker `[OperationsMobileReadyValidation] result=Passed checks=8`.
...
- `Invoke-OperationsMobileReadyValidation.ps1` — Programmer 1/2: O001–O003 mobile-ready Unity validation against the Ops shadow. Marker `[OperationsMobileReadyValidation] result=Passed checks=8`.
