...
Status: Historical 2D isometric request package. This brief is archived as reference for entity coverage, animation-state coverage, pivots, readability, and asset-manifest thinking. It is superseded for active production by `3D_SingleMap_Gameplay_Direction.md`, the prefab catalog under `Assets/Game/Configs/Prefabs`, and the 3D operation-map validation work. Do not use this brief to request new 2D isometric runtime sprites unless PM explicitly reopens the 2D direction.
...
- Visual config: `Design/VisualConfigs/Combat_Visual_Config_v0_1.json`
...
The full backlog covers every character visual id listed in `Design/VisualConfigs/Combat_Visual_Config_v0_1.json`, including:
