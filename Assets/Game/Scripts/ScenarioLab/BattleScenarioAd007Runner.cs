...
{
    public static class BattleScenarioAd007Runner
    {
        public const string ScenarioId = "AD-007_AirMissileLauncher_ThreatStartsInsideRadarExtendedRange_RadarComparison";

        private const int Seed = 72345;
        ...
        public static BattleScenarioVariant[] CreateDefaultVariants()
        {
            return new[]
            {
                ...
                {
                    VariantId = "AD-007-A-NoSupport-OutsideBaseRange",
                    Label = "No Support / Starts Outside Base Range",
                ...
                new BattleScenarioVariant
                {
                    VariantId = "AD-007-B-RadarNear-InsideExtendedRange",
                    Label = "Radar Near / Starts Inside Extended Range",
        ...
        public static BattleScenarioResult RunDefinition(BattleScenarioDefinition definition)
        {
            ...
            if (definition.ScenarioId != ScenarioId)
                throw new ArgumentException($"Unsupported AD-007 scenario id '{definition.ScenarioId}'.", nameof(definition));
        ...
        private static bool EvaluateResult(BattleScenarioResult result)
        {
            ...
            BattleScenarioMetrics baseline = result.Variants[0];
            ...
            return supported.Intercepted &&
                   ...
                   supported.IncomingThreatDistanceAtDetection > baseline.LauncherEffectiveRange &&
                   supported.DetectionTimeSeconds < baseline.DetectionTimeSeconds &&
