    ...
    public sealed partial class UiShellEcsGateway : IUiMissionTutorialTargetGateway
    {
        ...
        private bool TryReadMissionTutorialTargetCore(out UiMissionTutorialTarget target)
        {
            ...
            if((runtime.MissionId.Equals(new Unity.Collections.FixedString64Bytes(CampaignMissionSequence.RouteReopened)) || runtime.MissionId.Equals(new Unity.Collections.FixedString64Bytes(CampaignMissionSequence.PowerRelay)) || runtime.MissionId.Equals(new Unity.Collections.FixedString64Bytes(CampaignMissionSequence.MarketLifeline)) || runtime.MissionId.Equals(new Unity.Collections.FixedString64Bytes(CampaignMissionSequence.SupplyLine)) || runtime.MissionId.Equals(new Unity.Collections.FixedString64Bytes(CampaignMissionSequence.Gridlock))) &&
                (guidance.GuidanceId>=75001 && guidance.GuidanceId<=75010 || guidance.GuidanceId>=76001 && guidance.GuidanceId<=76004 || guidance.GuidanceId>=77001 && guidance.GuidanceId<=77005 || guidance.GuidanceId>=78001 && guidance.GuidanceId<=78005 || guidance.GuidanceId>=79001 && guidance.GuidanceId<=79206) && em.Exists(guidance.SourceEntity) && em.HasComponent<LocalTransform>(guidance.SourceEntity))
            {
