...
- `check_mobile_ready.py` — Linux/host O001–O003 mobile-ready presentation + pacing checks. No Unity. Marker `[OperationsMobileReadyValidation] result=Passed checks=8`. Does not claim playable.
...
- `Invoke-OperationsMobileReadyValidation.ps1` — Programmer 2: mobile-ready presentation/pacing Unity validation (marker checks=8). Not a playable claim.
