...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(447, projection["reviewedNonDebtRowCount"])
        self.assertEqual(128, projection["genuineDebtRowCount"])
        self.assertEqual(52, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`447` non-debt and `128` genuine-debt", tracker)
        self.assertIn("`52` unique file/rule items", tracker)
        self.assertIn("`128` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(439, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(128, review["genuineDebtRowCount"])
        self.assertEqual(52, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(128, len(debt_rows))
