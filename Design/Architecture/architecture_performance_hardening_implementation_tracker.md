...
| Checklist in progress | `13 / 107`: `APH-311`, `APH-408`, `APH-501`, `APH-502`, `APH-507`, `APH-508`, `APH-509`, `APH-601`, `APH-609`, `APH-704`, `APH-710`, `APH-712`, `APH-803` |
| Complete plus active coverage | `94 / 106` (`88.7%`); this is visibility only, not accepted completion |
...
- [~] `APH-710` Remove classified hidden world lookups and recurring per-frame allocation owners as each domain receives explicit World/EntityManager/query dependencies or cached non-allocating state.
  - Active result: world/entity caches, idle-command gating, and disabled-diagnostics call-site guards removed both tactical-camera rows, the audio gameplay-state row, two scene-root rows, road/building command-query rows, both transport helper-construction rows, and the path scheduling/result trace rows. The warmed current capture is `72,944 / 1,024` bytes. The recurring UI `Update` row is reconciled as Unity Editor invocation/call-stack capture overhead because its runtime probe remains zero and controlled marker/observer/tick-owner experiments do not change it. Camera `31/31`, audio `8/8`, scene reference `5/5`, road command `11/11`, building production `26/26`, placement `16/16`, transport `79/79`, pathfinding `3/3`, Menu-to-Match-to-Menu PlayMode `1/1`, source growth `15/15`, boundary `31/31`, ECS/Burst `10/10`, and project builds pass. Remaining building-key, selection-panel, and hidden-world owners keep this task active. Evidence: `Design/AgentReports/2026-07-12_aph-710_audio_gameplay_state_query_cache.md`, `Design/AgentReports/2026-07-12_aph-710_match_scene_root_lookup.md`, `Design/AgentReports/2026-07-12_aph-710_road_command_entity_cache.md`, `Design/AgentReports/2026-07-12_aph-710_building_production_command_entity_cache.md`, `Design/AgentReports/2026-07-12_aph-710_building_placement_command_entity_cache.md`, `Design/AgentReports/2026-07-12_aph-710_transport_idle_helper_allocation.md`, and `Design/AgentReports/2026-07-12_aph-710_path_diagnostics_allocation.md`.
...
- [~] `APH-712` Align the FirstLaunch narrative feature with the approved managed-edge naming, SOLID ownership, UI assembly, and shell ECS contracts in `Design/Architecture/first_launch_architecture_alignment_refactor_tracker.md`.
  - Active result: Batch 1 performs GUID-preserving renames of 11 pre-existing managed composition/presentation helpers. Phase 3 adds narrow profile-persistence, shell-ECS/handoff-lifecycle, and reviewer-presentation boundaries, reducing the transitional composition owner from 453 to 260 lines. Exact source-growth exceptions retain current line/byte ceilings and do not authorize growth or recreation.
