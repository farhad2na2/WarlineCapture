...
namespace Game.Configs
{
    ...
    public static class SkirmishAcceptanceScaffold
    {
        ...
        public const string S005RelativeDirectory = "Design/AgentReports/SkirmishExpansion/S005";
        ...
        public static string S005RelativeRunsPath => Path.Combine(S005RelativeDirectory, RunsFileName);
