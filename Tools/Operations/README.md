...
- `check_o001_player_ready.py` — Linux/host P4R P0 O001 player shell: Package 3 launch into the authored D01 mission, visible-control play, durable Operations profile, settle, and hub return. No Unity. Marker `[OperationsO001PlayerShellValidation] result=Passed checks=3`. Does not open MatchSceneView, does not claim AriaWon, and does not certify shipping player-ready.
