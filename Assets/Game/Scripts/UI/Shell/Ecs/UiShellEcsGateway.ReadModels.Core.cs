...
namespace Game.UI.Shell.Ecs
{
    public sealed partial class UiShellEcsGateway
    {
        ...
        public static bool TryReadMissionResult(out UiMissionResultPopupModel result)
        {
            ...
            if(runtime.MissionId.Equals(new FixedString64Bytes(Game.Missions.Contracts.CampaignMissionSequence.PowerRelay))) result=LocalizePowerRelayResult(in result,in facts);
