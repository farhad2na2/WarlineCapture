...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(426, projection["reviewedNonDebtRowCount"])
        self.assertEqual(149, projection["genuineDebtRowCount"])
        self.assertEqual(73, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`426` non-debt and `149` genuine-debt", tracker)
        self.assertIn("`73` unique file/rule items", tracker)
        self.assertIn("`149` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(418, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(149, review["genuineDebtRowCount"])
        self.assertEqual(73, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(149, len(debt_rows))
