...
SPECS: tuple[SfxSpec, ...] = (
    ...
    SfxSpec(
        "Narrative.FirstLaunch.Music.Calm",
        "Assets/Game/Audio/Narrative/FirstLaunch/Environment/first_launch_story_calm_loop_01.wav",
        24.0,
        "Seamless cinematic story underscore for a Middle Eastern city at dawn, restrained cello, soft oud texture, warm low strings, quiet human tension, no drums, no pulse, no impacts, no whooshes, no voice, spacious mix beneath dialogue.",
        loop=True,
    ...
    SfxSpec(
        "Narrative.FirstLaunch.Music.Crisis",
        "Assets/Game/Audio/Narrative/FirstLaunch/Environment/first_launch_story_crisis_loop_01.wav",
        24.0,
        "Seamless restrained cinematic crisis underscore for a tactical story scene, low strings, subtle bowed metal and distant frame drum texture, evolving tension without rhythmic thumps, no trailer hits, no booms, no whooshes, no voice, clear space for dialogue.",
        loop=True,
        prompt_influence=0.55,
        max_rms_db=-13.0,
        max_crest_db=18.0,
    ...
    SfxSpec(
        "Narrative.FirstLaunch.Ambience.CityMarket",
        "Assets/Game/Audio/Narrative/FirstLaunch/Environment/first_launch_city_market_loop_01.wav",
        24.0,
        "Seamless realistic Middle Eastern city edge market ambience at early morning, light road traffic, old cars and small trucks passing at varied distances, sparse vendors and pedestrians, birds, dry breeze, occasional bicycle bell, no music, no explosions, no alarms, no rhythmic sounds, no isolated whoosh.",
        loop=True,
        prompt_influence=0.62,
        max_rms_db=-14.0,
        max_crest_db=19.0,
    ...
    SfxSpec(
        "Narrative.FirstLaunch.Ambience.CityAttack",
        "Assets/Game/Audio/Narrative/FirstLaunch/Environment/first_launch_city_attack_loop_01.wav",
        24.0,
        "Seamless realistic city-under-attack ambience heard from a protected street, continuous distant traffic, hurried footsteps and movement without voices, irregular far-away artillery rumbles, two faint distant explosions with long natural echoes, intermittent civil-defense siren far away, radio carrier static without speech, absolutely no human voice or spoken syllable, no close blast, no repeated thump, no pulse, no whoosh, no music.",
        loop=True,
    ...
    SfxSpec(
        "Narrative.FirstLaunch.Ambience.CommandRoom",
        "Assets/Game/Audio/Narrative/FirstLaunch/Environment/first_launch_command_room_loop_01.wav",
        24.0,
        "Seamless damaged military command-room ambience, steady generator and ventilation hum, quiet electronics, occasional radio carrier static and squelch without transmission, distant city siren and traffic through thick walls, absolutely no human voice, no speech, no spoken syllable, no alarm loop, no boom, no pulse, no whoosh, no music.",
        loop=True,
        prompt_influence=0.62,
        max_rms_db=-15.0,
        max_crest_db=18.0,
    ...
    SfxSpec(
        "Narrative.FirstLaunch.Ambience.Convoy",
        "Assets/Game/Audio/Narrative/FirstLaunch/Environment/first_launch_convoy_interior_loop_01.wav",
        18.0,
        "Seamless interior ambience of a moving armored personnel carrier in a city, steady low diesel engine, tire and suspension vibration, loose equipment gently rattling, muffled road traffic outside, no horn, no weapon fire, no boom, no pulse, no whoosh, no music, no voice.",
        loop=True,
        prompt_influence=0.62,
        max_rms_db=-12.0,
        max_crest_db=18.0,
    ...
    SfxSpec(
        "Narrative.FirstLaunch.Event.DistantAttack",
        "Assets/Game/Audio/Narrative/FirstLaunch/Environment/first_launch_distant_attack_event_01.wav",
        6.0,
        "Two irregular very distant urban explosions heard across a city, low natural rumble and long building reflections, subtle debris tail, no close impact, no bass hit, no trailer boom, no whoosh, no pulse, no music, no voice, ample headroom.",
        prompt_influence=0.62,
        max_rms_db=-14.0,
        max_crest_db=22.0,
        transient_expected=True,
    ...
    SfxSpec(
        "Narrative.FirstLaunch.Event.RadioEmergency",
        "Assets/Game/Audio/Narrative/FirstLaunch/Environment/first_launch_radio_emergency_event_01.wav",
        7.0,
        "Military emergency radio carrier texture, brief squelch, static and signal breakup only, absolutely no human voice, no speech, no spoken syllable, no alarm beep, no explosion, no boom, no music.",
        prompt_influence=0.62,
        max_rms_db=-13.0,
        max_crest_db=20.0,
    ),
