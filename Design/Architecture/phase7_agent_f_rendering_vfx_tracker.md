...
- `2026-06-22` - `P7-0261` `BuildingPlacementVisualSystem`: folded disabled building placement visual `SystemBase` wrapper into a plain direct-owned helper. `BuildingGameplaySourceCompositionSystemHelper` now instantiates the helper directly; visual wrapper creation, prefab instantiation, combined-mesh renderer filtering, placement positioning, and gate alignment behavior stayed unchanged.
