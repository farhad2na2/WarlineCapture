...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(480, projection["reviewedNonDebtRowCount"])
        self.assertEqual(95, projection["genuineDebtRowCount"])
        self.assertEqual(40, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`480` non-debt and `95` genuine-debt", tracker)
        self.assertIn("`40` unique file/rule items", tracker)
        self.assertIn("`95` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(472, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(95, review["genuineDebtRowCount"])
        self.assertEqual(40, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(95, len(debt_rows))
