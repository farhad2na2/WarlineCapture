...
Status: Legacy source/reference spec. Superseded for active visual/gameplay direction on 2026-05-21 by `WarlineCapture_3D_SingleMap_Gameplay_Direction.md`, `WarlineCapture_UIUX_MainMenu_Visual_Contract.md`, and `WarlineCapture_UIUX_Gameplay_Element_Alignment.md`.
...
- **Active visual direction:** Use the 2026-05-21 full 3D single-map direction. Gameplay/key art should show 3D operation maps, command-base environments, config-backed units/buildings, civilians, hostile cells, and metadata-backed command overlays. The older 2D isometric and source JPG references embedded below are historical content/layout references only.
...
- **Game design relationship:** Campaign screens implement mission/star progression; Operations screens implement the multi-day city command campaign; Skirmish setup implements replayable rule presets and AI tuning.
...
- **Gameplay element contract:** Every visible UI element, including labels, images, icons, cards, rows, maps, meters, badges, tabs, button groups, buttons, dropdowns, toggles, sliders, and clickable items, must have a gameplay purpose, data binding, state rule, and feedback/decorative role in `Design/WarlineCapture_UIUX_Gameplay_Element_Alignment.md` before implementation. Elements without a live runtime system must be explicitly `Locked`, `DesignedUnavailable`, `DevOnly`, or `ReadOnly`; do not ship silent inert UI.
- **Responsive feedback:** Shared button pulses, locked-state wiggles, validation toasts, resource flyouts, meter deltas, popup/drawer motion, tactical command markers, critical warning feedback, and paired audio event ids are defined in `Design/WarlineCapture_Visual_Feedback_VFX_Recommendations.md` and `Design/WarlineCapture_Audio_Design_Guidelines.md`.
...
- **Canonical visual-lock targets:** The high-quality generated target PNG paths for all `SCN-*`, `POP-*`, and `PREFAB-*` surfaces are listed in `Design/WarlineCapture_UIUX_Mockup_To_Canvas_Conversion_Plan.md` under `Canonical Visual-Lock Target Inventory`. Use the active 3D/command-base targets for production Canvas matching; the JPGs embedded below remain source/content references.

## Legacy Notice

The screen-by-screen sections below preserve the original UI inventory and source mockup reading notes. They are not authoritative when they mention premium 2D isometric art, Saga Campaign, Persistent Operation, Quick Custom Game, or old Main Menu resources. For new implementation, translate them through:

- `SCN-02`: Campaign, Operations, Skirmish, Store, Commander, Settings, Credits, Supplies, Command, Deploy Operation.
- `SCN-05`: Campaign Map, not a separate strategic map product layer.
- `SCN-13`: Skirmish, with QuickCustom retained only as an internal/runtime name where already implemented.
- Gameplay surfaces: one 3D operation map with planning, briefing, minimap, threat, deployment, and battle views as camera/UI layers.

## Screens and Popups

### SCN-01 - Splash / Loading
![SCN-01 Splash / Loading](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/SCN-01_splash_loading.jpg)
...
![SCN-02 Main Menu / Mode Select](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/SCN-02_main_menu_mode_select.jpg)
...
![SCN-03 Commander Profile](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/SCN-03_commander_profile.jpg)
...
![SCN-04 Settings & Accessibility](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/SCN-04_settings_accessibility.jpg)
...
### SCN-05 - Saga Map
![SCN-05 Saga Map](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/SCN-05_saga_map.jpg)

**Where shown:** Shown when the player enters Saga Campaign from the Main Menu.

**Game design link:** Implements GDD section 7 Saga Campaign: curated mission nodes, chapter unlocks, stars, and rewards. Chapter 1 node data comes from `SagaChapters/WarlineCapture_Saga_Chapter01_First_Response.md`; player-facing Chapter 1 title is `First Response`.
...
![SCN-06 Mission Briefing](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/SCN-06_mission_briefing.jpg)
...
- Reward icons: deterministic grants from `WarlineCapture_Economy_Reward_Design.md`.
...
![SCN-07 Loadout / Squad Prep](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/SCN-07_loadout_squad_prep.jpg)
...
![SCN-08 RTS Battle HUD](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/SCN-08_rts_battle_hud.jpg)
...
![SCN-09 Build Drawer / Production](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/SCN-09_build_drawer_production.jpg)
...
![SCN-10 Unit Command / Command Wheel](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/SCN-10_unit_command_wheel.jpg)
...
![SCN-11 Persistent Operation Dashboard](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/SCN-11_operation_dashboard.jpg)
...
![SCN-12 District Detail / Actions](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/SCN-12_district_detail_actions.jpg)
...
![SCN-13 Quick Custom Game Setup](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/SCN-13_quick_custom_game_setup.jpg)
...
**Game design link:** Implements the monetization strategy and canonical economy/reward rules. Product content comes from `Monetization/WarlineCapture_Monetization_Store_Catalog.md`; resources and reward types come from `WarlineCapture_Economy_Reward_Design.md`.
...
**Game design link:** Implements the combat catalog and upgrade-track specs in `WarlineCapture_Combat_Catalog_And_Upgrade_Design.md`. Availability, unlock moments, resolved item ids, and implementation owners come from `BalanceConfigs/WarlineCapture_Combat_Balance_Config_v0_1.json`; art comes from `VisualConfigs/WarlineCapture_Combat_Visual_Config_v0_1.json`.
...
### POP-01 - Threat Alert
![POP-01 Threat Alert](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/POP-01_threat_alert.jpg)
...
### POP-02 - Confirm Raid
![POP-02 Confirm Raid](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/POP-02_confirm_raid.jpg)
...
![POP-03 Build Placement](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/POP-03_build_placement.jpg)
...
![POP-04 Reward / Unlock](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/POP-04_reward_unlock.jpg)
...
![POP-05 Mission Result](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/POP-05_mission_result.jpg)
...
![POP-06 End of Day Report](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/POP-06_end_of_day_report.jpg)
...
![POP-07 Pause / Options](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/POP-07_pause_options.jpg)
...
### POP-08 - Intel Reveal
![POP-08 Intel Reveal](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/POP-08_intel_reveal.jpg)
...
**Game design link:** Implements the availability and implementation specs added to every ability and upgrade track in `BalanceConfigs/WarlineCapture_Combat_Balance_Config_v0_1.json`.
...
![PREFAB-01 Objective Tracker](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/PREFAB-01_objective_tracker.jpg)
...
![PREFAB-02 Squad Tray](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/PREFAB-02_squad_tray.jpg)
...
![PREFAB-03 Build Drawer](WarlineCapture_UIUX_Codex_Package/warlinecapture_uiux_spec_assets/PREFAB-03_build_drawer.jpg)
