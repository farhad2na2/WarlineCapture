...
| Phase 2: Deterministic database builder | In progress; generated bake-config schema, exact output ownership, deterministic source-row inventory, and shared compound prototype recipes accepted; no config asset created |
...
Checklist progress: `14 / 80` complete.
