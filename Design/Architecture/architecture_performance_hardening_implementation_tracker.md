...
| Last update | 2026-07-14 - Building redirect, barrier, resource-hauler bridge, and selected-hauler context wiring moved into a 99-line stateless boundary, reducing the existing runtime context factory from 557 to 499 lines. Context allocation `5/5`, direct path-interaction behavior `4/4`, exact source-policy `2/2`, both project builds, and Menu-to-Match smoke pass. The global inventory is 27 unrelated oversized owners without weakening ceilings. |
