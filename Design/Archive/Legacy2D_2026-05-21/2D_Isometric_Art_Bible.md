...
Date: 2026-05-05
Status: Historical reference. Superseded on 2026-05-21 by `3D_SingleMap_Gameplay_Direction.md`.
...
- Production direction: `Design/2D_Isometric_Production_Direction.md`
- Macro-tile production plan: `Design/MacroTile_Terrain_Production_Plan.md`
- Implementation and validation plan: `Design/2D_Isometric_Implementation_Validation_Plan.md`
- Strategic/tactical map alignment: `Design/Strategic_Tactical_Map_Gameplay_Alignment.md`
...
Building visual ids, world asset paths, UI icon paths, and damage-state art paths must be authored in `VisualConfigs/Combat_Visual_Config_v0_1.json`. Building HP, costs, outputs, production lists, socket type, and upgrade stats stay in `BalanceConfigs/Combat_Balance_Config_v0_1.json`.
...
Unit, vehicle, air, and sea visual ids, portraits, icons, animation ids, and art briefs must be authored in `VisualConfigs/Combat_Visual_Config_v0_1.json`. Combat stats, production costs, unlock gates, transport capacity, and upgrade tracks stay in `BalanceConfigs/Combat_Balance_Config_v0_1.json`.
...
Portraits must follow `Design/Unit_Portrait_Art_Generation_Guide.md`. Screen content art must follow `Design/UIUX_Target_To_Canvas_Workflow_Guide.md` and `Design/UIUX_Mockup_To_Canvas_Conversion_Plan.md`.
