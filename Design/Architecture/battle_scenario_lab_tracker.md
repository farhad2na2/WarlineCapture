...
- In progress: `0`.
- Remaining open: `0`.
- Current target: `Scenario Lab Next workflow now switches live visual tests instead of only changing overlay text; AD-002 and AD-011 use production air-target visual playback through existing ECS air-defense systems`.
