...
public static class WarlineCaptureGc15DemoClusterRtsSceneBuilder
{
    private const string DemoScenePath = "Assets/Game/Scenes/Demo.unity";
    private const string ScenePath = "Assets/Game/Scenes/Generated/GC15_DemoClusterRts_2048.unity";
    private const string CaptureRoot = "Design/AgentReports/Captures/GeneratedScenes/GC15_DemoClusterRts_2048";
    private const string ReportPath = "Design/AgentReports/2026-05-21_gameplay_gc15-demo-cluster-rts-scene.md";
    ...
    [MenuItem("WarlineCapture/Design/Build GC15 Demo Cluster RTS 2048")]
    public static void BuildGc15DemoClusterRts2048()
    {
        Roads.Clear();
        Reserved.Clear();
        PlacedObjects.Clear();
        ...
        GameObject root = new("GC15_DemoClusterRts_2048_Root");
        ...
        Debug.Log($"WARLINECAPTURE_GC15_DEMO_CLUSTER_RTS_BUILT acceptedRoots={acceptedRootCount} skippedRoad={skippedRoadCount} scene={ScenePath} report={ReportPath}");
    ...
    private static List<ModuleSpec> BuildModuleSpecs()
    {
        ...
        {
            new("CityCore_NorthWestBlock", village, BlueprintPoint(96f, 124f), 2f, 1.00f, 14f),
            new("CityCentral_WestInnerBlock", village, BlueprintPoint(356f, 136f), -6f, 0.62f, 12f),
            new("CityMarket_WestBlock", village, BlueprintPoint(170f, 370f), -9f, 0.92f, 14f),
            new("CitySouth_WestBlock", village, BlueprintPoint(128f, 762f), 7f, 0.96f, 14f),
            new("SouthGate_PlayerCamp", southGate, BlueprintPoint(96f, 724f), 34f, 0.78f, 12f),
            new("CentralTentBarracks_InnerBlock", tentCamp, BlueprintPoint(346f, 544f), -4f, 0.74f, 12f),
            new("WestTentBarracks", tentCamp, BlueprintPoint(400f, 764f), -4f, 0.92f, 14f),
            new("Airfield_NorthEastApron", airfield, BlueprintPoint(760f, 174f), -12f, 1.12f, 14f),
            new("CommandDepot_CentralEast", commandDepot, BlueprintPoint(596f, 512f), -20f, 0.78f, 12f),
            new("VehicleYard_NorthEastLot", vehicleYard, BlueprintPoint(626f, 318f), 132f, 0.78f, 12f),
            new("VehicleYard_SouthEast", vehicleYard, BlueprintPoint(704f, 704f), 132f, 1.04f, 14f),
            new("FuelUtility_EastService", fuelUtility, BlueprintPoint(782f, 594f), -62f, 0.82f, 14f),
        };
    }

    private static void DefineGameplayContract()
    {
        AddRoad("MainNorthSouth_West", 258f, 0f, 60f, 890f);
        AddRoad("MainNorthSouth_East", 440f, 0f, 58f, 890f);
        AddRoad("NorthCityToAirfield", 62f, 224f, 766f, 54f);
        AddRoad("CentralCityToCommand", 130f, 426f, 686f, 54f);
        AddRoad("SouthPlayerToFuel", 38f, 578f, 790f, 86f);

        Reserved.Add(new Zone("PlayerSpawn", BlueprintRect(52f, 624f, 36f, 36f)));
        Reserved.Add(new Zone("EnemySpawn_Airfield", BlueprintRect(775f, 227f, 34f, 34f)));
        Reserved.Add(new Zone("EnemySpawn_Command", BlueprintRect(582f, 416f, 28f, 28f)));
        Reserved.Add(new Zone("EnemySpawn_VehicleFuel", BlueprintRect(690f, 634f, 28f, 28f)));
        Reserved.Add(new Zone("Objective_MarketMid", BlueprintRect(356f, 238f, 134f, 52f)));
        Reserved.Add(new Zone("Objective_SouthTown", BlueprintRect(340f, 706f, 134f, 56f)));
        Reserved.Add(new Zone("Objective_CommandOutpost", BlueprintRect(540f, 396f, 86f, 62f)));
    }
    ...
    private static void BuildRenderEnvironment(GameObject root)
    {
        ...
        Volume volume = Child(root, "GC15_RTS_PresentationVolume").AddComponent<Volume>();
        volume.isGlobal = true;
        volume.priority = 10f;
        VolumeProfile profile = ScriptableObject.CreateInstance<VolumeProfile>();
        profile.name = "GC15_RTS_PresentationProfile";
    ...
    {
        Surface(root, "FlatGameplayPlane_2048x2048", Vector3.zero, new Vector2(MapSize, MapSize), CreateMaterial("GC15_SandBase", new Color(0.60f, 0.50f, 0.34f, 1f)), -0.04f);
    }

    private static void BuildVisualGroundSurfaces(GameObject root)
    {
        GameObject ground = Child(root, "GC15_GC14RoadContract_VisibleGround");
        Material shoulder = CreateMaterial("GC15_SandPackedShoulder", new Color(0.55f, 0.45f, 0.29f, 1f));
        Material road = CreateMaterial("GC15_DustRoad_Compacted", new Color(0.64f, 0.53f, 0.35f, 1f));
        Material tireTrack = CreateMaterial("GC15_DirtTireTrack", new Color(0.44f, 0.34f, 0.20f, 1f));
        Material runway = CreateMaterial("GC15_RunwayWeatheredAsphalt", new Color(0.38f, 0.37f, 0.33f, 1f));
        Material plaza = CreateMaterial("GC15_PlazaPackedSand", new Color(0.62f, 0.51f, 0.33f, 1f));

        SurfaceBlueprintPolygon(ground, "MainNorthSouth_West_Shoulder", shoulder, 0.044f, (238f, -4f), (338f, -4f), (306f, 894f), (206f, 894f));
        SurfaceBlueprintPolygon(ground, "MainNorthSouth_West", road, 0.056f, (258f, 0f), (318f, 0f), (286f, 890f), (226f, 890f));
        SurfaceBlueprintPolygon(ground, "MainNorthSouth_East_Shoulder", shoulder, 0.044f, (420f, -4f), (518f, -4f), (488f, 894f), (390f, 894f));
        SurfaceBlueprintPolygon(ground, "MainNorthSouth_East", road, 0.056f, (440f, 0f), (498f, 0f), (468f, 890f), (410f, 890f));

        SurfaceBlueprintPolygon(ground, "NorthCityToAirfield_Shoulder", shoulder, 0.044f, (48f, 226f), (844f, 198f), (850f, 304f), (50f, 332f));
        SurfaceBlueprintPolygon(ground, "NorthCityToAirfield", road, 0.056f, (62f, 250f), (824f, 224f), (828f, 278f), (66f, 304f));
        SurfaceBlueprintPolygon(ground, "CentralCityToCommand_Shoulder", shoulder, 0.044f, (112f, 400f), (358f, 388f), (628f, 322f), (838f, 322f), (838f, 426f), (652f, 426f), (380f, 494f), (116f, 508f));
        SurfaceBlueprintPolygon(ground, "CentralCityToCommand", road, 0.056f, (130f, 426f), (360f, 414f), (632f, 348f), (816f, 350f), (816f, 402f), (646f, 400f), (374f, 466f), (134f, 480f));
        SurfaceBlueprintPolygon(ground, "SouthPlayerToFuel_Shoulder", shoulder, 0.044f, (26f, 588f), (248f, 552f), (518f, 448f), (840f, 412f), (850f, 524f), (544f, 558f), (274f, 660f), (28f, 698f));
        SurfaceBlueprintPolygon(ground, "SouthPlayerToFuel", road, 0.056f, (38f, 612f), (252f, 578f), (520f, 474f), (820f, 442f), (828f, 496f), (538f, 528f), (270f, 632f), (44f, 668f));

        SurfaceBlueprintPolygon(ground, "Airfield_Runway_Primary", runway, 0.066f, (744f, 92f), (818f, 92f), (818f, 296f), (744f, 296f));
        SurfaceBlueprintPolygon(ground, "Airfield_Runway_Diagonal", runway, 0.065f, (770f, 30f), (816f, 42f), (770f, 270f), (724f, 258f));
        SurfaceBlueprintPolygon(ground, "Market_Objective_Plaza", plaza, 0.064f, (356f, 238f), (490f, 238f), (490f, 290f), (356f, 290f));
        SurfaceBlueprintPolygon(ground, "South_Objective_Plaza", plaza, 0.064f, (340f, 706f), (474f, 706f), (474f, 762f), (340f, 762f));
        SurfaceBlueprintPolygon(ground, "Command_Outpost_Yard", plaza, 0.063f, (512f, 356f), (650f, 350f), (664f, 512f), (536f, 540f), (492f, 438f));
        SurfaceBlueprintPolygon(ground, "VehicleFuel_Yard", plaza, 0.063f, (566f, 574f), (800f, 552f), (836f, 650f), (810f, 814f), (640f, 842f), (558f, 762f));

        SurfaceBlueprintPolygon(ground, "Track_PlayerToCommand_A", tireTrack, 0.082f, (48f, 630f), (252f, 596f), (520f, 492f), (818f, 460f), (820f, 474f), (524f, 508f), (258f, 612f), (52f, 646f));
        SurfaceBlueprintPolygon(ground, "Track_NorthRoad_A", tireTrack, 0.082f, (70f, 262f), (824f, 236f), (824f, 248f), (70f, 274f));
        SurfaceBlueprintPolygon(ground, "Track_CommandRoad_A", tireTrack, 0.082f, (138f, 436f), (360f, 424f), (632f, 358f), (812f, 360f), (812f, 372f), (636f, 370f), (364f, 438f), (140f, 450f));
    }
    ...
    private static void CloneLegalDemoModules(GameObject root, List<ModuleSpec> modules, Dictionary<string, List<GameObject>> sourceByModule)
    {
        ...
        foreach (ModuleSpec module in modules)
        {
            ...
            foreach (GameObject source in sourceByModule[module.Name])
            {
                ...
                clone.name = "GC15_" + module.Name + "_" + source.name;
    ...
    private static void PlaceProofUnits(GameObject root)
    {
        ...
        PlaceUnit(units, "Assets/Game/Prefabs/Characters/Unit_Chr_Soldier_Male_02_Alt_04.prefab", BlueprintPoint(78f, 642f), 70f, 1.45f, "PlayerSquad_01");
        PlaceUnit(units, "Assets/Game/Prefabs/Characters/Unit_Chr_Soldier_Male_01.prefab", BlueprintPoint(98f, 636f), 70f, 1.45f, "PlayerSquad_02");
        PlaceUnit(units, "Assets/Game/Prefabs/Characters/Unit_Chr_Soldier_Female_01.prefab", BlueprintPoint(96f, 654f), 70f, 1.45f, "PlayerSquad_03");
        PlaceUnit(units, "Assets/Game/Prefabs/Vehicles/Unit_Veh_APC_Heavy.prefab", BlueprintPoint(246f, 606f), 76f, 1.0f, "PlayerAPC_RoadProof");
        ...
        PlaceUnit(units, "Assets/Game/Prefabs/Vehicles/Unit_Veh_Tank_USA.prefab", BlueprintPoint(704f, 648f), 246f, 1.0f, "EnemyTank_RoadProof");
    }
    ...
    private static void BuildHiddenContractMarkers(GameObject root)
    {
        ...
        Material road = CreateMaterial("GC15_DebugRoad", new Color(0.05f, 0.7f, 0.9f, 0.45f));
        Material reserved = CreateMaterial("GC15_DebugReserved", new Color(1f, 0.28f, 0.05f, 0.45f));
    ...
    {
        Camera top = CameraObject(root, "Camera_GC15_TopDownBlueprintProof");
        ...
        BuildRtsCamera(root, "Camera_GC15_RtsOverview", new Vector3(-620f, 520f, -820f), BlueprintPoint(388f, 430f), 38f);
        BuildRtsCamera(root, "Camera_GC15_RtsCityReadable", new Vector3(-930f, 330f, -430f), BlueprintPoint(172f, 366f), 34f);
        BuildRtsCamera(root, "Camera_GC15_RtsAirfieldCommand", new Vector3(260f, 430f, -620f), BlueprintPoint(660f, 320f), 36f);
        BuildRtsCamera(root, "Camera_GC15_RtsSouthBase", new Vector3(-120f, 390f, -980f), BlueprintPoint(470f, 704f), 34f);
    }
    ...
    private static void ValidateLayout(List<ModuleSpec> modules, Dictionary<string, List<GameObject>> sourceByModule)
    {
        ...
        if (acceptedRootCount < 120)
            ValidationLog.Add($"ERROR: GC15 accepted only {acceptedRootCount} authored roots; scene is likely too sparse.");

        if (ValidationLog.Count == 0)
            ValidationLog.Add($"PASS: GC15 placed {acceptedRootCount} Demo-authored roots around the GC14 road contract, with {skippedRoadCount} illegal road/reserved roots omitted.");
    }
    ...
    private static void CaptureScene()
    {
        ...
        {
            if (camera.name == "Camera_GC15_TopDownBlueprintProof")
                Render(camera, ProjectPath(CaptureRoot + "/gc15_topdown_blueprint_proof_2048x2048.png"), 2048, 2048);
            if (camera.name == "Camera_GC15_RtsOverview")
                Render(camera, ProjectPath(CaptureRoot + "/gc15_rts_overview_1920x1080.png"), 1920, 1080);
            if (camera.name == "Camera_GC15_RtsCityReadable")
                Render(camera, ProjectPath(CaptureRoot + "/gc15_rts_city_readable_1920x1080.png"), 1920, 1080);
            if (camera.name == "Camera_GC15_RtsAirfieldCommand")
                Render(camera, ProjectPath(CaptureRoot + "/gc15_rts_airfield_command_1920x1080.png"), 1920, 1080);
            if (camera.name == "Camera_GC15_RtsSouthBase")
                Render(camera, ProjectPath(CaptureRoot + "/gc15_rts_south_base_1920x1080.png"), 1920, 1080);
        }
    }
    ...
    private static void WriteReport(List<ModuleSpec> modules, Dictionary<string, List<GameObject>> sourceByModule)
    {
        ...
        report.AppendLine("# GC15 Demo Cluster RTS Scene");
        report.AppendLine();
        report.AppendLine("Lane: Gameplay");
        report.AppendLine("Task: Continue from GC14 by placing authored Demo-scene visual modules/building clusters around the 2048 road contract, without random individual-prefab scattering.");
        report.AppendLine();
        report.AppendLine("Files changed:");
        report.AppendLine("- `Assets/Game/Scripts/Editor/WarlineCaptureGc15DemoClusterRtsSceneBuilder.cs`");
        report.AppendLine("- `Assets/Game/Scenes/Generated/GC15_DemoClusterRts_2048.unity`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC15_DemoClusterRts_2048/gc15_topdown_blueprint_proof_2048x2048.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC15_DemoClusterRts_2048/gc15_rts_overview_1920x1080.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC15_DemoClusterRts_2048/gc15_rts_city_readable_1920x1080.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC15_DemoClusterRts_2048/gc15_rts_airfield_command_1920x1080.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC15_DemoClusterRts_2048/gc15_rts_south_base_1920x1080.png`");
        report.AppendLine();
        report.AppendLine("Contracts touched: GC14/GC11 2048 road, spawn, and objective masks. Demo modules are visual dressing only and are legalized against those masks.");
        ...
        report.AppendLine("Validation run: Unity batchmode `WarlineCaptureGc15DemoClusterRtsSceneBuilder.BuildGc15DemoClusterRts2048`.");
        ...
        report.AppendLine("Known gaps: This is still a visual proof scene. It does not yet convert the layout to ECS/pathfinding data, and visual acceptance requires PM/user review of the attached captures.");
        report.AppendLine("Cross-lane impacts: Art/Design can now review composed Demo-cluster placement against the blueprint before Gameplay locks this into ECS walkability.");
        report.AppendLine("Next recommended task: visual review of GC15 captures; if accepted, promote the road/reserved masks and cluster exclusion data into a reusable scene-generation contract.");
        report.AppendLine();
