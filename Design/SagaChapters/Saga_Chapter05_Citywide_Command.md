...
Use `../3D_SingleMap_Gameplay_Direction.md` before turning these mission slots into detailed specs. Multi-objective planning views must connect to the same 3D operation map with metadata-backed routes, objective anchors, camera bounds, and minimap markers.
