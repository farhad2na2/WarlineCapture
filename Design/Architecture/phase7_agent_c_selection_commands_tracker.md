...
- In progress: `0`.
- Remaining open: `48`.
- Current target: `Agent C naming-only Batch 228 VisibleUnitSelectionCameraSystemHelper complete; open SystemBase rows remain complete`.
- Converted to `ISystem`: `0`.
- Split passive/managed boundaries: `18 retired/folded helpers`.
- Managed `SystemBase` exceptions created: `0`.
- Validation status: `All open Agent C SystemBase rows have been folded out of ECS into plain helpers/facades. Naming-only Batch 228 renamed the visible unit selection camera boundary to VisibleUnitSelectionCameraSystemHelper, preserved .meta GUID dc11fbe61364435494e80d0b2e2eea04, and regenerated the non-ECS helper inventory to denominator 1; focused selection-state, selection/input, and architecture validations passed in /private/tmp/warline-non-ecs-helper-naming-batch228-selection-state.log, /private/tmp/warline-non-ecs-helper-naming-batch228-rts-selection-input.log, and /private/tmp/warline-non-ecs-helper-naming-batch228-architecture.log. Naming-only Batch 227 renamed P7-0052 to SelectionUiReadModelUiSystemHelper and regenerated the non-ECS helper inventory to denominator 2; focused read-model lookup, squad-tray, selection/input, and architecture validations passed in /private/tmp/warline-non-ecs-helper-naming-batch227-readmodel-lookup.log, /private/tmp/warline-non-ecs-helper-naming-batch227-squad-tray.log, /private/tmp/warline-non-ecs-helper-naming-batch227-rts-selection-input.log, and /private/tmp/warline-non-ecs-helper-naming-batch227-architecture.log. Naming-only Batch 226 renamed P7-0051 to SelectionUiCommandUiSystemHelper and regenerated the non-ECS helper inventory to denominator 3; focused selection/input, HUD command-control, and architecture validations passed in /private/tmp/warline-non-ecs-helper-naming-batch226-rts-selection-input.log, /private/tmp/warline-non-ecs-helper-naming-batch226-hud-command-controls.log, and /private/tmp/warline-non-ecs-helper-naming-batch226-architecture.log; UI shell content validation reached pre-existing missing statusChipSprite prefab reference debt, and command request/result validation reached the documented pre-existing UnitEngagementSystem_ScanOrderAcquiresOnlyTargetsInsideScanArea assertion. Naming-only Batch 225 renamed P7-0050 to SelectionStateCompositionSystemHelper and regenerated the non-ECS helper inventory to denominator 4; focused selection-state, selection/input, and architecture validations passed in /private/tmp/warline-non-ecs-helper-naming-batch225-selection-state.log, /private/tmp/warline-non-ecs-helper-naming-batch225-rts-selection-input.log, and /private/tmp/warline-non-ecs-helper-naming-batch225-architecture.log. Naming-only Batch 224 renamed P7-0048 to SelectionRuntimeConfigStartupSystemHelper and regenerated the non-ECS helper inventory to denominator 5; focused camera, selection/input, and architecture validations passed in /private/tmp/warline-non-ecs-helper-naming-batch224-rts-camera.log, /private/tmp/warline-non-ecs-helper-naming-batch224-rts-selection-input.log, and /private/tmp/warline-non-ecs-helper-naming-batch224-architecture.log. Naming-only Batch 223 renamed P7-0047 to SelectionRectangleRequestCompositionSystemHelper and regenerated the non-ECS helper inventory to denominator 6; focused selection/input validation and architecture validation passed in /private/tmp/warline-non-ecs-helper-naming-batch223-rts-selection-input.log and /private/tmp/warline-non-ecs-helper-naming-batch223-architecture.log. Naming-only Batch 222 renamed P7-0046 to SelectionGameplayStartupSystemHelper and regenerated the non-ECS helper inventory to denominator 7; focused selection/input validation and architecture validation passed in /private/tmp/warline-non-ecs-helper-naming-batch222-rts-selection-input.log and /private/tmp/warline-non-ecs-helper-naming-batch222-architecture.log. Naming-only Batch 221 renamed P7-0045 to SelectionBuildingInteractionCompositionSystemHelper and regenerated the non-ECS helper inventory to denominator 8; focused selection/input validation and architecture validation passed in /private/tmp/warline-non-ecs-helper-naming-batch221-rts-selection-input.log and /private/tmp/warline-non-ecs-helper-naming-batch221-architecture.log. Naming-only Batch 210 renamed the direct squad-tray HUD selection bridge to MatchHudSquadTraySelectionUiSystemHelper and regenerated the non-ECS helper inventory to denominator 19; focused squad-tray validation and architecture validation passed in /private/tmp/warline-non-ecs-helper-naming-batch210-match-hud-squad-tray.log and /private/tmp/warline-non-ecs-helper-naming-batch210-architecture.log. Naming-only Batch 205 renamed P7-0026 to FocusedUnitUiReadModelUiSystemHelper and regenerated the non-ECS helper inventory to denominator 24; unit transport validation and architecture validation passed in /private/tmp/warline-non-ecs-helper-naming-batch205-unit-transport.log and /private/tmp/warline-non-ecs-helper-naming-batch205-architecture.log. Naming-only Batch 204 renamed P7-0025 to FocusedUnitLifecycleCompositionSystemHelper and regenerated the non-ECS helper inventory to denominator 25; selection-state focused validation and architecture validation passed in /private/tmp/warline-non-ecs-helper-naming-batch204-selection-state.log and /private/tmp/warline-non-ecs-helper-naming-batch204-architecture.log. Naming-only Batch 203 renamed P7-0023 to FocusableUnitLookupCameraSystemHelper and regenerated the non-ECS helper inventory to denominator 26; focused focusable-unit lookup and architecture validations passed in /private/tmp/warline-non-ecs-helper-naming-batch203-focusable-unit-lookup.log and /private/tmp/warline-non-ecs-helper-naming-batch203-architecture.log. Naming-only Batch 183 renamed P7-0040 to RtsSelectionRuntimeInputCompositionSystemHelper and regenerated the non-ECS helper inventory to denominator 46; focused selection input validation and architecture passed in /private/tmp/warline-non-ecs-helper-naming-batch183-rts-selection-input.log and /private/tmp/warline-non-ecs-helper-naming-batch183-architecture.log. Naming-only Batch 182 renamed P7-0039 to RtsSelectionPointerTargetCommandCompositionSystemHelper and regenerated the non-ECS helper inventory to denominator 47; focused selection input validation and architecture passed in /private/tmp/warline-non-ecs-helper-naming-batch182-rts-selection-input.log and /private/tmp/warline-non-ecs-helper-naming-batch182-architecture.log. Naming-only Batch 181 renamed P7-0035 to RtsSelectionInputCompositionSystemHelper and regenerated the non-ECS helper inventory to denominator 48; focused selection input validation and architecture passed in /private/tmp/warline-non-ecs-helper-naming-batch181-rts-selection-input.log and /private/tmp/warline-non-ecs-helper-naming-batch181-architecture.log. Naming-only Batch 180 renamed P7-0034 to RtsSelectionInputStateCompositionSystemHelper and regenerated the non-ECS helper inventory to denominator 49; focused selection input validation and architecture passed in /private/tmp/warline-non-ecs-helper-naming-batch180-rts-selection-input.log and /private/tmp/warline-non-ecs-helper-naming-batch180-architecture.log. Naming-only Batch 179 renamed P7-0032 to RtsSelectionFocusCommandCompositionSystemHelper and regenerated the non-ECS helper inventory to denominator 50; focused selection input validation and architecture passed. Batch 178 renamed P7-0030 to RtsSelectionCommandResultFlushCompositionSystemHelper and passed selection input plus architecture, while command request/result validation reached the documented unrelated UnitEngagementSystem_ScanOrderAcquiresOnlyTargetsInsideScanArea blocker. Latest completed rows: P7-0051 SelectionUiCommandUiSystemHelper, P7-0052 SelectionUiReadModelUiSystemHelper, and P7-0374 VisibleUnitSelectionCameraSystemHelper. dotnet build passed; inventory regenerated; latest focused logs are /private/tmp/warline-non-ecs-helper-naming-batch228-selection-state.log, /private/tmp/warline-non-ecs-helper-naming-batch228-rts-selection-input.log, and /private/tmp/warline-non-ecs-helper-naming-batch228-architecture.log; prior Agent C validation paths remain recorded in completed slices and handoff reports`.
...
| `P7-0047` | `SelectionRectangleRequestCompositionSystemHelper` | `PlainClass` | `RetiredFolded` | Folded | Camera argument | Folded out of `SystemBase`; it is a manually constructed selection-rectangle request helper, not scheduled ECS. |
| `P7-0048` | `SelectionRuntimeConfigStartupSystemHelper` | `PlainClass` | `RetiredFolded` | Folded | GameObject, Camera state | Folded out of `SystemBase`; it is a startup config-state factory, not scheduled ECS. |
...
| `P7-0050` | `SelectionStateCompositionSystemHelper` | `PlainClass` | `RetiredFolded` | Folded | None | Folded out of `SystemBase`; it is a manually constructed selected/focused state helper, not scheduled ECS. |
| `P7-0051` | `SelectionUiCommandUiSystemHelper` | `PlainClass` | `RetiredFolded` | Folded | UnityEngine Time/Screen | Folded out of `SystemBase`; it is a manually constructed UI command facade implementing `ISelectionUiCommand`, not scheduled ECS. |
| `P7-0052` | `SelectionUiReadModelUiSystemHelper` | `PlainClass` | `RetiredFolded` | Folded | Camera argument, UI interface | Folded out of `SystemBase`; it is a manually constructed `ISelectionUiReadModel` adapter, not scheduled ECS. |
...
| `P7-0047` | `SelectionRectangleRequestCompositionSystemHelper` | Retired/folded from disabled `SystemBase` into a plain selection-rectangle request helper; preserved pending rectangle request extraction, visible-player selection collection, building fallback selection, selected-tag application, selected move cache updates, HUD callbacks, and focus assignment. | `dotnet build Assembly-CSharp-Editor.csproj --no-restore -v:minimal` passed; `git diff --check` passed; inventory regenerated to `Design/Architecture/systembase_to_isystem_inventory.md`; focused selection/input validation passed in `/private/tmp/warline-non-ecs-helper-naming-batch223-rts-selection-input.log`; architecture guard passed in `/private/tmp/warline-non-ecs-helper-naming-batch223-architecture.log`. |
| `P7-0048` | `SelectionRuntimeConfigStartupSystemHelper` | Retired/folded from disabled `SystemBase` into a plain startup config-state factory; removed the `DefaultGameObjectInjectionWorld.GetOrCreateSystemManaged` dependency and preserved config normalization, camera fallback, marker prefab references, selection thresholds, and camera-mode settings. | `dotnet build Assembly-CSharp-Editor.csproj --no-restore -v:minimal` passed; `git diff --check` passed; inventory regenerated to `Design/Architecture/systembase_to_isystem_inventory.md`; focused camera validation passed in `/private/tmp/warline-non-ecs-helper-naming-batch224-rts-camera.log`; focused selection/input validation passed in `/private/tmp/warline-non-ecs-helper-naming-batch224-rts-selection-input.log`; architecture guard passed in `/private/tmp/warline-non-ecs-helper-naming-batch224-architecture.log`. |
...
| `P7-0050` | `SelectionStateCompositionSystemHelper` | Retired/folded from disabled `SystemBase` into a plain selected/focused state helper; preserved focused entity state, selected move cache helpers, cacheability filtering, and lifecycle debug recording. Also corrected selection-mode entry so `RuntimeGameplayStateComponent.SelectionModeActive` owns selection mode while active command state is cleared, matching the command request/result contract. | `dotnet build Assembly-CSharp-Editor.csproj --no-restore -v:minimal` passed; `git diff --check` passed; inventory regenerated to `Design/Architecture/systembase_to_isystem_inventory.md`; MonoBehaviour loop baseline refreshed to `40` existing loop keys; selection-state validation passed in `/private/tmp/warline-non-ecs-helper-naming-batch225-selection-state.log`; focused selection/input validation passed in `/private/tmp/warline-non-ecs-helper-naming-batch225-rts-selection-input.log`; architecture guard passed in `/private/tmp/warline-non-ecs-helper-naming-batch225-architecture.log`. |
| `P7-0051` | `SelectionUiCommandUiSystemHelper` | Retired/folded from disabled `SystemBase` into a plain UI command facade; preserved `ISelectionUiCommand`, command-intent queuing, select-all screen rect requests, focused transport disembark request helpers, and intro-input lock behavior. | `dotnet build Assembly-CSharp.csproj --no-restore -v:minimal` passed; `dotnet build Assembly-CSharp-Editor.csproj --no-restore -v:minimal` passed; `git diff --check` passed; non-ECS helper inventory regenerated to denominator `3`; focused selection/input validation passed in `/private/tmp/warline-non-ecs-helper-naming-batch226-rts-selection-input.log`; HUD command controls validation passed in `/private/tmp/warline-non-ecs-helper-naming-batch226-hud-command-controls.log`; architecture guard passed in `/private/tmp/warline-non-ecs-helper-naming-batch226-architecture.log`; UI shell content and command request/result runners reached documented unrelated blockers in `/private/tmp/warline-non-ecs-helper-naming-batch226-ui-shell-content.log` and `/private/tmp/warline-non-ecs-helper-naming-batch226-command-request-result.log`. |
| `P7-0052` | `SelectionUiReadModelUiSystemHelper` | Retired/folded from disabled `SystemBase` into a plain `ISelectionUiReadModel` adapter; preserved focused-unit status/health/capability reads, focused transport passenger reads, selected-unit presence, and visible player unit/soldier/vehicle screen queries. | `dotnet build Assembly-CSharp.csproj --no-restore -v:minimal` passed; `dotnet build Assembly-CSharp-Editor.csproj --no-restore -v:minimal` passed; `git diff --check` passed; non-ECS helper inventory regenerated to denominator `2`; UI read-model lookup validation passed in `/private/tmp/warline-non-ecs-helper-naming-batch227-readmodel-lookup.log`; squad-tray validation passed in `/private/tmp/warline-non-ecs-helper-naming-batch227-squad-tray.log`; focused selection/input validation passed in `/private/tmp/warline-non-ecs-helper-naming-batch227-rts-selection-input.log`; architecture guard passed in `/private/tmp/warline-non-ecs-helper-naming-batch227-architecture.log`. |
| `P7-0374` | `VisibleUnitSelectionCameraSystemHelper` | Naming-only follow-up after the Integration split; preserved camera-backed visible-unit screen filtering, soldier/vehicle filter enum, selected-tag application, and the ECS `VisibleUnitSelectionCandidateSystem` data producer. | `dotnet build Assembly-CSharp.csproj --no-restore -v:minimal` passed; `dotnet build Assembly-CSharp-Editor.csproj --no-restore -v:minimal` passed with the existing Unity XML copy warning and `0` errors; `git diff --check` passed; non-ECS helper inventory regenerated to denominator `1`; selection-state validation passed in `/private/tmp/warline-non-ecs-helper-naming-batch228-selection-state.log`; focused selection/input validation passed in `/private/tmp/warline-non-ecs-helper-naming-batch228-rts-selection-input.log`; architecture guard passed in `/private/tmp/warline-non-ecs-helper-naming-batch228-architecture.log`. |
