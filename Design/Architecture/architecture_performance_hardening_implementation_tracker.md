...
| Last update | 2026-07-14 - The map-vehicle clearance boundary is validated and pushed as `434bc7c44`, reducing its existing owner from 687 to 499 lines through a 244-line stateless boundary while preserving the test-facing facade. Placement `5/5`, startup/naming `10/10`, exact source-policy `2/2`, both project builds, and post-rebase Menu-to-Match smoke pass. The global inventory is 28 unrelated oversized owners without weakening ceilings. |
