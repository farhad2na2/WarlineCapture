...
- `RtsSelectionPointerTargetCommandSystem.IssueMoveOrder` already queues and processes move command requests, but it is called by the automatic empty-click path.
