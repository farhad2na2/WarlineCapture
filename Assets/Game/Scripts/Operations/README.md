...
| Capture | `Game.Operations.Capture` | Ops-owned Play Mode HUD/victory OnGUI presenter for ARIA evidence capture. Runtime assembly (UnityEngine) so AddComponent works in Editor Play Mode. Does not open Match/Watch shared UI. |
