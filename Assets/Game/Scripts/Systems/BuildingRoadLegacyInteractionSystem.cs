...
internal sealed class BuildingRoadLegacyInteractionSystem
{
    ...
    {
        public readonly BuildingRoadLegacyStorageSystem StorageSystem;
        public readonly BuildingRoadLegacyEcsSystem EcsSystem;
        public readonly BuildingRoadLegacyEcsSystem.Context EcsContext;
        ...
        public Context(
            BuildingRoadLegacyStorageSystem storageSystem,
            BuildingRoadLegacyEcsSystem ecsSystem,
            BuildingRoadLegacyEcsSystem.Context ecsContext,
    ...
    public RuntimeBuildingData PlaceBuilding(Context context, BuildingPlacementLifecycleSystem.PlacementState placement)
    {
    ...
    public void DeleteBuilding(Context context, int buildingId, bool destroyVisual)
    {
        if (context.StorageSystem == null ||
            !context.StorageSystem.TryGetBuilding(buildingId, out RuntimeBuildingData building))
            return;
