...
namespace Game.Editor
{
    public static class SkirmishDefinitionBuilder
    {
        ...
        public const string ScenarioFolderS005 = "Assets/Game/Configs/SkirmishExpansion/Scenarios/S005";
        ...
        public static string Rebuild()
        {
            ...
            Directory.CreateDirectory(ScenarioFolderS005);
            ...
            bool preserveS005Playable = TryReadPlayable("S005", out string preservedS005Notes);
            ...
            Persist(set.ArmyCombined, SharedFolder + "/SkirmishArmy_CombinedArms.asset");
            ...
            Persist(set.DefinitionS005, ScenarioFolderS005 + "/SkirmishScenario_S005.asset");
            Persist(CopyLayout(set.LayoutDbBa), ScenarioFolderS005 + "/SkirmishLayout_S005.asset");
            ...
            if (preserveS005Playable)
                RestorePlayable("S005", preservedS005Notes);
            AssetDatabase.SaveAssets();
            return "[SkirmishDefinitionBuilder] result=Passed definition=skirmish.s002,skirmish.s003,skirmish.s004,skirmish.s005";
        }
