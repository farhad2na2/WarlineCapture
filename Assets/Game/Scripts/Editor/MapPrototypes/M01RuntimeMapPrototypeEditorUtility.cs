namespace Game.Editor
{
    ...
    public static class M01RuntimeMapPrototypeEditorUtility
    {
        ...
        private const string VisualRecipeVersion = "M01RuntimeVisualRecipe_2026-07-17_v32_intact_authored_districts";
        ...
        private const int MinimumVisualRecipeEntryCount = 96;
        ...
        private static readonly Vector3 AcceptedGameplayCameraPosition = new(-103f, 31f, -58f);
        private static readonly Vector3 AcceptedGameplayCameraTarget = new(-45f, 6f, 2f);
        private const float AcceptedGameplayCameraFieldOfView = 52f;
