...
- Built and installed the clean ARM64 IL2CPP release APK from commit `ba3154573fc2564c40ca5432d5ea8afc9619e22c` on Xiaomi `24090RA29G` (`malachite`, Android 16). The artifact is `/Users/farhad/Projects/WarlineCapture-Clone/Build/AndroidAPK/WarlineCapture.apk`, 442,968,453 bytes, SHA-256 `ca62d56c14f47eb651413279b94e9f9d584ca3f133a3045291c063eabbbd04ba`.
- The release app started, loaded Match, displayed the canonical `Materials 92/120` header, remained foreground for the smoke window, and produced no fatal exception, ANR, native crash, or out-of-memory marker. This closes Android packaging and crash-free Match-entry evidence for the feature.
