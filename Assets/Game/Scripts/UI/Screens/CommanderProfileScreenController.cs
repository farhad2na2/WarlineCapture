...
public sealed class CommanderProfileScreenController : MonoBehaviour
{
    ...
    {
        WarlineCaptureModalController modal = GetComponentInParent<WarlineCaptureModalController>();
