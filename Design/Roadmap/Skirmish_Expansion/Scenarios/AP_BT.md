# Airfield Plains — Breakthrough: implementation packet
...
- Map: `opmap.skirmish.airfield_plains`; layout `layout.skirmish.ap.bt`. Alternative corridors a/b: north radar-road; south apron corridor; muster, east perimeter exit, two defender tower slots, twelve individual designation bindings.
...
**Airfield Plains · Breakthrough · Ground Maneuver · Field Base** — handoff work ordinal **109**. One of the 117 remaining new catalog combinations.

**Bind:** catalog `S109`; definition `skirmish.s109`; scenario `scenario.skirmish.s109`; map `opmap.skirmish.airfield_plains`; objective `BT`; army `G`; start `F`. Prerequisite tickets: `SK-00;SK-01;SK-02;SK-03;SK-04;SK-05;SK-08;SK-10;SK-11;SK-12;SK-13`. Required capability tags: `ground;intel;transport;advanced_ground;objective_bt`. Recommended later size `War` is gated; first visit remains Standard.
...
**Implementation sequence:** (1) Compile exactly the identity/profile/layout above and match all three size rows to [INITIAL_SETUP_MATRIX](../INITIAL_SETUP_MATRIX.csv), including caps/storage/BT substitution/CE support. (2) Bind the packet’s objective roles and all starting/group/producer/route anchors; simulate both viable approaches with real movement. (3) Install `SkirmishBreakthroughObjectiveSystem` and its typed state; preserve the exact terminal/clock semantics. (4) Wire producer costs/queues, contextual controls and objective/army HUD from the resolved snapshot; add keys `skirmish.s109.{title,brief,objective,warning.*,result.*}` in EN/FA. (5) Expose the same public role/route/goal affordances to enemy and ARIA policies through their separate legal observations/actuators. (6) Verify checkpoint and result/replay, then publish only this entry’s certified size/difficulty matrix.

**Entry-specific checks:** At Standard Field, replace K with the third designated rifle squad for the player only; enemy remains 2R+K. Verify R1 missing-facility explanations, paid R2 transition and level-zero upgrades on every fresh start. Reject offensive-air queues in G while preserving transport/recon. Prove both ground-only and transport-assisted evacuation without replacement designated soldiers. Certify runway/taxi/return and convoy separation; retain a full ground-only winning approach; inspect aircraft visibility/selection at all camera angles.

**ARIA must play and win:** Regular seeds `104838`, `130472`, `156030` in both EN and FA at Standard: three full normal-speed runs per locale, at least two real wins in each, all traces/losses retained. Additional exposed difficulty wins at Standard/EN use Recruit `196722`, Veteran `262256`, Commander `327782`. Additional exposed sizes need a full Regular EN and FA win at War seed `393350` and Large War seed `458988`, plus their device/recovery gates. These samples supplement per-configuration legality checks; all four difficulties are required for final catalog completion. ARIA uses visible controls, no hidden knowledge/state mutation/extra resources, no human tactical intervention or restart in a counted win. A Draw is not a win.

**Completion artifact:** Config and code hashes; compiled setup/actual entity census; normal human win; ARIA matrix; loss/deadline/surrender and unique edge fixtures; saved-result/replay/checkpoint evidence; camera/map/EN/FA/device review. Store evidence under `Design/AgentReports/SkirmishExpansion/S109/` and update only this publication row after every required gate. Authoring a valid asset does not mark it Accepted.

## S110

**Airfield Plains · Breakthrough · Ground Maneuver · Established Base** — handoff work ordinal **110**. One of the 117 remaining new catalog combinations.

**Bind:** catalog `S110`; definition `skirmish.s110`; scenario `scenario.skirmish.s110`; map `opmap.skirmish.airfield_plains`; objective `BT`; army `G`; start `E`. Prerequisite tickets: `SK-00;SK-01;SK-02;SK-03;SK-04;SK-05;SK-08;SK-10;SK-11;SK-12;SK-13`. Required capability tags: `ground;intel;transport;advanced_ground;objective_bt`. Recommended later size `War` is gated; first visit remains Standard.
...
**Implementation sequence:** (1) Compile exactly the identity/profile/layout above and match all three size rows to [INITIAL_SETUP_MATRIX](../INITIAL_SETUP_MATRIX.csv), including caps/storage/BT substitution/CE support. (2) Bind the packet’s objective roles and all starting/group/producer/route anchors; simulate both viable approaches with real movement. (3) Install `SkirmishBreakthroughObjectiveSystem` and its typed state; preserve the exact terminal/clock semantics. (4) Wire producer costs/queues, contextual controls and objective/army HUD from the resolved snapshot; add keys `skirmish.s110.{title,brief,objective,warning.*,result.*}` in EN/FA. (5) Expose the same public role/route/goal affordances to enemy and ARIA policies through their separate legal observations/actuators. (6) Verify checkpoint and result/replay, then publish only this entry’s certified size/difficulty matrix.
...
**ARIA must play and win:** Regular seeds `104839`, `130473`, `156031` in both EN and FA at Standard: three full normal-speed runs per locale, at least two real wins in each, all traces/losses retained. Additional exposed difficulty wins at Standard/EN use Recruit `196723`, Veteran `262257`, Commander `327783`. Additional exposed sizes need a full Regular EN and FA win at War seed `393351` and Large War seed `458989`, plus their device/recovery gates. These samples supplement per-configuration legality checks; all four difficulties are required for final catalog completion. ARIA uses visible controls, no hidden knowledge/state mutation/extra resources, no human tactical intervention or restart in a counted win. A Draw is not a win.

**Completion artifact:** Config and code hashes; compiled setup/actual entity census; normal human win; ARIA matrix; loss/deadline/surrender and unique edge fixtures; saved-result/replay/checkpoint evidence; camera/map/EN/FA/device review. Store evidence under `Design/AgentReports/SkirmishExpansion/S110/` and update only this publication row after every required gate. Authoring a valid asset does not mark it Accepted.

## S111

**Airfield Plains · Breakthrough · Air Mobile · Field Base** — handoff work ordinal **111**. One of the 117 remaining new catalog combinations.

**Bind:** catalog `S111`; definition `skirmish.s111`; scenario `scenario.skirmish.s111`; map `opmap.skirmish.airfield_plains`; objective `BT`; army `A`; start `F`. Prerequisite tickets: `SK-00;SK-01;SK-02;SK-03;SK-04;SK-05;SK-08;SK-10;SK-11;SK-12;SK-13`. Required capability tags: `ground;intel;transport;offensive_air;advanced_air;objective_bt`. Recommended later size `War` is gated; first visit remains Standard.
...
**Implementation sequence:** (1) Compile exactly the identity/profile/layout above and match all three size rows to [INITIAL_SETUP_MATRIX](../INITIAL_SETUP_MATRIX.csv), including caps/storage/BT substitution/CE support. (2) Bind the packet’s objective roles and all starting/group/producer/route anchors; simulate both viable approaches with real movement. (3) Install `SkirmishBreakthroughObjectiveSystem` and its typed state; preserve the exact terminal/clock semantics. (4) Wire producer costs/queues, contextual controls and objective/army HUD from the resolved snapshot; add keys `skirmish.s111.{title,brief,objective,warning.*,result.*}` in EN/FA. (5) Expose the same public role/route/goal affordances to enemy and ARIA policies through their separate legal observations/actuators. (6) Verify checkpoint and result/replay, then publish only this entry’s certified size/difficulty matrix.

**Entry-specific checks:** At Standard Field, replace K with the third designated rifle squad for the player only; enemy remains 2R+K. Verify R1 missing-facility explanations, paid R2 transition and level-zero upgrades on every fresh start. Reject tank/heavy APC/siege queues in A while keeping R1 AA available. Prove both ground-only and transport-assisted evacuation without replacement designated soldiers. Certify runway/taxi/return and convoy separation; retain a full ground-only winning approach; inspect aircraft visibility/selection at all camera angles.

**ARIA must play and win:** Regular seeds `104840`, `130474`, `156032` in both EN and FA at Standard: three full normal-speed runs per locale, at least two real wins in each, all traces/losses retained. Additional exposed difficulty wins at Standard/EN use Recruit `196724`, Veteran `262258`, Commander `327784`. Additional exposed sizes need a full Regular EN and FA win at War seed `393352` and Large War seed `458990`, plus their device/recovery gates. These samples supplement per-configuration legality checks; all four difficulties are required for final catalog completion. ARIA uses visible controls, no hidden knowledge/state mutation/extra resources, no human tactical intervention or restart in a counted win. A Draw is not a win.

**Completion artifact:** Config and code hashes; compiled setup/actual entity census; normal human win; ARIA matrix; loss/deadline/surrender and unique edge fixtures; saved-result/replay/checkpoint evidence; camera/map/EN/FA/device review. Store evidence under `Design/AgentReports/SkirmishExpansion/S111/` and update only this publication row after every required gate. Authoring a valid asset does not mark it Accepted.

## S112

**Airfield Plains · Breakthrough · Air Mobile · Established Base** — handoff work ordinal **112**. One of the 117 remaining new catalog combinations.

**Bind:** catalog `S112`; definition `skirmish.s112`; scenario `scenario.skirmish.s112`; map `opmap.skirmish.airfield_plains`; objective `BT`; army `A`; start `E`. Prerequisite tickets: `SK-00;SK-01;SK-02;SK-03;SK-04;SK-05;SK-08;SK-10;SK-11;SK-12;SK-13`. Required capability tags: `ground;intel;transport;offensive_air;advanced_air;objective_bt`. Recommended later size `War` is gated; first visit remains Standard.
...
**Implementation sequence:** (1) Compile exactly the identity/profile/layout above and match all three size rows to [INITIAL_SETUP_MATRIX](../INITIAL_SETUP_MATRIX.csv), including caps/storage/BT substitution/CE support. (2) Bind the packet’s objective roles and all starting/group/producer/route anchors; simulate both viable approaches with real movement. (3) Install `SkirmishBreakthroughObjectiveSystem` and its typed state; preserve the exact terminal/clock semantics. (4) Wire producer costs/queues, contextual controls and objective/army HUD from the resolved snapshot; add keys `skirmish.s112.{title,brief,objective,warning.*,result.*}` in EN/FA. (5) Expose the same public role/route/goal affordances to enemy and ARIA policies through their separate legal observations/actuators. (6) Verify checkpoint and result/replay, then publish only this entry’s certified size/difficulty matrix.

**Entry-specific checks:** Verify free starting facilities/forces are grants, not a hidden second debit; R2 persists while stat upgrades start at zero. Reject tank/heavy APC/siege queues in A while keeping R1 AA available. Prove both ground-only and transport-assisted evacuation without replacement designated soldiers. Certify runway/taxi/return and convoy separation; retain a full ground-only winning approach; inspect aircraft visibility/selection at all camera angles.

**ARIA must play and win:** Regular seeds `104841`, `130475`, `156033` in both EN and FA at Standard: three full normal-speed runs per locale, at least two real wins in each, all traces/losses retained. Additional exposed difficulty wins at Standard/EN use Recruit `196725`, Veteran `262259`, Commander `327785`. Additional exposed sizes need a full Regular EN and FA win at War seed `393353` and Large War seed `458991`, plus their device/recovery gates. These samples supplement per-configuration legality checks; all four difficulties are required for final catalog completion. ARIA uses visible controls, no hidden knowledge/state mutation/extra resources, no human tactical intervention or restart in a counted win. A Draw is not a win.

**Completion artifact:** Config and code hashes; compiled setup/actual entity census; normal human win; ARIA matrix; loss/deadline/surrender and unique edge fixtures; saved-result/replay/checkpoint evidence; camera/map/EN/FA/device review. Store evidence under `Design/AgentReports/SkirmishExpansion/S112/` and update only this publication row after every required gate. Authoring a valid asset does not mark it Accepted.

## S113

**Airfield Plains · Breakthrough · Combined Arms · Field Base** — handoff work ordinal **113**. One of the 117 remaining new catalog combinations.

**Bind:** catalog `S113`; definition `skirmish.s113`; scenario `scenario.skirmish.s113`; map `opmap.skirmish.airfield_plains`; objective `BT`; army `C`; start `F`. Prerequisite tickets: `SK-00;SK-01;SK-02;SK-03;SK-04;SK-05;SK-08;SK-10;SK-11;SK-12;SK-13`. Required capability tags: `ground;intel;transport;offensive_air;advanced_ground;advanced_air;objective_bt`. Recommended later size `War` is gated; first visit remains Standard.
...
**Implementation sequence:** (1) Compile exactly the identity/profile/layout above and match all three size rows to [INITIAL_SETUP_MATRIX](../INITIAL_SETUP_MATRIX.csv), including caps/storage/BT substitution/CE support. (2) Bind the packet’s objective roles and all starting/group/producer/route anchors; simulate both viable approaches with real movement. (3) Install `SkirmishBreakthroughObjectiveSystem` and its typed state; preserve the exact terminal/clock semantics. (4) Wire producer costs/queues, contextual controls and objective/army HUD from the resolved snapshot; add keys `skirmish.s113.{title,brief,objective,warning.*,result.*}` in EN/FA. (5) Expose the same public role/route/goal affordances to enemy and ARIA policies through their separate legal observations/actuators. (6) Verify checkpoint and result/replay, then publish only this entry’s certified size/difficulty matrix.

**Entry-specific checks:** At Standard Field, replace K with the third designated rifle squad for the player only; enemy remains 2R+K. Verify R1 missing-facility explanations, paid R2 transition and level-zero upgrades on every fresh start. Verify simultaneous armor/AA/air queues share category and Supply reservations correctly. Prove both ground-only and transport-assisted evacuation without replacement designated soldiers. Certify runway/taxi/return and convoy separation; retain a full ground-only winning approach; inspect aircraft visibility/selection at all camera angles.

**ARIA must play and win:** Regular seeds `104842`, `130476`, `156034` in both EN and FA at Standard: three full normal-speed runs per locale, at least two real wins in each, all traces/losses retained. Additional exposed difficulty wins at Standard/EN use Recruit `196726`, Veteran `262260`, Commander `327786`. Additional exposed sizes need a full Regular EN and FA win at War seed `393354` and Large War seed `458992`, plus their device/recovery gates. These samples supplement per-configuration legality checks; all four difficulties are required for final catalog completion. ARIA uses visible controls, no hidden knowledge/state mutation/extra resources, no human tactical intervention or restart in a counted win. A Draw is not a win.

**Completion artifact:** Config and code hashes; compiled setup/actual entity census; normal human win; ARIA matrix; loss/deadline/surrender and unique edge fixtures; saved-result/replay/checkpoint evidence; camera/map/EN/FA/device review. Store evidence under `Design/AgentReports/SkirmishExpansion/S113/` and update only this publication row after every required gate. Authoring a valid asset does not mark it Accepted.

## S114

**Airfield Plains · Breakthrough · Combined Arms · Established Base** — handoff work ordinal **114**. One of the 117 remaining new catalog combinations.

**Bind:** catalog `S114`; definition `skirmish.s114`; scenario `scenario.skirmish.s114`; map `opmap.skirmish.airfield_plains`; objective `BT`; army `C`; start `E`. Prerequisite tickets: `SK-00;SK-01;SK-02;SK-03;SK-04;SK-05;SK-08;SK-10;SK-11;SK-12;SK-13`. Required capability tags: `ground;intel;transport;offensive_air;advanced_ground;advanced_air;objective_bt`. Recommended later size `War` is gated; first visit remains Standard.
...
**ARIA must play and win:** Regular seeds `104843`, `130477`, `156035` in both EN and FA at Standard: three full normal-speed runs per locale, at least two real wins in each, all traces/losses retained. Additional exposed difficulty wins at Standard/EN use Recruit `196727`, Veteran `262261`, Commander `327787`. Additional exposed sizes need a full Regular EN and FA win at War seed `393355` and Large War seed `458993`, plus their device/recovery gates. These samples supplement per-configuration legality checks; all four difficulties are required for final catalog completion. ARIA uses visible controls, no hidden knowledge/state mutation/extra resources, no human tactical intervention or restart in a counted win. A Draw is not a win.

**Completion artifact:** Config and code hashes; compiled setup/actual entity census; normal human win; ARIA matrix; loss/deadline/surrender and unique edge fixtures; saved-result/replay/checkpoint evidence; camera/map/EN/FA/device review. Store evidence under `Design/AgentReports/SkirmishExpansion/S114/` and update only this publication row after every required gate. Authoring a valid asset does not mark it Accepted.
