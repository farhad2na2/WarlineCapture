# POP-01_ThreatAlert Layer Pack

This pack is the mandatory VisualLockLayered source for `Threat Alert Popup`. It was created while reworking the popup track after the earlier popup implementation skipped the layer-pack gate.

## Gate Rules

- Reference target: `reference/POP-01_ThreatAlert_Landscape_Target.png`
