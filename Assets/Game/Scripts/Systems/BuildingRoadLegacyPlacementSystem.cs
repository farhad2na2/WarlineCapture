...
internal sealed class BuildingRoadLegacyPlacementSystem
{
        ...
        Vector2 screenPosition = default)
    {
        ...
        if (context.TryGetGridData != null &&
            context.TryGetGridData(out _, out GridConfig grid, out DynamicBuffer<GridRoad> roads, out DynamicBlockerData blockerData) &&
