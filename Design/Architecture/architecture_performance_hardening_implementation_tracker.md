...
| Last update | 2026-07-15 - the clean supporting-UI candidate APK is `449,902,496` bytes, `13,456,702` under budget and `62,179,585` below the failing baseline; release-device memory/thermal and APH-809 visual acceptance remain open |
