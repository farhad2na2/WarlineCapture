...
namespace Game.UI.Shell.Ecs
{
    ...
    public partial struct SupplyLineRadioReportProjectionSystem : ISystem
    {
        private const int MessageId=830007;
        ...
        public void OnUpdate(ref SystemState state)
        {
            ...
            bool valid=SystemAPI.TryGetSingleton(out CampaignMissionRuntimeComponent runtime) &&
                runtime.MissionId.Equals("saga.ch02.m02.supply_line") && runtime.Phase==MissionPhaseKind.Engage &&
            ...
            if(!valid || !SystemAPI.TryGetSingleton(out CampaignMissionSupplyLineState supplyLine) || supplyLine.FuelTransferred==0 ||
                !supplyLine.SessionToken.Equals(runtime.SessionToken) || supplyLine.AttemptOrdinal!=runtime.AttemptOrdinal ||
                supplyLine.SourceVersion!=runtime.SourceVersion || supplyLine.Failure!=SupplyLineFailure.None ||
            ...
            var line=CH02M02SupplyLineCopy.Comms[0];
            if(issued)
            {
            ...
            messages.Add(new AssistantMessageElement
            {
                ...
                RelatedKind=AssistantRecommendationKind.Explain,SuppressionKey="mission.supply_line.first_delivery",
