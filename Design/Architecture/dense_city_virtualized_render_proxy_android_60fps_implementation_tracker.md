...
**Independent correctness queue (does not advance the 80-item VRP checklist):** candidate canal water now has a regeneration-stable, clearly blue transparent presentation override with its Windows/Editor asset contract accepted; Android visual confirmation remains pending. Buildings-over-roads and road-over-water-without-bridge remain separate open defects.
