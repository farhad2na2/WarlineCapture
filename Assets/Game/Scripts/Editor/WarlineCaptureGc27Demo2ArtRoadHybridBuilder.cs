...
public static class WarlineCaptureGc27Demo2ArtRoadHybridBuilder
{
    private const string ScenePath = "Assets/Game/Scenes/Generated/GC27_Demo2ArtRoadHybrid_2048.unity";
    private const string CaptureRoot = "Design/AgentReports/Captures/GeneratedScenes/GC27_Demo2ArtRoadHybrid_2048";
    private const string ReportPath = "Design/AgentReports/2026-05-21_gameplay_gc27-demo2-art-road-hybrid.md";
    private const string DataPath = "Design/AgentReports/Data/GeneratedScenes/GC27_Demo2ArtRoadHybrid_2048/gc27_demo2_art_road_hybrid_contract.json";
    ...
    [MenuItem("WarlineCapture/Design/Build GC27 Demo2 Art Road Hybrid 2048")]
    public static void BuildGc27Demo2ArtRoadHybrid2048()
    {
        MacroRoads.Clear();
        ...
        GameObject root = new("GC27_Demo2ArtRoadHybrid_2048_Root");
        BuildEnvironment(root);
        DefineContract();
        BuildGroundAndRoads(root);
        BuildDemo2ArtRoadGroundLayer(root);
        ...
        Debug.Log($"WARLINECAPTURE_GC27_DEMO2_ART_ROAD_HYBRID_BUILT scene={ScenePath} report={ReportPath}");
    ...
    private static void BuildEnvironment(GameObject root)
    {
        ...
        Volume volume = Child(root, "GC27_RTS_PresentationVolume").AddComponent<Volume>();
    ...
    {
        Material baseMat = CreateMaterial("GC27_SandBase", new Color(0.58f, 0.49f, 0.34f, 1f));
        Material sandLightMat = CreateMaterial("GC27_SandWindLight", new Color(0.66f, 0.57f, 0.40f, 1f));
        Material sandDarkMat = CreateMaterial("GC27_SandCompactedDark", new Color(0.46f, 0.38f, 0.25f, 1f));
        Material roadMat = CreateMaterial("GC27_AuthoredCompactedRoad", new Color(0.50f, 0.40f, 0.25f, 1f));
        Material roadEdgeMat = CreateMaterial("GC27_RoadRaisedEdge", new Color(0.34f, 0.27f, 0.17f, 1f));
        Material shoulderMat = CreateMaterial("GC27_AuthoredRoadShoulder", new Color(0.47f, 0.38f, 0.24f, 1f));
        Material trackMat = CreateMaterial("GC27_DirtTireTrack", new Color(0.26f, 0.20f, 0.12f, 1f));
        Material runwayMat = CreateMaterial("GC27_RunwayWeatheredAsphalt", new Color(0.24f, 0.24f, 0.22f, 1f));
        Material runwayMarkMat = CreateMaterial("GC27_RunwayFadedMarking", new Color(0.72f, 0.68f, 0.58f, 1f));
        Material plazaMat = CreateMaterial("GC27_LocalPackedPlaza", new Color(0.63f, 0.52f, 0.35f, 1f));
        Material vehicleMat = CreateMaterial("GC27_VehicleYardDust", new Color(0.50f, 0.42f, 0.31f, 1f));
        Material districtPadMat = CreateMaterial("GC27_DistrictPackedSandPad", new Color(0.61f, 0.51f, 0.34f, 1f));
    ...
    {
        GameObject variation = Child(root, "GC27_VisualSandVariationTiles");
    ...
    {
        GameObject pads = Child(root, "GC27_AuthoredDistrictPads_VisualOnly");
    ...
    private static void BuildDemo2ArtRoadGroundLayer(GameObject root)
    {
        GameObject parent = Child(root, "Demo2BattleRoyale_ArtRoadGroundLayer_SourceScale");

        PlaceDemo2GroundPatch(parent, "GrassPad_NorthWestTown_A", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_Grass_Square_01.prefab", 112f, 124f, 0f, new Vector2(76f, 76f));
        PlaceDemo2GroundPatch(parent, "GrassPad_WestMarket_A", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_Grass_Circle_01.prefab", 176f, 366f, 24f, new Vector2(56f, 56f));
        PlaceDemo2GroundPatch(parent, "GrassPad_SouthBase_A", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_Grass_Circle_02.prefab", 138f, 768f, -14f, new Vector2(54f, 54f));
        PlaceDemo2GroundPatch(parent, "Concrete_CommandPad_A", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_Concrete_Base_01.prefab", 678f, 432f, 0f, new Vector2(74f, 74f));
        PlaceDemo2GroundPatch(parent, "Concrete_AirfieldPad_A", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_Port_Concrete_Slab_01.prefab", 706f, 206f, 90f, new Vector2(70f, 70f));

        PlaceDemo2RoadStrip(parent, "WestNorthSouth", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_Road_Straight_01.prefab", new Vector2(288f, 38f), new Vector2(256f, 850f), 42f, new Vector2(42f, 28f));
        PlaceDemo2RoadStrip(parent, "EastNorthSouth", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_Road_Straight_03.prefab", new Vector2(512f, 36f), new Vector2(504f, 848f), 42f, new Vector2(42f, 28f));
        PlaceDemo2RoadStrip(parent, "NorthCityToAirfield", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_Road_Straight_02.prefab", new Vector2(74f, 268f), new Vector2(590f, 256f), 42f, new Vector2(42f, 28f));
        PlaceDemo2RoadStrip(parent, "CentralCityToCommand", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_Road_Straight_Damaged_01.prefab", new Vector2(142f, 454f), new Vector2(478f, 444f), 42f, new Vector2(42f, 28f));
        PlaceDemo2RoadStrip(parent, "CommandToAirfieldEast", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_Road_Straight_Damaged_02.prefab", new Vector2(554f, 308f), new Vector2(886f, 308f), 42f, new Vector2(42f, 28f));
        PlaceDemo2RoadStrip(parent, "SouthPlayerToFuel", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_Road_Straight_01.prefab", new Vector2(58f, 890f), new Vector2(812f, 890f), 42f, new Vector2(42f, 28f));

        PlaceDemo2RoadNode(parent, "RoadT_WestNorth", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_Road_T_01.prefab", 284f, 266f, 90f, new Vector2(44f, 44f));
        PlaceDemo2RoadNode(parent, "RoadT_WestCentral", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_Road_T_01.prefab", 274f, 454f, 90f, new Vector2(44f, 44f));
        PlaceDemo2RoadNode(parent, "RoadT_EastCommand", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_Road_T_01.prefab", 512f, 308f, 270f, new Vector2(44f, 44f));
        PlaceDemo2RoadNode(parent, "RoadCorner_CommandAirfield", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_Road_Corner_01.prefab", 542f, 306f, 0f, new Vector2(44f, 44f));
        PlaceDemo2RoadNode(parent, "RoadEnd_NorthAirfield", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_Road_Straight_End_01.prefab", 894f, 308f, 90f, new Vector2(42f, 28f));

        PlaceDemo2RoadStrip(parent, "DirtServiceLane_CentralBarracks", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_DirtRoad_Straight_01.prefab", new Vector2(362f, 532f), new Vector2(360f, 618f), 36f, new Vector2(34f, 22f));
        PlaceDemo2RoadStrip(parent, "DirtServiceLane_WestBarracks", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_DirtRoad_Straight_01.prefab", new Vector2(362f, 704f), new Vector2(360f, 768f), 36f, new Vector2(34f, 22f));
        PlaceDemo2RoadStrip(parent, "DirtServiceLane_ArmorFuel", "Assets/Synty/PolygonBattleRoyale/Prefabs/Environments/SM_Env_DirtRoad_Straight_01.prefab", new Vector2(616f, 650f), new Vector2(770f, 632f), 36f, new Vector2(34f, 22f));
    ...
    private static void PlaceChildMaskedAuthoredModule(GameObject parent, MaskedModule module, string path)
    {
        ...
        source.name = "GC27_" + module.Name + "_ChildMaskSource";
        ...
        GameObject moduleRoot = Child(parent, "GC27_" + module.Name + "_ChildMaskedPieces");
        int accepted = 0;
        int pieceIndex = 0;
    ...
    private static bool TryPlaceChildMaskedPiece(GameObject parent, MaskedModule module, Zone mask, string sourcePath, GameObject sourceChild, int index)
    {
        ...
        instance.name = "GC27_" + module.Name + "_ChildPiece_" + index + "_" + sourceChild.name;
    ...
    private static void PlaceAuthoredCluster(GameObject parent, MaskedModule module, Zone mask, string path)
    {
        ...
        instance.name = "GC27_" + module.Name + "_AuthoredCluster";
        instance.transform.SetParent(parent.transform, true);
        instance.transform.position = Center(mask.Rect, 0f);
    ...
    private static void PlaceDemo2GroundPatch(GameObject parent, string name, string path, float x, float y, float rotationY, Vector2 footprintBlueprint)
    {
        Vector3 position = BlueprintPoint(x, y);
        Rect footprint = BlueprintFootprint(x, y, footprintBlueprint);
        PlaceDemo2ArtPrefab(parent, name, path, "ground", position, rotationY, footprint, false);
        demo2GroundPlacements++;
    }

    private static void PlaceDemo2RoadStrip(GameObject parent, string name, string path, Vector2 startBlueprint, Vector2 endBlueprint, float spacingMeters, Vector2 footprintBlueprint)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            PlaceDemo2ArtPrefab(parent, $"{name}_{i:00}", path, "road", position, rotationY, footprint, true);
            demo2RoadPlacements++;
        }
    }

    private static void PlaceDemo2RoadNode(GameObject parent, string name, string path, float x, float y, float rotationY, Vector2 footprintBlueprint)
    {
        Vector3 position = BlueprintPoint(x, y);
        Rect footprint = BlueprintFootprint(x, y, footprintBlueprint);
        PlaceDemo2ArtPrefab(parent, name, path, "road_node", position, rotationY, footprint, true);
        demo2RoadPlacements++;
    }
    ...
    private static void PlaceDemo2BoundaryStrip(GameObject parent, string name, string path, Vector2 startBlueprint, Vector2 endBlueprint, float spacingMeters, Vector2 footprintBlueprint)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            Vector3 position = Vector3.Lerp(start, end, t);
            Rect footprint = BlueprintFootprint(blueprint.x, blueprint.y, footprintBlueprint);
            PlaceDemo2ArtPrefab(parent, $"{name}_{i:00}", path, "boundary", position, rotationY, footprint, false);
    ...
    private static void PlaceDemo2Detail(GameObject parent, string name, string path, float x, float y, float rotationY, Vector2 footprintBlueprint, bool mustStayOnWalkable)
    {
        Vector3 position = BlueprintPoint(x, y);
        Rect footprint = BlueprintFootprint(x, y, footprintBlueprint);
        PlaceDemo2ArtPrefab(parent, name, path, "detail", position, rotationY, footprint, mustStayOnWalkable);
        demo2DetailPlacements++;
    }

    private static void PlaceDemo2ArtPrefab(GameObject parent, string name, string path, string category, Vector3 position, float rotationY, Rect footprint, bool mustStayOnWalkable)
    {
        GameObject prefab = AssetDatabase.LoadAssetAtPath<GameObject>(path);
        if (prefab == null)
        {
        ...
        GameObject instance = (GameObject)PrefabUtility.InstantiatePrefab(prefab);
        instance.name = "GC27_Demo2_" + name;
        instance.transform.SetParent(parent.transform, true);
        instance.transform.position = position;
        instance.transform.rotation = Quaternion.Euler(0f, rotationY, 0f);
        instance.transform.localScale = Vector3.one;
    ...
    private static void BuildDebugOverlay(GameObject root)
    {
        ...
        Material green = CreateMaterial("GC27_DebugSoldierWalkable", new Color(0f, 1f, 0.1f, 0.6f));
        Material cyan = CreateMaterial("GC27_DebugVehicleWalkable", new Color(0f, 0.8f, 1f, 0.6f));
        Material red = CreateMaterial("GC27_DebugBlocker", new Color(1f, 0f, 0f, 0.7f));
        foreach (Zone zone in SoldierLocalZones)
    ...
    private static void BuildGeneratorAuthoringOverlay(GameObject root)
    {
        ...
        Material city = CreateMaterial("GC27_AuthoringDistrict_City", new Color(0.20f, 0.42f, 0.80f, 0.85f));
        Material baseMat = CreateMaterial("GC27_AuthoringDistrict_Base", new Color(0.30f, 0.62f, 0.28f, 0.85f));
        Material logistics = CreateMaterial("GC27_AuthoringDistrict_Logistics", new Color(0.84f, 0.58f, 0.18f, 0.85f));
        Material airfield = CreateMaterial("GC27_AuthoringDistrict_Airfield", new Color(0.68f, 0.68f, 0.74f, 0.85f));
    ...
    private static void BuildMaskedModuleOverlay(GameObject root)
    {
        ...
        Material moduleMat = CreateMaterial("GC27_ModuleMask_DistrictEnvelope", new Color(0.88f, 0.18f, 0.92f, 0.82f));
        Material blockerMat = CreateMaterial("GC27_ModuleMask_BlockerOwned", new Color(1f, 0.08f, 0.08f, 0.9f));
    ...
    private static void Validate()
    {
        ...
        if (detailBlockerPlacements < 60)
            ValidationLog.Add($"ERROR: GC27 placed only {detailBlockerPlacements} legal detail props; densification target is at least 60.");

        if (Districts.Count < 7)
            ValidationLog.Add($"ERROR: GC27 exported only {Districts.Count} districts; procedural authoring target is at least 7 named districts.");
        ...
        if (Modules.Count < 7)
            ValidationLog.Add($"ERROR: GC27 exported only {Modules.Count} reusable masked modules; target is at least 7.");

        if (authoredClusterPlacements < Modules.Count)
            ValidationLog.Add($"ERROR: GC27 placed only {authoredClusterPlacements} authored Demo clusters for {Modules.Count} reusable modules.");
        ...
        if (demo2RoadPlacements < 100)
            ValidationLog.Add($"ERROR: GC27 placed only {demo2RoadPlacements} Demo2 road modules; target is at least 100 for visible source-scale road coverage.");
        if (demo2GroundPlacements < 5)
            ValidationLog.Add($"ERROR: GC27 placed only {demo2GroundPlacements} Demo2 ground/concrete modules; target is at least 5.");
        if (demo2BoundaryPlacements < 20)
            ValidationLog.Add($"ERROR: GC27 placed only {demo2BoundaryPlacements} Demo2 boundary modules; target is at least 20.");
        if (demo2DetailPlacements < 8)
            ValidationLog.Add($"ERROR: GC27 placed only {demo2DetailPlacements} Demo2 detail modules; target is at least 8.");
        ...
        if (ValidationLog.Count == 0)
            ValidationLog.Add($"PASS: GC27 instantiated {authoredClusterPlacements} source-scale Demo-authored clusters/modules, added Demo2 road/ground/boundary art ({demo2RoadPlacements}/{demo2GroundPlacements}/{demo2BoundaryPlacements}/{demo2DetailPlacements}), exported {Modules.Count} reusable masked district modules across {Districts.Count} named districts, preserved the GC17/GC18 walkability masks, and kept legal blocker visuals off macro roads. Detail props: {detailBlockerPlacements}; primary blocker visuals: {mainBlockerPlacements}; total placements: {Placements.Count}; art placements: {ArtSurfacePlacements.Count}; blocker zones: {BlockerZones.Count}; soldier zones: {SoldierLocalZones.Count}; vehicle zones: {VehicleZones.Count}; macro roads: {MacroRoads.Count}.");
    }
    ...
    {
        BuildRtsCamera(root, "Camera_GC27_RtsOverview", new Vector3(-620f, 520f, -820f), BlueprintPoint(388f, 430f), 38f);
        BuildRtsCamera(root, "Camera_GC27_RtsCityReadable", new Vector3(-930f, 330f, -430f), BlueprintPoint(172f, 366f), 34f);
        BuildRtsCamera(root, "Camera_GC27_RtsAirfieldCommand", new Vector3(260f, 430f, -620f), BlueprintPoint(660f, 320f), 36f);
        BuildRtsCamera(root, "Camera_GC27_RtsDenseCityClose", new Vector3(-700f, 210f, -250f), BlueprintPoint(176f, 392f), 30f);
        BuildRtsCamera(root, "Camera_GC27_ScaleAuditClose", new Vector3(-700f, 92f, -185f), BlueprintPoint(176f, 392f), 22f);

        Camera top = CameraObject(root, "Camera_GC27_TopDownContractVisualProof");
    ...
    private static void CaptureScene()
    {
        ...
        {
            if (camera.name == "Camera_GC27_RtsOverview")
                Render(camera, ProjectPath(CaptureRoot + "/gc27_rts_overview_1920x1080.png"), 1920, 1080);
            if (camera.name == "Camera_GC27_RtsCityReadable")
                Render(camera, ProjectPath(CaptureRoot + "/gc27_rts_city_readable_1920x1080.png"), 1920, 1080);
            if (camera.name == "Camera_GC27_RtsAirfieldCommand")
                Render(camera, ProjectPath(CaptureRoot + "/gc27_rts_airfield_command_1920x1080.png"), 1920, 1080);
            if (camera.name == "Camera_GC27_RtsDenseCityClose")
                Render(camera, ProjectPath(CaptureRoot + "/gc27_rts_dense_city_close_1920x1080.png"), 1920, 1080);
            if (camera.name == "Camera_GC27_ScaleAuditClose")
                Render(camera, ProjectPath(CaptureRoot + "/gc27_scale_audit_close_1920x1080.png"), 1920, 1080);
            if (camera.name == "Camera_GC27_TopDownContractVisualProof")
            {
                RenderContractProof(camera, ProjectPath(CaptureRoot + "/gc27_topdown_contract_visual_proof_2048x2048.png"));
                RenderGeneratorBlueprint(camera, ProjectPath(CaptureRoot + "/gc27_topdown_generator_blueprint_2048x2048.png"));
                RenderModuleMaskProof(camera, ProjectPath(CaptureRoot + "/gc27_topdown_module_mask_proof_2048x2048.png"));
            }
        }
    }
    ...
    private static void WriteContractJson()
    {
        ...
        {
            generatedBy = nameof(WarlineCaptureGc27Demo2ArtRoadHybridBuilder),
            scene = ScenePath,
    ...
    private static void WriteReport()
    {
        ...
        report.AppendLine("# GC27 Demo2 Art Road Hybrid Scene");
        report.AppendLine();
        report.AppendLine("Lane: Gameplay");
        report.AppendLine("Task: Continue from GC26 by preserving the source-scale compound layout and replacing the weak generated road/ground look with Demo2 PolygonBattleRoyale road, dirt, concrete, grass, wall, rubble, and detail assets.");
        report.AppendLine();
        report.AppendLine("Files changed:");
        report.AppendLine("- `Assets/Game/Scripts/Editor/WarlineCaptureGc27Demo2ArtRoadHybridBuilder.cs`");
        report.AppendLine("- `Assets/Game/Scenes/Generated/GC27_Demo2ArtRoadHybrid_2048.unity`");
        report.AppendLine("- `Design/AgentReports/Data/GeneratedScenes/GC27_Demo2ArtRoadHybrid_2048/gc27_demo2_art_road_hybrid_contract.json`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC27_Demo2ArtRoadHybrid_2048/gc27_rts_overview_1920x1080.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC27_Demo2ArtRoadHybrid_2048/gc27_rts_city_readable_1920x1080.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC27_Demo2ArtRoadHybrid_2048/gc27_rts_airfield_command_1920x1080.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC27_Demo2ArtRoadHybrid_2048/gc27_rts_dense_city_close_1920x1080.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC27_Demo2ArtRoadHybrid_2048/gc27_scale_audit_close_1920x1080.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC27_Demo2ArtRoadHybrid_2048/gc27_topdown_contract_visual_proof_2048x2048.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC27_Demo2ArtRoadHybrid_2048/gc27_topdown_generator_blueprint_2048x2048.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC27_Demo2ArtRoadHybrid_2048/gc27_topdown_module_mask_proof_2048x2048.png`");
        report.AppendLine();
        report.AppendLine("Contracts touched: GC17/GC18 walkability visual contract remains the source of truth; GC27 adds a Demo2 art-road layer on top of GC26 source-scale compound envelopes without changing gameplay masks.");
        report.AppendLine("User-visible behavior: no shipped runtime behavior changed; generated scene now uses source-scale Demo2 road/ground/boundary/dressing prefabs over the existing flat gameplay plane.");
        report.AppendLine("Validation run: Unity batchmode `WarlineCaptureGc27Demo2ArtRoadHybridBuilder.BuildGc27Demo2ArtRoadHybrid2048`.");
        report.AppendLine("Validation result: " + (ValidationLog.Any(line => line.StartsWith("ERROR:", StringComparison.Ordinal)) ? "failed; see validation log below." : "passed Demo2 art-road hybrid validation."));
        report.AppendLine("Known gaps: Demo2 source-scale road modules are repeated along GC26 lane masks, so visual continuity still needs human review in the generated screenshots; this is not final navmesh/ECS integration.");
        report.AppendLine("Cross-lane impacts: Art/design can now compare the hybrid look against the Demo2 scene and target RTS reference while Gameplay keeps walkable/blocker masks stable.");
        report.AppendLine("Next recommended task: GC28 should visually review the captures, then replace any weak repeated road sections with authored intersections/compound entrance modules.");
        report.AppendLine();
