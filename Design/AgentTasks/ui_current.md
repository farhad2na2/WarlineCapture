...
Do not repeat the same HUD scope work, start new mockups, M02 work, broad HUD redesign, or unrelated polish. Re-engage only if QA/HCI reports a concrete HUD/UI regression.
