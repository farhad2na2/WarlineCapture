...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(445, projection["reviewedNonDebtRowCount"])
        self.assertEqual(130, projection["genuineDebtRowCount"])
        self.assertEqual(54, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`445` non-debt and `130` genuine-debt", tracker)
        self.assertIn("`54` unique file/rule items", tracker)
        self.assertIn("`130` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(437, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(130, review["genuineDebtRowCount"])
        self.assertEqual(54, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(130, len(debt_rows))
