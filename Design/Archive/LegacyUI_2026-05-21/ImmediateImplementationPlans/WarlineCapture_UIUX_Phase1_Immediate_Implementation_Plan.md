...
```text
Assets/Game/Prefabs/UI/Shell/WarlineCaptureAppCanvas.prefab
```
...
```text
Assets/Game/Scripts/UI/Shell/WarlineCaptureRoute.cs
...
Assets/Game/Scripts/UI/Shell/WarlineCaptureSafeArea.cs
Assets/Game/Scripts/UI/Shell/WarlineCaptureUiBootstrap.cs
...
- Prefab loads from `Assets/Game/Prefabs/UI/Shell/WarlineCaptureAppCanvas.prefab`.
...
2. Assign `WarlineCaptureAppCanvas.prefab`.
...
3. Create `WarlineCaptureAppCanvas.prefab`.
