...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(457, projection["reviewedNonDebtRowCount"])
        self.assertEqual(118, projection["genuineDebtRowCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`457` non-debt and `118` genuine-debt", tracker)
        self.assertIn("`46` unique file/rule items", tracker)
        self.assertIn("`118` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(449, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(118, review["genuineDebtRowCount"])
        ...
        self.assertEqual(118, len(debt_rows))
