...
Planning specification, 2026-09-20. Applies to the 120-scenario catalog and eventual 200 extension. Operations planning is deferred. Current implementation is simpler: campaign-specific guidance, a Base Assault planner with S1/S2 approach exceptions, and shared basic Skirmish enemy targeting. It is not already this architecture.
...
- All four enemy difficulties require legality tests, full simulated matches for every catalog entry, and visible manual/ARIA representative games per map/objective. Recruit should be teachable; Veteran/Commander should challenge skilled players. Validate ordering with human play; never promise a precise difficulty win rate without evidence.
