...
#pragma warning restore 0618
            ...
            in OperationMapReadinessComponent readiness) => new()
        {
            ...
            LaunchOrigin = request.LaunchOrigin, RunKind = request.RunKind, Guidance = MissionLaunchPayloadFactory.RequiresFullTutorial(request.MissionId.ToString()) ? Game.Narrative.Contracts.NarrativeGuidanceMode.Full : request.Guidance,
            ...
            ReadyReadiness = readiness.ReadyFlags, ReplayTutorialEnabled = MissionLaunchPayloadFactory.RequiresFullTutorial(request.MissionId.ToString()) ? (byte)1 : request.ReplayTutorialEnabled
        };
