...
public sealed class WarlineCaptureUiAccessibilityApplier : MonoBehaviour
{
    ...
    public void Apply(WarlineCaptureSettingsModel model)
    {
    ...
    private bool ShouldApplyScale()
    {
        ...
        while (parent != null)
        {
            if (parent.GetComponent<WarlineCaptureUiAccessibilityApplier>() != null)
                return false;
