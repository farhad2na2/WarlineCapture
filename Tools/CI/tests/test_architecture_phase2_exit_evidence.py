...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(429, projection["reviewedNonDebtRowCount"])
        self.assertEqual(146, projection["genuineDebtRowCount"])
        self.assertEqual(70, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`429` non-debt and `146` genuine-debt", tracker)
        self.assertIn("`70` unique file/rule items", tracker)
        self.assertIn("`146` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(421, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(146, review["genuineDebtRowCount"])
        self.assertEqual(70, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(146, len(debt_rows))
