...
- [x] Fold `P7-0117 BuildingRuntimeObjectSystem` from a disabled `SystemBase` wrapper into a plain Unity object lifecycle helper; play-mode `Destroy`, edit-mode `DestroyImmediate`, null guard, and all existing direct destruction delegate call sites stayed unchanged.
