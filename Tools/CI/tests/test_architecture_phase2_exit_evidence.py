...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(477, projection["reviewedNonDebtRowCount"])
        self.assertEqual(98, projection["genuineDebtRowCount"])
        self.assertEqual(41, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`477` non-debt and `98` genuine-debt", tracker)
        self.assertIn("`41` unique file/rule items", tracker)
        self.assertIn("`98` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(469, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(98, review["genuineDebtRowCount"])
        self.assertEqual(41, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(98, len(debt_rows))
