...
namespace Game.Editor
{
    ...
    public static partial class M03RadarWarningEditorLaunchProbe
    {
        ...
        {
            if(finished) return;
            if((completeBuildingJourney || SessionState.GetBool(TutorialBuildKey,false) || radarToolbarAudit || battleClarityAudit) && EditorApplication.isPlaying && !insideBuildingGameFrame)
            ...
            try
            {
                ...
                if(AdvanceVehicleVisualValidation(em,root,in runtime,in facts)) return;
        ...
        private static void Complete(bool passed,string detail)
        {
            ...
            SessionState.SetBool(VehicleVisualKey,false);
