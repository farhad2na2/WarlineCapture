...
namespace Game.UI.Contracts
{
    ...
    {
        public readonly int Aboard, Delivered, Required, CarrierLeg, SecureSeconds, RemainingSeconds, Lesson, PatrolSeconds;
