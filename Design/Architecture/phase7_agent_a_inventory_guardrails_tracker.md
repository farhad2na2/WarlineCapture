...
- In progress: `0`.
- Remaining open: `0`.
- Current target: `Agent F rendering/visual lane in progress; P7-0264 BuildingSelectionMarkerSystem helper fold completed; continue remaining Agent F visual split/direct candidates`.
- Runtime production baseline: `45 SystemBase/legacy declarations`, `134 ISystem declarations` under `Assets/Game/Scripts`.
- Current production ISystem share: `74.9%`.
- Inventory rows: `179 total`, `171 ProductionNonUI`, `8 ProductionUI`.
- Owner lanes assigned: `AgentB 20`, `AgentC 12`, `AgentD 9`, `AgentE 10`, `AgentF 36`, `Integration 92`.
...
- Planning projection from current inventory: at least `152 ISystem / 24 managed-exception non-UI SystemBase = 86.4% non-UI ISystem share` if every open direct/split non-exception production row converts one-to-one and UI remains out of scope; `RetireFold` rows can improve the final denominator.
- Validation status: `Agent B P7-0010 AIPlanEntryStartupSystem, P7-0015 FactionEconomyStartupSystem, P7-0008 AIFactionControlStartupSystem, P7-0016 InitialFactionSpawnCellSystem, P7-0021 RuntimeDiagnosticsSystem, P7-0022 RuntimeGameplayStateSystem, P7-0013 AIStartupSystem, and P7-0005 AICombatOrderSystem conversions/cleanup passed focused validations; P7-0020 PerformanceDiagnosticsSystem and P7-0002 MapSurfaceRuntimeBootstrapSystem folded out of ECS and passed focused validations; Agent C has completed all open SystemBase rows; Agent F request-contract slice folded P7-0281 SelectionScreenMarkerSystem and P7-0259 BuildingMarkerVisualCompositionSystem out of ECS into plain request/visual helpers, split P7-0249 UnitModelSpawnSystem and P7-0251 UnitRenderBudgetSystem to consume RuntimeCameraSnapshotComponent instead of managed Camera, and moved P7-0283/P7-0284 combat VFX playback to reviewed managed presentation exceptions in UnitAttackVfxSystems.cs while marking P7-0338 UnitAttackSystem cleanly converted; Agent D has no remaining open Agent D inventory rows; Agent E folded assigned city/citizen/road helper wrappers into plain Agent E helpers; Agent F folded P7-0278/P7-0282 camera helpers, P7-0273 RoadVisualRefreshSystem, P7-0260 BuildingPlacementVisualCompositionSystem, P7-0262 BuildingPlacementVisualUpdateSystem, P7-0241 RuntimeCityVisualSystem, P7-0242 RuntimeCityYardWallVisualSystem, P7-0253 UnitAttackTraceSystem, P7-0254 UnitImpostorRenderSystem, P7-0256 BuildingDestroyedVisualSystem, P7-0258 BuildingFoundationVisualSystem, P7-0261 BuildingPlacementVisualSystem, P7-0263 BuildingRuntimeVisualSystem, and P7-0264 BuildingSelectionMarkerSystem into plain direct-owned helpers, confirmed P7-0245 UnitAttachedLightSystem as a counted managed light presentation exception, and split P7-0252 UnitSelectionMarkerSystem so marker instance/scale decisions are blocker-free ISystem work while P7-0383 UnitSelectionObjectOutlinePresentationSystem owns Material/Mesh outline presentation as a counted managed exception`; latest Agent F logs include `/private/tmp/warline-phase7-agent-f-building-selection-marker-helper-fold.log` (`[BuildingSelectionMarkerFocusedValidation] result=Passed tests=6`), `/private/tmp/warline-phase7-agent-f-building-runtime-visual-helper-fold-selection-marker.log` (`[BuildingSelectionMarkerFocusedValidation] result=Passed tests=6`), and `/private/tmp/warline-phase7-agent-a-architecture.log` (`[NonUiSystemBaseMigrationArchitectureValidation] result=Passed tests=18`); inventory reports `45` production SystemBase/legacy declarations, `134` production ISystem declarations, and `74.9%` production ISystem share; dispositions now include `24` managed exceptions and `20` open rows; prior Agent D/F/B/C log paths remain recorded in the active lane trackers and handoff reports.
