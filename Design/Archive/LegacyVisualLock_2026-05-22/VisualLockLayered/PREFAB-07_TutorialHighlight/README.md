# PREFAB-07_TutorialHighlight Flat Visual Target Reference

This folder keeps a reference copy for the WarlineCapture visual-lock index.

- Reference target: `reference/PREFAB-07_TutorialHighlight_Landscape_Target.png`
- Source background: `Design/VisualLock/SCN-08_RTSBattleHUD_M01_TacticalFeedback/SCN-08_RTSBattleHUD_M01_TacticalFeedback_Landscape_Target.png` blurred and dimmed for panel/popup context.
