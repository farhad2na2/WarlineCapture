...
public static class WarlineCaptureGc25ScaleReferenceDistrictBuilder
{
    private const string ScenePath = "Assets/Game/Scenes/Generated/GC25_ScaleReferenceDistrict_2048.unity";
    private const string CaptureRoot = "Design/AgentReports/Captures/GeneratedScenes/GC25_ScaleReferenceDistrict_2048";
    private const string ReportPath = "Design/AgentReports/2026-05-21_gameplay_gc25-scale-reference-district.md";
    private const string DataPath = "Design/AgentReports/Data/GeneratedScenes/GC25_ScaleReferenceDistrict_2048/gc25_scale_reference_district_contract.json";
    ...
    [MenuItem("WarlineCapture/Design/Build GC25 Scale Reference District 2048")]
    public static void BuildGc25ScaleReferenceDistrict2048()
    {
        MacroRoads.Clear();
        ...
        GameObject root = new("GC25_ScaleReferenceDistrict_2048_Root");
        ...
        Debug.Log($"WARLINECAPTURE_GC25_SCALE_REFERENCE_DISTRICT_BUILT scene={ScenePath} report={ReportPath}");
    ...
    private static void BuildEnvironment(GameObject root)
    {
        ...
        Volume volume = Child(root, "GC25_RTS_PresentationVolume").AddComponent<Volume>();
    ...
    {
        Material baseMat = CreateMaterial("GC25_SandBase", new Color(0.58f, 0.49f, 0.34f, 1f));
        Material sandLightMat = CreateMaterial("GC25_SandWindLight", new Color(0.66f, 0.57f, 0.40f, 1f));
        Material sandDarkMat = CreateMaterial("GC25_SandCompactedDark", new Color(0.46f, 0.38f, 0.25f, 1f));
        Material roadMat = CreateMaterial("GC25_AuthoredCompactedRoad", new Color(0.50f, 0.40f, 0.25f, 1f));
        Material roadEdgeMat = CreateMaterial("GC25_RoadRaisedEdge", new Color(0.34f, 0.27f, 0.17f, 1f));
        Material shoulderMat = CreateMaterial("GC25_AuthoredRoadShoulder", new Color(0.47f, 0.38f, 0.24f, 1f));
        Material trackMat = CreateMaterial("GC25_DirtTireTrack", new Color(0.26f, 0.20f, 0.12f, 1f));
        Material runwayMat = CreateMaterial("GC25_RunwayWeatheredAsphalt", new Color(0.24f, 0.24f, 0.22f, 1f));
        Material runwayMarkMat = CreateMaterial("GC25_RunwayFadedMarking", new Color(0.72f, 0.68f, 0.58f, 1f));
        Material plazaMat = CreateMaterial("GC25_LocalPackedPlaza", new Color(0.63f, 0.52f, 0.35f, 1f));
        Material vehicleMat = CreateMaterial("GC25_VehicleYardDust", new Color(0.50f, 0.42f, 0.31f, 1f));
        Material districtPadMat = CreateMaterial("GC25_DistrictPackedSandPad", new Color(0.61f, 0.51f, 0.34f, 1f));
    ...
    {
        GameObject variation = Child(root, "GC25_VisualSandVariationTiles");
    ...
    {
        GameObject pads = Child(root, "GC25_AuthoredDistrictPads_VisualOnly");
    ...
    private static void AddRoadEdgeBands(GameObject roads, Material edgeMat, Material runwayMarkMat)
    {
        ...
        SurfaceBlueprintPolygon(roads, "Edge_MainNorthSouth_East_A", edgeMat, 0.091f, (406f, 0f), (416f, 0f), (386f, 890f), (376f, 890f));
        SurfaceBlueprintPolygon(roads, "Edge_MainNorthSouth_East_B", edgeMat, 0.091f, (494f, 0f), (504f, 0f), (474f, 890f), (464f, 890f));
        SurfaceBlueprintPolygon(roads, "Edge_NorthRoad_A", edgeMat, 0.091f, (58f, 242f), (828f, 216f), (830f, 226f), (60f, 252f));
        SurfaceBlueprintPolygon(roads, "Edge_NorthRoad_B", edgeMat, 0.091f, (66f, 302f), (830f, 276f), (832f, 286f), (68f, 312f));
        SurfaceBlueprintPolygon(roads, "Edge_CommandRoad_A", edgeMat, 0.091f, (128f, 418f), (358f, 406f), (632f, 340f), (820f, 342f), (820f, 352f), (634f, 350f), (360f, 416f), (130f, 428f));
        SurfaceBlueprintPolygon(roads, "Edge_CommandRoad_B", edgeMat, 0.091f, (132f, 480f), (374f, 466f), (646f, 400f), (816f, 402f), (816f, 412f), (648f, 410f), (376f, 476f), (134f, 490f));
        SurfaceBlueprintRect(roads, "Runway_Center_FadedStripe", 778f, 94f, 8f, 196f, runwayMarkMat, 0.096f);
        SurfaceBlueprintRect(roads, "Runway_Threshold_North", 756f, 112f, 50f, 6f, runwayMarkMat, 0.097f);
        SurfaceBlueprintRect(roads, "Runway_Threshold_South", 756f, 266f, 50f, 6f, runwayMarkMat, 0.097f);
    }
    ...
    private static void PlaceChildMaskedAuthoredModule(GameObject parent, MaskedModule module, string path)
    {
        ...
        source.name = "GC25_" + module.Name + "_ChildMaskSource";
        ...
        GameObject moduleRoot = Child(parent, "GC25_" + module.Name + "_ChildMaskedPieces");
        int accepted = 0;
        int pieceIndex = 0;
    ...
    private static bool TryPlaceChildMaskedPiece(GameObject parent, MaskedModule module, Zone mask, string sourcePath, GameObject sourceChild, int index)
    {
        ...
        instance.name = "GC25_" + module.Name + "_ChildPiece_" + index + "_" + sourceChild.name;
    ...
    private static void PlaceAuthoredCluster(GameObject parent, MaskedModule module, Zone mask, string path)
    {
        ...
        instance.name = "GC25_" + module.Name + "_AuthoredCluster";
        instance.transform.SetParent(parent.transform, true);
        instance.transform.position = Center(mask.Rect, 0f);
    ...
    private static void BuildDebugOverlay(GameObject root)
    {
        ...
        Material green = CreateMaterial("GC25_DebugSoldierWalkable", new Color(0f, 1f, 0.1f, 0.6f));
        Material cyan = CreateMaterial("GC25_DebugVehicleWalkable", new Color(0f, 0.8f, 1f, 0.6f));
        Material red = CreateMaterial("GC25_DebugBlocker", new Color(1f, 0f, 0f, 0.7f));
        foreach (Zone zone in SoldierLocalZones)
    ...
    private static void BuildGeneratorAuthoringOverlay(GameObject root)
    {
        ...
        Material city = CreateMaterial("GC25_AuthoringDistrict_City", new Color(0.20f, 0.42f, 0.80f, 0.85f));
        Material baseMat = CreateMaterial("GC25_AuthoringDistrict_Base", new Color(0.30f, 0.62f, 0.28f, 0.85f));
        Material logistics = CreateMaterial("GC25_AuthoringDistrict_Logistics", new Color(0.84f, 0.58f, 0.18f, 0.85f));
        Material airfield = CreateMaterial("GC25_AuthoringDistrict_Airfield", new Color(0.68f, 0.68f, 0.74f, 0.85f));
    ...
    private static void BuildMaskedModuleOverlay(GameObject root)
    {
        ...
        Material moduleMat = CreateMaterial("GC25_ModuleMask_DistrictEnvelope", new Color(0.88f, 0.18f, 0.92f, 0.82f));
        Material blockerMat = CreateMaterial("GC25_ModuleMask_BlockerOwned", new Color(1f, 0.08f, 0.08f, 0.9f));
    ...
    private static void Validate()
    {
        ...
        if (detailBlockerPlacements < 60)
            ValidationLog.Add($"ERROR: GC25 placed only {detailBlockerPlacements} legal detail props; densification target is at least 60.");

        if (Districts.Count < 7)
            ValidationLog.Add($"ERROR: GC25 exported only {Districts.Count} districts; procedural authoring target is at least 7 named districts.");
        ...
        if (Modules.Count < 7)
            ValidationLog.Add($"ERROR: GC25 exported only {Modules.Count} reusable masked modules; target is at least 7.");

        if (authoredClusterPlacements < Modules.Count)
            ValidationLog.Add($"ERROR: GC25 placed only {authoredClusterPlacements} authored Demo clusters for {Modules.Count} reusable modules.");
    ...
    {
        BuildRtsCamera(root, "Camera_GC25_RtsOverview", new Vector3(-620f, 520f, -820f), BlueprintPoint(388f, 430f), 38f);
        BuildRtsCamera(root, "Camera_GC25_RtsCityReadable", new Vector3(-930f, 330f, -430f), BlueprintPoint(172f, 366f), 34f);
        BuildRtsCamera(root, "Camera_GC25_RtsAirfieldCommand", new Vector3(260f, 430f, -620f), BlueprintPoint(660f, 320f), 36f);
        BuildRtsCamera(root, "Camera_GC25_RtsDenseCityClose", new Vector3(-700f, 210f, -250f), BlueprintPoint(176f, 392f), 30f);
        BuildRtsCamera(root, "Camera_GC25_ScaleAuditClose", new Vector3(-700f, 92f, -185f), BlueprintPoint(176f, 392f), 22f);

        Camera top = CameraObject(root, "Camera_GC25_TopDownContractVisualProof");
    ...
    private static void CaptureScene()
    {
        foreach (Camera camera in Object.FindObjectsByType<Camera>(FindObjectsInactive.Include))
        {
            ...
            if (camera.name == "Camera_GC25_RtsCityReadable")
                Render(camera, ProjectPath(CaptureRoot + "/gc25_rts_city_readable_1920x1080.png"), 1920, 1080);
            if (camera.name == "Camera_GC25_RtsAirfieldCommand")
                Render(camera, ProjectPath(CaptureRoot + "/gc25_rts_airfield_command_1920x1080.png"), 1920, 1080);
            if (camera.name == "Camera_GC25_RtsDenseCityClose")
                Render(camera, ProjectPath(CaptureRoot + "/gc25_rts_dense_city_close_1920x1080.png"), 1920, 1080);
            if (camera.name == "Camera_GC25_ScaleAuditClose")
                Render(camera, ProjectPath(CaptureRoot + "/gc25_scale_audit_close_1920x1080.png"), 1920, 1080);
            if (camera.name == "Camera_GC25_TopDownContractVisualProof")
            {
                RenderContractProof(camera, ProjectPath(CaptureRoot + "/gc25_topdown_contract_visual_proof_2048x2048.png"));
                RenderGeneratorBlueprint(camera, ProjectPath(CaptureRoot + "/gc25_topdown_generator_blueprint_2048x2048.png"));
                RenderModuleMaskProof(camera, ProjectPath(CaptureRoot + "/gc25_topdown_module_mask_proof_2048x2048.png"));
            }
        }
    }
    ...
    private static void WriteContractJson()
    {
        ...
        {
            generatedBy = nameof(WarlineCaptureGc25ScaleReferenceDistrictBuilder),
            scene = ScenePath,
    ...
    private static void WriteReport()
    {
        ...
        report.AppendLine("# GC25 Scale Reference District Scene");
        report.AppendLine();
        report.AppendLine("Lane: Gameplay");
        report.AppendLine("Task: Continue from GC24 by validating building, road, vehicle, and character scale using source prefab scale instead of fitting authored art down to masks.");
        report.AppendLine();
        report.AppendLine("Files changed:");
        report.AppendLine("- `Assets/Game/Scripts/Editor/WarlineCaptureGc25ScaleReferenceDistrictBuilder.cs`");
        report.AppendLine("- `Assets/Game/Scenes/Generated/GC25_ScaleReferenceDistrict_2048.unity`");
        report.AppendLine("- `Design/AgentReports/Data/GeneratedScenes/GC25_ScaleReferenceDistrict_2048/gc25_scale_reference_district_contract.json`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC25_ScaleReferenceDistrict_2048/gc25_rts_overview_1920x1080.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC25_ScaleReferenceDistrict_2048/gc25_rts_city_readable_1920x1080.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC25_ScaleReferenceDistrict_2048/gc25_rts_airfield_command_1920x1080.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC25_ScaleReferenceDistrict_2048/gc25_rts_dense_city_close_1920x1080.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC25_ScaleReferenceDistrict_2048/gc25_scale_audit_close_1920x1080.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC25_ScaleReferenceDistrict_2048/gc25_topdown_contract_visual_proof_2048x2048.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC25_ScaleReferenceDistrict_2048/gc25_topdown_generator_blueprint_2048x2048.png`");
        report.AppendLine("- `Design/AgentReports/Captures/GeneratedScenes/GC25_ScaleReferenceDistrict_2048/gc25_topdown_module_mask_proof_2048x2048.png`");
        report.AppendLine();
        report.AppendLine("Contracts touched: GC17/GC18 walkability visual contract remains the source of truth; GC25 changes visual placement policy so source-authored buildings, modules, soldiers, and vehicles are kept at scale 1 where possible.");
        report.AppendLine("User-visible behavior: no shipped runtime behavior changed; generated scene now exposes true source-scale relationships between soldiers, buildings, vehicles, roads, and district envelopes.");
        report.AppendLine("Validation run: Unity batchmode `WarlineCaptureGc25ScaleReferenceDistrictBuilder.BuildGc25ScaleReferenceDistrict2048`.");
        ...
        report.AppendLine("Known gaps: source-scale prefabs reveal that some district envelopes/masks are still too sparse for target-quality city density; roads are still generated surfaces, not final art road modules.");
        report.AppendLine("Cross-lane impacts: Design should size future masks/envelopes around source-scale prefabs instead of relying on per-object scale fitting.");
        report.AppendLine("Next recommended task: GC26 should replace generated surface strips with real Polygon/Demo road, wall, curb, terrain, and compound modules while preserving source scale 1.");
        report.AppendLine();
