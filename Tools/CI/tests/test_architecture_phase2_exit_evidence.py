...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(432, projection["reviewedNonDebtRowCount"])
        self.assertEqual(143, projection["genuineDebtRowCount"])
        self.assertEqual(67, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`432` non-debt and `143` genuine-debt", tracker)
        self.assertIn("`67` unique file/rule items", tracker)
        self.assertIn("`143` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(424, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(143, review["genuineDebtRowCount"])
        self.assertEqual(67, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(143, len(debt_rows))
