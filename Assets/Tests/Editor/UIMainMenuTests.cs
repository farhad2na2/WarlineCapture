...
public sealed class UIMainMenuTests
{
    ...
    private const string UiButtonAnimatorControllerPath = "Assets/Game/Animations/UI/UIButtonStates.overrideController";
    ...
    private const string UiButtonNormalClipPath = "Assets/Game/Animations/UI/UIButton_Normal.anim";
    private const string UiButtonHighlightedClipPath = "Assets/Game/Animations/UI/UIButton_Highlighted.anim";
    private const string UiButtonPressedClipPath = "Assets/Game/Animations/UI/UIButton_Pressed.anim";
    private const string UiButtonSelectedClipPath = "Assets/Game/Animations/UI/UIButton_Selected.anim";
    private const string UiButtonDisabledClipPath = "Assets/Game/Animations/UI/UIButton_Disabled.anim";
    ...
    public void MainMenu_RoutesOnlyImplementedDestinations()
    {
        ...
        AssertRoute(prefab, "TopProfileBar/SettingsButton", UIRoute.Settings);
        AssertRoute(prefab, "LeftNav/InboxButton", UIRoute.Inbox);
        AssertRoute(prefab, "LeftNav/StoreButton", UIRoute.CommandExchange);
        AssertRoute(prefab, "LeftNav/EventsButton", UIRoute.Events);
        AssertRoute(prefab, "LeftNav/RankingButton", UIRoute.Ranking);
        AssertRoute(prefab, "LeftNav/CommandFeedRouteButton", UIRoute.CommandFeed);
        AssertRoute(prefab, "ModeCardList/ModeCard_QuickCustom/Button", UIRoute.QuickCustomSetup);
    ...
    private static void AssertAnimatedTabButton(GameObject prefab, string path, string expectedInitialState, bool shouldSelectWithEventSystem)
    {
        ...
        UIButtonAnimationState initialState = target.GetComponent<UIButtonAnimationState>();
    ...
    private static void AssertRoute(GameObject prefab, string path, UIRoute expectedRoute)
    {
        Transform target = prefab.transform.Find(path);
        Assert.NotNull(target, path);
