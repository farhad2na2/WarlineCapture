...
Validation run:
- `rg` checked M01 mission/runtime/FTUE ids against `M01_FirstContact_Production_Contract.md` and `FTUE_And_Command_Assistant_Design.md`.
- `rg` checked `BattleHudGameplayBridge` methods, `TacticalCommandMode`, and `TacticalCommandReasonCode` names against `BattleHudGameplayBridge.cs` and `Gameplay_UI_Integration_Handoff_Spec.md`.
...
- `git diff --check -- README.md Design/README.md Design/FTUE_And_Command_Assistant_Design.md Design/UIUX_Gameplay_Element_Alignment.md Design/AssistantPanel_M01_Implementation_Contract.md`
