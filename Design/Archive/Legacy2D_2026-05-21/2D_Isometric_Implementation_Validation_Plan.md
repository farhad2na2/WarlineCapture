...
- Art bible: `Design/2D_Isometric_Art_Bible.md`
...
- Strategic/tactical map gameplay alignment: `Design/Strategic_Tactical_Map_Gameplay_Alignment.md`
...
- Tactical overlays and VFX should follow `Design/Visual_Feedback_VFX_Recommendations.md` for move/attack markers, invalid target feedback, scan effects, reward/resource feedback, and critical combat warnings.
...
5. Assets are added to `Design/VisualConfigs/Combat_Visual_Config_v0_1.json` before runtime binding.
...
1. Follow `Design/Unit_Portrait_Art_Generation_Guide.md` for portraits.
2. Follow `Design/UIUX_Target_To_Canvas_Workflow_Guide.md` and `Design/UIUX_Mockup_To_Canvas_Conversion_Plan.md` for target-to-canvas content layers.
...
5. Each UI render asset must map to a `VisualConfigs/Combat_Visual_Config_v0_1.json` id or a screen-specific `MapPreviewArtId`/content art id.
