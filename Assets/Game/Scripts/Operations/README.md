...
Shared-seam blockers: `Design/Roadmap/Operations/P0_SHARED_SEAMS.md`, `Design/Roadmap/Operations/P1_STRATEGIC_CORE.md`, and `Design/Roadmap/Operations/P2_TACTICAL_RULES.md`.
