...
class Phase2ClosureAuditContractTests(unittest.TestCase):
    ...
    def test_distinct_575_populations_and_projection_arithmetic(self):
        ...
        self.assertEqual(552, projection["reviewedNonDebtRowCount"])
        self.assertEqual(23, projection["genuineDebtRowCount"])
        self.assertEqual(19, projection["uniqueDebtItemCount"])
    ...
    def test_documents_keep_projection_non_accepting(self):
        ...
        self.assertIn("`552` non-debt and `23` genuine-debt", tracker)
        self.assertIn("`19` unique file/rule items", tracker)
        self.assertIn("`23` remaining genuine-debt rows", package)
    ...
    def test_production_delta_has_one_hash_bound_decision_per_intake_row(self):
        ...
        self.assertEqual(544, review["resolvedNonDebtRowCount"])
        self.assertEqual(8, review["protectedDeferredRowCount"])
        self.assertEqual(23, review["genuineDebtRowCount"])
        self.assertEqual(19, review["uniqueDebtItemCount"])
        self.assertEqual(0, review["unclassifiedRowCount"])
        reviewed = [
        ...
        self.assertEqual(23, len(debt_rows))
