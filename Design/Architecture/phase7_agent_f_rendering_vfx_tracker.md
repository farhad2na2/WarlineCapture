...
- In progress: `0`.
- Remaining open: `61`.
- Current target: `Agent F naming slice complete for P7-0264 BuildingSelectionMarkerPresentationSystemHelper; continue remaining Agent F visual/helper naming candidates`.
